...
public final class aaru implements CardboardView$Renderer
{
    ...
    public final void onDrawEye(final CardboardView$Eye cardboardView$Eye) {
        if (this.b && this.a != null) {
            if (cardboardView$Eye.getEyeType() == 0) {
                this.a.onDrawEye((Eye)new aart(cardboardView$Eye, 1, this.c.getHeadView()));
                return;
            }
            this.a.onDrawEye((Eye)new aart(cardboardView$Eye, 2, this.c.getHeadView()));
        }
    }
