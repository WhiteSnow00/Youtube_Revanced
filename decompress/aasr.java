...
final class aasr implements GLSurfaceView$EGLWindowSurfaceFactory
{
    ...
    public final void a() {
        ...
        if (this.f) {
            ...
            while (i > 0) {
                --i;
                EGL14.eglSurfaceAttrib(eglGetCurrentDisplay, eglGetCurrentSurface, aasr.c[i], (int)(aavl.a[i] * 50000.0f));
            }
        }
    }
    ...
    public final void b(final boolean b) {
        ...
        if (this.i == null) {
            ...
            if (this.d) {
                ...
                if (eglQueryString != null && eglQueryString.contains("EGL_EXT_gl_colorspace_bt2020_pq")) {
                    ...
                    if (i != null && i.contains("EGL_EXT_gl_colorspace_display_p3") && Build$VERSION.SDK_INT <= 28) {
                        ...
                        this.j = 3;
                        this.k = 3;
                        tut.c("GlWindowFactory", "BT709 GAMMA22");
                        if (this.i != null) {
                            return;
                        }
                        throw new aavb("c.GlExtensions_null");
                    }
                }
                (this.g = new aasq(1)).a(12445, n);
                this.g.a(12344, 12344);
                (this.h = new aasq(1)).a(12445, 12426);
            ...
            final String b2 = ych.b(this.k);
            final String a = ych.a(this.j);
            final StringBuilder sb = new StringBuilder();
            sb.append(b2);
            sb.append(" ");
            sb.append(a);
            tut.c("GlWindowFactory", sb.toString());
        }
    }
    ...
    public final javax.microedition.khronos.egl.EGLSurface createWindowSurface(final EGL10 egl10, final javax.microedition.khronos.egl.EGLDisplay eglDisplay, final EGLConfig eglConfig, final Object o) {
        ...
        return egl10.eglCreateWindowSurface(eglDisplay, eglConfig, o, (int[])aasq.b);
    }
