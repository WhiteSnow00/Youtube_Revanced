...
public final class aawy implements aaxx, abps
{
    ...
    static {
        a = (aaxw)new aawz((List)afeq.r((Object)xaa.c(22156)), (List)afeq.u((Object)xaa.c(28239), (Object)xaa.c(28240), (Object)xaa.c(123454), (Object)xaa.c(123453)));
    }
    ...
    final xah c(final xag xag, final PlayerResponseModel playerResponseModel, final String s) {
        ...
        final aiqj h = this.h();
        d.b = aaxt.a(h);
        final xah d2 = aaxt.d(xag, (Runnable)aavc, new wyt(ByteBuffer.wrap(playerResponseModel.Y()).array()), h);
        if (s != null) {
    ...
    final xah d(final xag xag, final WatchNextResponseModel watchNextResponseModel, final String s) {
        ...
        if (c != null && ((ahbc)c).ry((ahaq)OfflineWatchEndpointOuterClass.offlineWatchEndpoint)) {
            xah = aaxt.d(xag, (Runnable)aavc, new wyt(xaa.c(13187)), h);
        }
        else {
            xah = aaxt.d(xag, (Runnable)aavc, new wyt(ByteBuffer.wrap(watchNextResponseModel.d()).array()), h);
        }
        if (s != null) {
            aaxt.b((wyw)d.e, (wzz)d.b, s);
        }
    ...
    public final asir[] lX(final abpu abpu) {
        final asir an = ((ashi)abpu.p().a).j(aale.s(abpu.bM(), 512L)).j(aale.q(1)).an((asjm)new aauu(this, 5), (asjm)aaof.l);
        asir asir;
        if (((vai)abpu.ci().g).bx()) {
            asir = abpu.Q().an((asjm)new aauu(this, 6), (asjm)aaof.l);
        }
        else {
            asir = abpu.P().j(aale.s(abpu.bM(), 512L)).j(aale.q(1)).an((asjm)new aauu(this, 6), (asjm)aaof.l);
        }
        return new asir[] { an, asir, abpu.M().j(aale.s(abpu.bM(), 512L)).j(aale.q(1)).an((asjm)new aauu(this, 7), (asjm)aaof.l) };
    }
