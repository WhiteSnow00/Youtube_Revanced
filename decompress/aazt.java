...
public final class aazt implements aazo
{
    ...
    public aazt(final ashi ashi, final ashi ashi2, final atke atke, final Executor a, final aukf b, final aukf j, final aukf c, final abuh d, final atke k) {
        ...
        this.h = false;
        this.i = 0;
        ashi.an((asjm)new aauu(this, 16), (asjm)aaof.p);
        ashi2.an((asjm)new aauu(this, 17), (asjm)aaof.p);
        ((ashi)((abpu)atke.a()).p().k).an((asjm)new aauu(this, 18), (asjm)aaof.p);
        this.a = a;
        this.b = b;
        this.j = j;
        this.c = c;
    ...
    public final void g(final long n, final long n2, final boolean b, final boolean b2) {
        ...
        this.i = 0;
        this.h();
        this.l = (abvy)new aazq(this, n - 1L, b2, n, n2);
        this.m = (abvy)new aazr(this, n2 + 1L, b2, n, n2);
        this.n = (abvy)new aazs(this, n);
        ...
        if (!this.g) {
            this.a.execute((Runnable)new aazp(this, b, n));
            this.g = true;
        }
    }
