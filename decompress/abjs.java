...
public class abjs
{
    ...
    public abjs(final String k, int int1, final String s, final long f) {
        ...
        adme.K(split.length == 8);
        final int int2 = Integer.parseInt(split[0]);
        this.a = int2;
        final int int3 = Integer.parseInt(split[1]);
        this.b = int3;
        final int int4 = Integer.parseInt(split[2]);
        this.g = int4;
        int1 = Integer.parseInt(split[3]);
        this.c = int1;
    ...
    public final String g(final int n) {
        if (n >= 0 && n < this.d()) {
            ...
            if ((string = (String)this.l.get(n)) == null) {
                ...
                sb2.append(n);
                final twk b = twk.b(Uri.parse(replace2.replace("$M", sb2.toString())));
                b.h("sigh", this.j);
                string = b.a().toString();
