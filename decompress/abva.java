...
public final class abva extends View
{
    ...
    public abva(final Context context) {
        super(context);
        this.setLayerType(1, (Paint)null);
        this.setId(2131431827);
                ...
                if (n != 3) {
                    if (n != 4) {
                        if (n != 5) {
                            ...
                            this.d.setShadowLayer((float)resources.getDimensionPixelSize(2131169902), 0.0f, (float)resources.getDimensionPixelSize(2131169903), this.e.getColor());
                            j = n;
                        }
                    }
                    else {
