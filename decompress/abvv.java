...
public final class abvv
{
    ...
    public final void b(final int n) {
        ...
        if (this.t != 0) {
            ...
            while (iterator.hasNext()) {
                ((abvu)iterator.next()).d(this.t);
            }
        }
        this.t = 0;
    }
    
    public final void c(final abvu abvu) {
        this.a.add(abvu);
    }
    ...
    public final void d() {
        ...
        this.j(0L);
        this.m(null, null);
        final CharSequence d = twd.d((CharSequence)null);
    ...
    public final void l(final vig u) {
        if (!aexq.c(this.u.e(), u.e())) {
            this.u = u;
            this.b(64);
        }
    }
