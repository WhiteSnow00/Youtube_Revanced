...
public final class achn implements zlk
{
    private final int a;
    ...
    public achn(final int a, final Bitmap$Config b) {
        adme.L(a > 0, "desiredWidth must be > 0");
        this.a = a;
        this.b = b;
    }
    ...
    public final Bitmap a(final byte[] array) {
        ...
        throw new txe("failed to decode bitmap");
    }
