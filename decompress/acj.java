...
public final class acj
{
    ...
    public float[] d;
    public int e;
    protected final cdr f;
    private final ack g;
    private int h;
    private int i;
    private boolean j;
    
    public acj(final ack g, final cdr f, final byte[] array, final byte[] array2) {
        this.a = 0;
        this.h = 8;
        this.b = new int[8];
        this.c = new int[8];
    ...
    public final float a(final aco aco) {
    ...
    public final float c(final aco aco, final boolean b) {
        int e = this.e;
        if (e != -1) {
            int n = 0;
            int n2 = -1;
    ...
    public final void e(final aco aco, float n, final boolean b) {
    ...
    public final void f() {
        for (int e = this.e, n = 0; e != -1 && n < this.a; e = this.c[e], ++n) {
            final aco aco = ((aco[])this.f.c)[this.b[e]];
            if (aco != null) {
                aco.b(this.g);
            }
        }
    ...
    public final void g(final aco aco, final float n) {
        if (n == 0.0f) {
            this.c(aco, true);
            return;
        }
    ...
    public final String toString() {
        ...
        while (e != -1 && n < this.a) {
            ...
            sb.append(n2);
            sb.append(" : ");
            concat = sb.toString().concat(String.valueOf(String.valueOf(((aco[])this.f.c)[this.b[e]])));
            e = this.c[e];
            ++n;
        }
        return concat;
