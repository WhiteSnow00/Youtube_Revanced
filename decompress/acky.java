...
public final class acky extends ackr
{
    ...
    public acky(final Context context, final acme acme, final acmh acmh) {
    ...
    protected final ackw d(final Context context, final acmh acmh) {
        return (ackw)new ackx(context, acmh);
    }
    
    protected final void f(final int n, final aclz aclz, final aclb aclb) {
        this.g = new int[n];
        this.b = aclz.b("grid_row_presenter_horizontal_row_padding", aclb.e);
        this.d = aclz.b("grid_row_presenter_top_padding", aclb.c);
        this.c = aclz.b("grid_row_presenter_horizontal_row_padding", aclb.f);
        this.e = aclz.b("grid_row_presenter_bottom_padding", aclb.d);
        this.f = aclb.g;
    }
    ...
    protected final void i(final View view, final aclb aclb, final int n) {
        this.g[n] = view.getId();
        int n2 = n;
        if (n == 0) {
