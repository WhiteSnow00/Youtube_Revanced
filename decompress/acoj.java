...
public final class acoj extends LinearLayout
{
    ...
    public acoj(final Context context) {
        super(context);
        this.setOrientation(1);
        final LayoutInflater from = LayoutInflater.from(context);
        from.inflate(2131625300, (ViewGroup)this);
        this.a = (TextView)this.findViewById(2131432096);
        final ListView b = (ListView)this.findViewById(2131428424);
        this.b = b;
        final View inflate = from.inflate(2131625302, (ViewGroup)b, false);
