...
public final class acpp extends ReplacementSpan
{
    ...
    public acpp(final String s, final float n, final float n2, final float n3, final int n4) {
        this(s, n, n2, n3, n4, null);
    }
    
    public acpp(final String a, final float c, final float d, final float e, final int color, final byte[] array) {
        this.a = a;
        this.c = c;
        this.d = d;
        this.e = e;
