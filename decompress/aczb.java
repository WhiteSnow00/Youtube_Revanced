...
public final class aczb extends aczd
{
    public aczc a;
    private ImageView d;
    private View e;
    ...
    public aczb(final LoadingFrameLayout loadingFrameLayout, final int n) {
    ...
    protected final View a() {
        ...
        this.e = viewById;
        if (viewById != null) {
            viewById.setOnClickListener((View$OnClickListener)new acvy(this, 3));
        }
        this.c(this.f);
        this.b(this.g);
        return a;
