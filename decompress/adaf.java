...
public final class adaf implements aczm
{
    String a;
    String b;
    String c;
    ...
    public final adan a() {
        ...
        adan adan;
        if (this.w) {
            adan = new adan(s, tmx.d, this.r);
        }
        else {
            adan = new adan(s, tmx.b, this.r);
        }
        adan.j = this.v;
        if (empty ^ true) {
            adan.u("Authorization", "Bearer ".concat(String.valueOf(this.g)));
            if (!TextUtils.isEmpty((CharSequence)this.h)) {
                adan.u("X-Goog-PageId", this.h);
            }
        }
        else if (!TextUtils.isEmpty((CharSequence)this.i)) {
            adan.u("X-Goog-Visitor-Id", this.i);
        }
        return adan;
    }
