...
final class adbc
{
    ...
    public final void a(final byte[] array, final int n, final int n2, final boolean b, final ahbs ahbs) {
        adme.L(n2 <= 4096, "length must be less than or equal to CHUNK_SIZE_BYTES!");
    ...
    public final void b() {
        ...
        try {
            ...
            tut.b("Something went wrong in the underlying codec!");
        }
        this.b.release();
        t.b();
    }
