...
public final class adkn implements UncaughtExceptionHandler
{
    ...
    public adkn(final adkp c, final atnb d) {
        this.c = c;
        this.d = d;
        this.b = false;
    }
    ...
    public final void a() {
        if (!adkn.a.getAndSet(true)) {
            this.e = Thread.getDefaultUncaughtExceptionHandler();
            Thread.setDefaultUncaughtExceptionHandler((Thread.UncaughtExceptionHandler)this);
        }
    }
    
    public final void b(final atnb p0) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        // 
        //     1: getfield        adkn.c:Ladkp;
        //     4: getstatic       adkr.b:Ladkr;
        //     7: iconst_0       
        //     8: invokestatic    adme.m:(Ladkp;Ladkr;Z)Ljava/util/List;
        ...
        //    55: astore          4
        //    57: getstatic       ahwk.a:Lahwk;
        //    60: aload           5
        //    62: aload           4
        //    64: invokestatic    ahcz.parseFrom:(Lahcz;Ljava/io/InputStream;Lcom/google/protobuf/ExtensionRegistryLite;)Lahcz;
        //    67: checkcast       Lahwk;
        //    70: astore          4
        //    72: aload           5
        ...
        //   142: aload           4
        //   144: invokestatic    adme.j:(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   147: aconst_null    
        //   148: astore          4
        //   150: aload           4
        //   152: ifnull          260
        ...
        //   160: pop            
        //   161: invokestatic    akpu.d:()Lakps;
        //   164: astore          5
        //   166: aload           5
        //   168: invokevirtual   ahcr.copyOnWrite:()V
        //   171: aload           5
        //   173: getfield        akps.instance:Lahcz;
        //   176: checkcast       Lakpu;
        //   179: aload           4
        //   181: invokestatic    akpu.af:(Lakpu;Lahwk;)V
        //   184: aload           5
        //   186: invokevirtual   ahcr.build:()Lahcz;
        //   189: checkcast       Lakpu;
        //   192: astore          8
        //   194: aload           4
        //   196: getfield        ahwk.e:Laosv;
        //   199: astore          5
        //   201: aload           5
        //   203: astore          4
        //   205: aload           5
        //   207: ifnonnull       215
        //   210: getstatic       aosv.a:Laosv;
        //   213: astore          4
        //   215: aload           4
        //   217: getfield        aosv.g:Laoso;
        //   220: astore          5
        //   222: aload           5
        //   224: astore          4
        //   226: aload           5
        //   228: ifnonnull       236
        //   231: getstatic       aoso.a:Laoso;
        //   234: astore          4
        //   236: aload           4
        //   238: getfield        aoso.e:J
        //   241: lstore_2       
        //   242: aload_1        
        //   243: invokeinterface atnb.a:()Ljava/lang/Object;
        //   248: checkcast       Lwza;
        //   251: aload           8
        //   253: lload_2        
        //   254: invokeinterface wza.e:(Lakpu;J)Z
        //   259: pop            
        //   260: aload           6
        //   262: invokestatic    adme.i:(Ljava/io/File;)V
        //   265: goto            18
        //   268: return         
        //   269: astore          5
        //   271: goto            123
    ...
    public final void uncaughtException(final Thread thread, final Throwable t) {
        try {
            final arzb arzb = (arzb)this.d.a();
            adme.l((adkp)arzb.a, (MessageLite)arzb.d(thread.getName(), t, arzb.e(t)), adkr.b, this.b);
