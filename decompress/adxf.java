...
public class adxf extends mu
{
    ...
    public adxf(final Context context) {
        this(context, null);
    }
    
    public adxf(final Context context, final AttributeSet set) {
        this(context, set, 0);
    }
    
    public adxf(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        this.d = new Rect();
        this.e = new Rect();
        this.f = 119;
        this.a = true;
        this.b = false;
        final TypedArray a = adxy.a(context, set, adxs.a, n, 0, new int[0]);
