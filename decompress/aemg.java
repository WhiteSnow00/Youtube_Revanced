...
public final class aemg
{
    ...
    public aemg(final String d) {
        this.a = new abh();
        this.b = new abh();
        adkp.I(aezr.f(d) ^ true, "mapKey must be a non-empty, non-null static String unique to the class using CallbackIdMap.");
        this.d = d;
    }
    
    public final int a(final Object o) {
        qdt.h();
        final Integer n = (Integer)((abo)this.b).get(o.getClass());
        final boolean b = true;
        adkp.T(n != null, "The callback %s has not been registered", o.getClass());
        adkp.T(this.b(n) == o && b, "The callback class %s was registered using a different instance. The instance registered in onCreate() must be the same instance used to listen. You can use a final member variable to safely hold the callback reference for each lifecycle.", o.getClass());
        return n;
    }
    
    public final Object b(final int n) {
        qdt.h();
        final Object value = ((abo)this.a).get(n);
        if (value == null) {
    ...
    public final void d(final Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            adkp.R(bundle.containsKey(concat), "CallbackIdMap writes its keys unconditionally. It did not find its state on restore, which suggests state loss.");
            ...
            while (i < stringArray.length) {
                try {
                    final Integer n = (Integer)((abo)this.b).put(Class.forName(stringArray[i]), intArray[i]);
                    if (n != null) {
                        final int intValue = n;
                        final int n2 = intArray[i];
                        adkp.X(intValue == n2, "Callback ID for class %s was restored with ID %s, but had an existing mapping of %s. Always register for FuturesMixin callbacks and subscribe to SubscriptionMixin callbacks in onCreate()! Do *not* subscribe in a Peer's constructor", stringArray[i], n2, n);
                    }
                    ++i;
                    continue;
                }
