...
public final class afch
{
    ...
    static {
        ...
        afar.d('A', 'F').f(afar.d('a', 'f'));
        final arhz arhz = new arhz((byte[])null);
        arhz.b('<', "&lt;");
        arhz.b('>', "&gt;");
        final int a2 = afcg.a;
        arhz.c();
        ...
        adme.H(173, set2);
        adme.I(1536, 1539, set2);
        adme.H(1757, set2);
        adme.H(1807, set2);
        adme.I(6068, 6069, set2);
        adme.I(8203, 8207, set2);
        adme.I(8234, 8238, set2);
        adme.I(8288, 8292, set2);
        adme.I(8298, 8303, set2);
        adme.H(65279, set2);
        adme.I(65529, 65531, set2);
        adme.I(119155, 119162, set2);
        adme.H(917505, set2);
        adme.I(917536, 917631, set2);
        adme.H(0, set2);
        adme.H(10, set2);
        adme.H(13, set2);
        adme.I(8232, 8233, set2);
        adme.H(133, set2);
        adme.H(Character.codePointAt("'", 0), set2);
        adme.H(Character.codePointAt("\"", 0), set2);
        adme.H(Character.codePointAt("&", 0), set2);
        adme.H(Character.codePointAt("<", 0), set2);
        adme.H(Character.codePointAt(">", 0), set2);
        adme.H(Character.codePointAt("=", 0), set2);
        adme.H(Character.codePointAt("\\", 0), set2);
        final aheu aheu = a = adme.al(set2);
        final HashSet set3 = new HashSet();
        adme.H(Character.codePointAt("\"", 0), set3);
        adme.H(Character.codePointAt("\\", 0), set3);
        adme.I(0, 31, set3);
        final aheu aheu2 = b = adme.al(set3);
