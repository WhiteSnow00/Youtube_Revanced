...
final class afcv extends AbstractSet implements Serializable
{
    ...
    private final int i(final int n, int i, int j, int y) {
        final int n2 = i - 1;
    ...
    public final boolean add(final Object o) {
        if (this.g()) {
            adkp.R(this.g(), "Arrays already allocated");
            final int b = this.b;
    ...
    public final boolean contains(final Object o) {
        ...
        do {
            ...
            final int n2 = y - 1;
            n = l[n2];
            if (aefb.u(n, h) == u && adkp.ae(o, this.c(n2))) {
                return true;
            }
        } while ((y = (n & h)) != 0);
        return false;
    ...
    final void f(final int n) {
        adkp.I(true, "Expected size must be >= 0");
