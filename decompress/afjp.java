...
public class afjp
{
    ...
    public afjp(final int n) {
        this(n, null);
    }
    
    public afjp(final int n, final byte[] array) {
        this.n(n);
    }
    
    public afjp(final afjp afjp) {
        this.n(afjp.c);
        for (int i = afjp.a(); i != -1; i = afjp.e(i)) {
            this.o(afjp.h(i), afjp.c(i));
        }
    }
    ...
    final int d(final Object o) {
        ...
        long n;
        for (int i = this.e[this.r() & u]; i != -1; i = (int)n) {
            n = this.f[i];
            if (q(n) == u && aexq.c(o, this.a[i])) {
                return i;
            }
        }
        return -1;
    ...
    public final int f(final Object o, int n) {
        ...
        if (n3 != -1) {
            int n4 = -1;
            while (q(this.f[n3]) != n || !aexq.c(o, this.a[n3])) {
    ...
    public void n(final int n) {
        adme.L(n >= 0, "Initial capacity must be non-negative");
        adme.L(true, "Illegal load factor");
    ...
    final afji p(final int n) {
        adme.ab(n, this.c);
        return new afji(this, n);
    }
}
