...
public final class agpl
{
    ...
    public agpl(final abqz abqz, final askz askz) {
        this.b = Optional.empty();
        this.a = 1;
        abqz.H((afax)abej.f, (afax)abej.g).P(askz).am((asmi)new abgi(this, 6, (byte[])null, (byte[])null));
        abqz.M().P(askz).am((asmi)new abgi(this, 7, (byte[])null, (byte[])null));
    }
    
    public agpl(final ParentToolsResult parentToolsResult) {
    ...
    public agpl(final byte[] array) {
        this.a = 3;
    }
    
    public agpl(final byte[] array, final byte[] array2) {
        this.b = new long[32];
    }
    ...
    public final void h(final amsx b) {
        if (b != null) {
            this.b = b;
            return;
        }
    ...
    public final nox l() {
        return new nox(this, (byte[])null, (byte[])null);
    }
