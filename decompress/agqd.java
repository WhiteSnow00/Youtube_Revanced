...
public final class agqd implements qla
{
    ...
    public final void a() {
        ...
        //     3: ifeq            7
        //     6: return         
        //     7: getstatic       agqd.a:Ljava/util/concurrent/atomic/AtomicBoolean;
        //    10: iconst_1       
        //    11: invokevirtual   java/util/concurrent/atomic/AtomicBoolean.getAndSet:(Z)Z
        //    14: ifne            146
        //    17: ldc             "AndroidLoggerConfig"
        //    19: invokestatic    aewp.o:(Ljava/lang/String;)Laeux;
        //    22: astore_1       
        //    23: aload_0        
        //    24: getfield        agqd.b:Lagqc;
        //    27: astore_2       
        //    28: getstatic       afoj.a:Ljava/util/concurrent/atomic/AtomicBoolean;
        //    31: iconst_0       
        //    32: iconst_1       
        //    33: invokevirtual   java/util/concurrent/atomic/AtomicBoolean.compareAndSet:(ZZ)Z
        //    36: ifeq            94
        //    39: getstatic       afoo.a:Ljava/util/concurrent/atomic/AtomicReference;
        //    42: astore_3       
        //    43: aload_3        
        //    44: aconst_null    
        //    45: aload_2        
        ...
        //    49: ifeq            72
        //    52: invokestatic    afoo.e:()V
        //    55: getstatic       afop.a:Lafop;
        //    58: getfield        afop.b:Ljava/util/concurrent/atomic/AtomicReference;
        //    61: getstatic       afov.a:Lafot;
        //    64: invokevirtual   java/util/concurrent/atomic/AtomicReference.set:(Ljava/lang/Object;)V
        //    67: aload_1        
        //    68: invokevirtual   aeux.close:()V
        //    71: return         
        //    72: aload_3        
        ...
        //   106: astore_2       
        //   107: aload_1        
        //   108: invokevirtual   aeux.close:()V
        //   111: goto            144
        //   114: astore_1       
