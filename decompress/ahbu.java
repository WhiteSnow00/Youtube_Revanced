...
public final class ahbu extends ahby
{
    ...
    public ahbu(final byte[] f, final int n, final int n2) {
    ...
    public final String A() {
        ...
        if (k > 0) {
            ...
            final int i = this.i;
            if (k <= g - i) {
                final String g2 = ahgb.g(this.f, i, k);
                this.i += k;
                return g2;
            }
        }
    ...
    public final int j() {
        ...
        if (this.g - i >= 4) {
            final byte[] f = this.f;
            this.i = i + 4;
            return (f[i + 3] & 0xFF) << 24 | ((f[i + 1] & 0xFF) << 8 | (f[i] & 0xFF) | (f[i + 2] & 0xFF) << 16);
        }
        throw ahds.j();
    }
    ...
    public final ahbt x() {
        ...
        if (k > 0) {
            ...
            final int i = this.i;
            if (k <= g - i) {
                final ahbt z = ahbt.z(this.f, i, k);
                this.i += k;
                return z;
            }
        }
    ...
    public final MessageLite y(final ahev ahev, final ExtensionRegistryLite extensionRegistryLite) {
        ...
        ++this.a;
        final Object n = ahev.n((ahby)this, extensionRegistryLite);
        this.B(0);
        --this.a;
        if (this.d() == 0) {
            this.C(f);
    ...
    public final String z() {
        ...
        if (k > 0) {
            ...
            final int i = this.i;
            if (k <= g - i) {
                final String s = new String(this.f, i, k, ahdq.a);
                this.i += k;
                return s;
            }
        }
