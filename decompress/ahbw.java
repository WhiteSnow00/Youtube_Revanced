...
final class ahbw extends ahby
{
    ...
    public ahbw(final InputStream f, final int n) {
        this.m = Integer.MAX_VALUE;
        ahdq.i((Object)f, "input");
        this.f = f;
        this.g = new byte[n];
        this.h = 0;
        this.j = 0;
    ...
    public final int d() {
        ...
        final byte[] g = this.g;
        this.j = n + 4;
        return (g[n + 3] & 0xFF) << 24 | ((g[n + 1] & 0xFF) << 8 | (g[n] & 0xFF) | (g[n + 2] & 0xFF) << 16);
    }
    ...
    public final ahbt x() {
        ...
        final int j = this.j;
        if (k <= h - j && k > 0) {
            final ahbt z = ahbt.z(this.g, j, k);
            this.j += k;
            return z;
        }
        if (k != 0) {
    ...
    public final String z() {
        ...
        if (k > 0) {
            ...
            final int j = this.j;
            if (k <= h - j) {
                final String s = new String(this.g, j, k, ahdq.a);
                this.j += k;
                return s;
            }
        }
        ...
        if (k <= this.h) {
            this.T(k);
            final String s2 = new String(this.g, this.j, k, ahdq.a);
            this.j += k;
            return s2;
        }
        return new String(this.W(k), ahdq.a);
    }
}
