...
public final class ahme extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final ahmh ahmh = (ahmh)ahbh.parseFrom((ahbh)ahmh.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ahmh.b & 0x1) != 0x0) {
                return new ahmf(((ahbh)ahmh).toBuilder());
            }
