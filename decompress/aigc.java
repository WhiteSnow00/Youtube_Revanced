...
public final class aigc extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aige aige = (aige)ahcz.parseFrom(aige.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aige.b & 0x1) != 0x0) {
                return new aigb(aige.toBuilder());
            }
