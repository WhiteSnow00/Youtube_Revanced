...
final class aihd extends vfv
{
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final aihf aihf = (aihf)ahbh.parseFrom((ahbh)aihf.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aihf.b & 0x1) != 0x0) {
                return new aihc(aihf.toBuilder());
            }
