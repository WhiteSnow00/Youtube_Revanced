...
final class aiir extends vhd
{
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aiit aiit = (aiit)ahcz.parseFrom((ahcz)aiit.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aiit.b & 0x1) != 0x0) {
                return new aiiq(((ahcz)aiit).toBuilder());
            }
