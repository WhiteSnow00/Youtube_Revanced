...
final class aiiw extends vhd
{
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aiiy aiiy = (aiiy)ahcz.parseFrom((ahcz)aiiy.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aiiy.b & 0x1) != 0x0) {
                return new aiiv(((ahcz)aiiy).toBuilder());
            }
