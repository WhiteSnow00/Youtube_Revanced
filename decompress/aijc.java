...
public final class aijc extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aije aije = (aije)ahcz.parseFrom((ahcz)aije.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aije.b & 0x1) != 0x0) {
                return new aijb(((ahcz)aije).toBuilder());
            }
