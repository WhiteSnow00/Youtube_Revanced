...
public final class aite extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aitg aitg = (aitg)ahcz.parseFrom(aitg.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aitg.c & 0x1) != 0x0) {
                return new aitd(aitg.toBuilder());
            }
