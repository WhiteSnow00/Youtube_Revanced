...
public final class ajkf extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final ajkh ajkh = (ajkh)ahcz.parseFrom(ajkh.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ajkh.c & 0x1) != 0x0) {
                return new ajke(ajkh.toBuilder());
            }
