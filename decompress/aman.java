...
public final class aman extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amap amap = (amap)ahcz.parseFrom(amap.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amap.c & 0x1) != 0x0) {
                return new amam(amap.toBuilder());
            }
