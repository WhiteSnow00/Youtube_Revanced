...
public final class amaq extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final amas amas = (amas)ahbh.parseFrom((ahbh)amas.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amas.c & 0x1) != 0x0) {
                return new amap((ahbb)((ahbh)amas).toBuilder());
            }
