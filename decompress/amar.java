...
public final class amar implements vfu
{
    ...
    public final amam c() {
        ...
        adkp.R(b2, "entityFromStore is not instance of MainVideoDownloadStateEntityModel, key=downloadState");
        return (amam)b;
    }
    ...
    public final apyj g() {
        ...
        adkp.R(b2, "entityFromStore is not instance of YtMainChannelEntityModel, key=owner");
        return (apyj)b;
    }
