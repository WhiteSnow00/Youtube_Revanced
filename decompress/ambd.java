...
public final class ambd extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final ambf ambf = (ambf)ahcz.parseFrom(ambf.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ambf.c & 0x1) != 0x0) {
                return new ambc(ambf.toBuilder());
            }
