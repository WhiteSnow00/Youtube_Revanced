...
public final class ambi extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final ambl ambl = (ambl)ahcz.parseFrom(ambl.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ambl.c & 0x1) != 0x0) {
                return new ambh(ambl.toBuilder());
            }
