...
final class ambz extends vfv
{
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final amcb amcb = (amcb)ahbh.parseFrom((ahbh)amcb.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amcb.c & 0x1) != 0x0) {
                return new amby(((ahbh)amcb).toBuilder());
            }
