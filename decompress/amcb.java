...
final class amcb extends vhd
{
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amce amce = (amce)ahcz.parseFrom((ahcz)amce.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amce.c & 0x1) != 0x0) {
                return new amca(((ahcz)amce).toBuilder());
            }
