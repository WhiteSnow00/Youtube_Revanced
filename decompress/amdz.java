...
final class amdz extends vhd
{
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final ameb ameb = (ameb)ahcz.parseFrom((ahcz)ameb.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ameb.c & 0x1) != 0x0) {
                return new amdy(((ahcz)ameb).toBuilder());
            }
