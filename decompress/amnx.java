...
public final class amnx extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amnz amnz = (amnz)ahcz.parseFrom(amnz.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amnz.b & 0x1) != 0x0) {
                return new amnw(amnz.toBuilder());
            }
