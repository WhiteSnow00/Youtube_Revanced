...
public final class amud extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amuf amuf = (amuf)ahcz.parseFrom((ahcz)amuf.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amuf.c & 0x1) != 0x0) {
                return new amuc(((ahcz)amuf).toBuilder());
            }
