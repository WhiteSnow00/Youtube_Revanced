...
public final class amws extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amwu amwu = (amwu)ahcz.parseFrom((ahcz)amwu.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amwu.b & 0x1) != 0x0) {
                return new amwr(((ahcz)amwu).toBuilder());
            }
