...
public final class amyl extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final amyn amyn = (amyn)ahcz.parseFrom((ahcz)amyn.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amyn.c & 0x1) != 0x0) {
                return new amyk(((ahcz)amyn).toBuilder());
            }
