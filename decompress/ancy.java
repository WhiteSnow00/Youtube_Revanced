...
public final class ancy implements vfu
{
    ...
    public final ajjv c() {
        ...
        adkp.R(b2, "entityFromStore is not instance of DrmLicenseEntityModel, key=drmLicense");
        return (ajjv)b;
    }
    ...
    public final amwb f() {
        ...
        adkp.R(b2, "entityFromStore is not instance of OfflineVideoPolicyEntityModel, key=offlineVideoPolicy");
        return (amwb)b;
    }
    ...
    public final aoxc h() {
        ...
        adkp.R(b2, "entityFromStore is not instance of TransferEntityModel, key=transfer");
        return (aoxc)b;
    }
