...
public final class anoc extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final anoe anoe = (anoe)ahbh.parseFrom((ahbh)anoe.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((anoe.b & 0x1) != 0x0) {
                return new anob(anoe.toBuilder());
            }
