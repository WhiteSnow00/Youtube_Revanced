...
public final class aoqt extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aoqr aoqr = (aoqr)ahcz.parseFrom(aoqr.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aoqr.b & 0x1) != 0x0) {
                return new aoqs(aoqr.toBuilder());
            }
