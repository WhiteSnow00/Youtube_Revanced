...
final class aowt extends vfv
{
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final aoww aoww = (aoww)ahbh.parseFrom((ahbh)aoww.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aoww.b & 0x1) != 0x0) {
                return new aows(aoww.toBuilder());
            }
