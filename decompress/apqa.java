...
public final class apqa extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final apqc apqc = (apqc)ahcz.parseFrom(apqc.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((apqc.c & 0x1) != 0x0) {
                return new appz(apqc.toBuilder());
            }
