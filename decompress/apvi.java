...
public final class apvi extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final apvl apvl = (apvl)ahcz.parseFrom(apvl.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((apvl.c & 0x1) != 0x0) {
                return new apvh(apvl.toBuilder());
            }
