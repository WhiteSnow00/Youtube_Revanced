...
public final class aqba extends vhd
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vgs b(final byte[] array) {
        try {
            final aqbc aqbc = (aqbc)ahcz.parseFrom(aqbc.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aqbc.c & 0x1) != 0x0) {
                return new aqaz(aqbc.toBuilder());
            }
