...
public final class aqds
{
    ...
    public final afft a() {
        ...
        while (iterator.hasNext()) {
            afel.h((Object)new aqdt((aqdz)((ahaz)((ahbh)iterator.next()).toBuilder()).build(), this.a));
        }
        ...
        while (iterator2.hasNext()) {
            afel2.h((Object)new aqdw((aqee)((ahaz)((ahbh)iterator2.next()).toBuilder()).build(), this.a));
        }
        ...
        while (iterator3.hasNext()) {
            afel3.h((Object)new aqdr((aqdx)((ahaz)((ahbh)iterator3.next()).toBuilder()).build()));
        }
        ...
        while (iterator4.hasNext()) {
            afel4.h((Object)new aqdu((aqea)iterator4.next().toBuilder().build(), this.a));
        }
