...
{
    private static final String a = "aret";
    
    public static CardboardDevice$DeviceParams a(final Context context) {
        return (CardboardDevice$DeviceParams)e((ahen)CardboardDevice$DeviceParams.newBuilder(), "current_device_params", 894990891, true, context);
    }
    
    public static Display$DisplayParams b(final Context context) {
        return (Display$DisplayParams)e((ahen)Display$DisplayParams.newBuilder(), "phone_params", 779508118, false, context);
    }
    ...
    public static boolean c(final Context context) {
        ...
        try {
            ...
            Log.w(aret.a, "Error clearing device parameters: ".concat(ex.toString()));
            b = false;
        }
        if (!b) {
            Log.e(aret.a, "Could not clear Cardboard parameters from storage.");
        }
        return b;
    }
    ...
    public static boolean d(CardboardDevice$DeviceParams allocate, Context o) {
        ...
        if (!b2) {
            Log.e(aret.a, "Could not write Cardboard parameters to storage.");
        }
        return b2;
        Label_0349: {
            if (allocate == null) {
    ...
    private static MessageLite e(final ahen p0, final String p1, final int p2, final boolean p3, final Context p4) {
        // 
        ...
        //    12: aload_1        
        //    13: aload           4
        //    15: invokestatic    aret.f:(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;
        ...
        //    53: iconst_m1      
        //    54: if_icmpne       69
        //    57: getstatic       aret.a:Ljava/lang/String;
        ...
        //    83: iload_2        
        //    84: if_icmpeq       99
        //    87: getstatic       aret.a:Ljava/lang/String;
        ...
        //   118: iconst_m1      
        //   119: if_icmpne       164
        //   122: getstatic       aret.a:Ljava/lang/String;
        ...
        //   139: goto            181
        //   142: astore_1       
        //   143: getstatic       aret.a:Ljava/lang/String;
        ...
        //   192: athrow         
        //   193: astore_1       
        //   194: getstatic       aret.a:Ljava/lang/String;
        ...
        //   234: aload_0        
        //   235: aload_1        
        //   236: invokeinterface ahen.mergeFrom:([B)Lahen;
        //   241: invokeinterface ahen.build:()Lcom/google/protobuf/MessageLite;
        //   246: astore_0       
        //   247: aload_0        
        //   248: areturn        
        //   249: astore_0       
        //   250: getstatic       aret.a:Ljava/lang/String;
