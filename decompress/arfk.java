...
public final class arfk implements GLSurfaceView$Renderer
{
    public GvrSurfaceView a;
    private final GvrApi b;
    
    public arfk(final GvrApi b) {
        if (b != null) {
            this.b = b;
            return;
        }
    ...
    public final void onDrawFrame(final GL10 gl10) {
        ...
        if (renderReprojectionThread != null) {
            arfm.a((Runnable)new auos(this, renderReprojectionThread.x, renderReprojectionThread.y, 1));
        }
    }
