...
public final class arfp extends FrameLayout implements View$OnTouchListener
{
    public int a;
    public boolean b;
    public Runnable c;
    ...
    public arfp(final Context context) {
        super(context);
        this.a = -1;
        this.setOnTouchListener((View$OnTouchListener)this);
        this.setBackground((Drawable)new ColorDrawable(-12232092));
        this.removeAllViews();
        LayoutInflater.from(this.getContext()).inflate(2131625655, (ViewGroup)this, true);
        this.findViewById(2131432187).setOnClickListener((View$OnClickListener)new acvy(this, 16));
        ((ImageView)this.findViewById(2131432181)).setOnClickListener((View$OnClickListener)new acvy(this, 17));
        this.h();
        if (this.getResources().getConfiguration().orientation == 2) {
            this.findViewById(2131432178).setVisibility(8);
        }
    ...
    public static /* bridge */ void e(final arfp arfp) {
        arfp.f(false);
    }
    ...
    private final void f(final boolean b) {
        ...
        ((Animation)alphaAnimation).setAnimationListener((Animation$AnimationListener)new arfo(this));
    ...
    private final void h() {
        final ImageButton f = (ImageButton)((ViewGroup)this.findViewById(2131432180)).findViewById(2131427738);
        this.f = f;
        ...
        this.f.setOnClickListener((View$OnClickListener)new acvy(this, 18));
    }
    ...
    public final void a() {
        if (this.getWidth() > 0 && this.getHeight() > 0 && this.a != -1 && this.e != null) {
            if (!this.b) {
                ...
                if (b != abs > 135) {
                    final View viewById = this.findViewById(2131432180);
                ...
                if (abs <= 135) {
                    ...
                    this.findViewById(2131432178).setVisibility(0);
                }
                this.b = true;
                if (d(this.a)) {
                    this.f(true);
    ...
    public final void c(final String s) {
        final TextView textView = (TextView)this.findViewById(2131432188);
        if (s != null) {
            textView.setText((CharSequence)this.getContext().getString(2132019136, new Object[] { s }));
            return;
        }
        textView.setText((CharSequence)this.getContext().getString(2132019135));
    }
    ...
    public final void setVisibility(final int visibility) {
        ...
        if (visibility2 != visibility) {
            if (visibility == 0) {
                if (this.e == null) {
                    (this.e = new arfn(this, this.getContext())).enable();
                }
            }
            else {
                this.g();
