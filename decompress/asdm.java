...
public final class asdm
{
    ...
    public asdm(Map h, final boolean b, int n, final int n2) {
        ...
        this.d = b2;
        if (b2 != null) {
            adkp.M(b2 >= 0, "maxInboundMessageSize %s exceeds bounds", b2);
        }
        final Integer b3 = ascm.b(h, "maxRequestMessageBytes");
        if ((this.e = b3) != null) {
            adkp.M(b3 >= 0, "maxOutboundMessageSize %s exceeds bounds", b3);
        }
        Map h2;
        if (b) {
        ...
        if (h2 == null) {
            ...
            adkp.M(doubleValue > 0.0, "backoffMultiplier must be greater than 0: %s", doubleValue);
            final Long c3 = ascm.c(h2, "perAttemptRecvTimeout");
            adkp.M(c3 == null || c3 >= 0L, "perAttemptRecvTimeout cannot be negative: %s", c3);
            ...
            adkp.I(c3 != null || !a2.isEmpty(), "retryableStatusCodes cannot be empty without perAttemptRecvTimeout");
    ...
    public final boolean equals(final Object o) {
        ...
        return adkp.ae(this.b, asdm.b) && adkp.ae(this.c, asdm.c) && adkp.ae(this.d, asdm.d) && adkp.ae(this.e, asdm.e) && adkp.ae(this.f, asdm.f) && adkp.ae(this.g, asdm.g);
    }
