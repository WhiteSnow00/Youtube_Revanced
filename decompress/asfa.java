        ...
        switch (this.c) {
            ...
            case 14: {
                try {
                    ...
                    ((audz)a3).a.onCanceled((UrlRequest)((audz)a3).d, (UrlResponseInfo)this.b);
                    ((audz)this.a).b();
                }
            ...
            case 12: {
                try {
                    ...
                    final Throwable t2;
                    ((aueb)this.b).i(new audd("System error", t2));
                }
            }
            case 11: {
                ...
                aueb2.f.add(aueb2.p);
                ((aueb)this.a).o(2, 3, new audk(this, 10, null));
                return;
            }
            case 10: {
                final aueb aueb3 = (aueb)this.a;
                aueb3.c.execute(aueb3.d(new audt(this, 3, null)));
                return;
            }
            case 9: {
                try {
            ...
            case 3: {
                ...
                synchronized (o) {
                    ...
                    try {
                        o = this.a;
                        ((CronetBidirectionalStream)o).a.onResponseTrailersReceived((BidirectionalStream)o, (UrlResponseInfo)((CronetBidirectionalStream)o).g, (UrlResponseInfo$HeaderBlock)this.b);
                    }
