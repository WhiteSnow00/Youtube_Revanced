...
public final class asiw extends InputStream implements InputStreamRetargetInterface, arye
{
    public MessageLite a;
    public final ahev b;
    public ByteArrayInputStream c;
    
    public asiw(final MessageLite a, final ahev b) {
        this.a = a;
        this.b = b;
    }
    ...
    public final int read(final byte[] array, final int n, final int n2) {
        ...
        if (a != null) {
            ...
            if (n2 >= serializedSize) {
                final ahcd am = ahcd.am(array, n, serializedSize);
                this.a.writeTo(am);
                am.an();
                this.a = null;
                this.c = null;
