...
public final class aslv extends RuntimeException
{
    ...
    public aslv(final Iterable iterable) {
        final LinkedHashSet set = new LinkedHashSet();
        final ArrayList list = new ArrayList();
        if (iterable != null) {
            for (final Throwable t : iterable) {
                if (t instanceof aslv) {
                    set.addAll(((aslv)t).a);
                }
                else if (t != null) {
                    set.add(t);
    ...
    public aslv(final Throwable... array) {
    ...
    private final void b(final asls asls) {
    ...
    public final Throwable getCause() {
        ...
        //     1: monitorenter   
        //     2: aload_0        
        //     3: getfield        aslv.c:Ljava/lang/Throwable;
        //     6: ifnonnull       279
        //     9: new             Laslr;
        //    12: astore_3       
        //    13: aload_3        
        //    14: invokespecial   aslr.<init>:()V
        //    17: new             Ljava/util/HashSet;
        //    20: astore          6
        //    22: aload           6
        //    24: invokespecial   java/util/HashSet.<init>:()V
        //    27: aload_0        
        //    28: getfield        aslv.a:Ljava/util/List;
        ...
        //   274: aload_0        
        //   275: aload_3        
        //   276: putfield        aslv.c:Ljava/lang/Throwable;
        //   279: aload_0        
        //   280: getfield        aslv.c:Ljava/lang/Throwable;
        //   283: astore_1       
        //   284: aload_0        
        //   285: monitorexit    
        //   286: aload_1        
