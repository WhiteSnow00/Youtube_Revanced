...
final class ata extends InputStream implements DataInput, InputStreamRetargetInterface
{
    ...
    public ata(final InputStream inputStream, final ByteOrder c) {
        (this.a = new DataInputStream(inputStream)).mark(0);
        this.b = 0;
        this.c = c;
    }
    
    public ata(final InputStream inputStream, final byte[] array) {
        this(inputStream);
    ...
    public ata(final byte[] array) {
        this(new ByteArrayInputStream(array), ByteOrder.BIG_ENDIAN);
    }
    
    public ata(final byte[] array, final byte[] array2) {
        this(array);
        this.a.mark(Integer.MAX_VALUE);
    }
