...
final class atcy extends AtomicInteger implements asku, asln
{
    ...
    public atcy(final asku a, final asmn e) {
        this.a = a;
        this.e = e;
        this.b = new aslm();
        this.d = new atla();
    ...
    public final void tt(final Object o) {
        try {
            final asld asld = (asld)this.e.a(o);
            asng.b(asld, "The mapper returned a null SingleSource");
            this.c.getAndIncrement();
            final atcx atcx = new atcx(this);
            if (!this.h && this.b.c(atcx)) {
                asld.ae(atcx);
            }
        }
        finally {
