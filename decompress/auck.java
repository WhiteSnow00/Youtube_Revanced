...
public final class auck extends ConnectivityManager$NetworkCallback
{
    public Network a;
    public final NetworkChangeNotifierAutoDetect b;
    
    public auck(final NetworkChangeNotifierAutoDetect b) {
        this.b = b;
    }
    ...
    public final void onAvailable(final Network a) {
        ...
        try {
            ...
            NetworkChangeNotifierAutoDetect.-$$Nest$mrunOnThread(this.b, (Runnable)new aucj(this, NetworkChangeNotifierAutoDetect.networkToNetId(a), NetworkChangeNotifierAutoDetect.-$$Nest$fgetmConnectivityManagerDelegate(this.b).a(a), b2, 0));
            if (b != null) {
                b.close();
            }
        }
    ...
    public final void onCapabilitiesChanged(final Network network, final NetworkCapabilities networkCapabilities) {
        ...
        try {
            ...
            NetworkChangeNotifierAutoDetect.-$$Nest$mrunOnThread(this.b, (Runnable)new bsm(this, NetworkChangeNotifierAutoDetect.networkToNetId(network), NetworkChangeNotifierAutoDetect.-$$Nest$fgetmConnectivityManagerDelegate(this.b).a(network), 3));
            if (b != null) {
                b.close();
            }
        }
    ...
    public final void onLosing(final Network network, final int n) {
        ...
        try {
            ...
            NetworkChangeNotifierAutoDetect.-$$Nest$mrunOnThread(this.b, (Runnable)new ypp(this, NetworkChangeNotifierAutoDetect.networkToNetId(network), 14));
            if (b != null) {
                b.close();
            }
        }
    ...
    public final void onLost(final Network network) {
        ...
        try {
            ...
            NetworkChangeNotifierAutoDetect.-$$Nest$mrunOnThread(this.b, (Runnable)new asfa(this, network, 2));
            if (this.a != null) {
                this.a = null;
                ...
                NetworkChangeNotifierAutoDetect.-$$Nest$mrunOnThread(this.b, (Runnable)new aasq(this, this.b.getCurrentNetworkState().getConnectionType(), 20));
            }
            if (b != null) {
                b.close();
            }
