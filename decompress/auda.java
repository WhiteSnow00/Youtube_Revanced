...
public final class auda
{
    ...
    public auda(final Context context, final vai vai) {
        this.b = context.getSystemService("vibrator");
        this.a = vai.f(45382096L);
    ...
    public auda(final atke c, final atke b, final atke d, final tnu tnu) {
        this.c = c;
        this.b = b;
        this.d = d;
        this.a = tnu.m(tnu.aw);
    ...
    public auda(final des b, final arq c, final boolean a, final int[] d, final byte[] array, final byte[] array2, final byte[] array3) {
        this.b = b;
        this.c = c;
        this.a = a;
        this.d = d;
    ...
    public auda(final CharSequence d, final CharSequence b, final CharSequence c, final boolean a) {
        this.d = d;
        this.b = b;
        this.c = c;
        this.a = a;
    ...
    public auda(final String c, final Intent b, final Exception d, final boolean a) {
        this.c = c;
        this.b = b;
        this.d = d;
        this.a = a;
    ...
    public auda(final String b, final byte[][] c, final boolean a, final Date d) {
        this.b = b;
        this.c = c;
        this.a = a;
        this.d = d;
    ...
    public auda(final tgd c, final tff tff) {
    ...
    public auda(final vai vai, final heo d, final byte[] array, final byte[] array2, final byte[] array3, final byte[] array4) {
        this.d = d;
    ...
    public static auda g(final String s) {
        tvb.n(s);
        return new auda(s, null, null, false);
    }
    ...
    public static boolean o(final Editable editable, final KeyEvent keyEvent, final boolean b) {
        if (KeyEvent.metaStateHasNoModifiers(keyEvent.getMetaState())) {
            ...
            final arx[] array = (arx[])editable.getSpans(selectionStart, selectionEnd, (Class)arx.class);
            if (array != null) {
                final int length = array.length;
                if (length > 0) {
                    int i = 0;
                    while (i < length) {
                        final arx arx = array[i];
                        final int spanStart = editable.getSpanStart((Object)arx);
                        final int spanEnd = editable.getSpanEnd((Object)arx);
                        Label_0135: {
                            if (b) {
    ...
    public static boolean p(final InputConnection inputConnection, final Editable editable, int n, int n2, final boolean b) {
        if (editable != null && n >= 0) {
            if (n2 >= 0) {
                ...
                final arx[] array = (arx[])editable.getSpans(n, n2, (Class)arx.class);
                if (array != null) {
                    final int length2 = array.length;
                    if (length2 > 0) {
                        for (final arx arx : array) {
                            final int spanStart = editable.getSpanStart((Object)arx);
                            final int spanEnd = editable.getSpanEnd((Object)arx);
    ...
    public static final void r(final Spannable spannable, final aru aru, final int n, final int n2) {
        spannable.setSpan((Object)new arx(aru), n, n2, 33);
    }
    ...
    public final CronetEngine h(final boolean b) {
        if (!b) {
            return (CronetEngine)((atke)this.c).a();
        }
        if (!this.a) {
            return (CronetEngine)((atke)this.b).a();
        }
        return (CronetEngine)((atke)this.d).a();
    }
    
    public final glm i(final fsr fsr) {
        return ((Map<K, glm>)this.c).get(fsr);
    }
            ...
            if (this.a) {
                ...
                if (o != null) {
                    try {
                        ...
                        ttr.d("Failed to haptics vibrate for video zoom", (Throwable)ex);
                    }
                }
            }
        }
    ...
    public final fon l(final String s) {
        return ((Map<K, fon>)this.b).get(s);
    }
    
    public final void m(final String s, final long n, final Bitmap bitmap, final ImageView$ScaleType imageView$ScaleType) {
        final fon fon = new fon(n, imageView$ScaleType);
        ((Map<String, fon>)this.b).put(s, fon);
        if (!this.a) {
            if (bitmap != null) {
        ...
        ((tgd)this.c).f((Object)new foo(s, fon));
    }
    ...
    public final boolean q(final CharSequence charSequence, int i, final int n, final aru aru) {
        if (aru.b == 0) {
            ...
            if (arv.a.get() == null) {
                arv.a.set(new StringBuilder());
            }
            final StringBuilder sb = arv.a.get();
            sb.setLength(0);
            while (i < n) {
                sb.append(charSequence.charAt(i));
                ++i;
            }
            if (!aie.a((Paint)((arv)c).b, sb.toString())) {
                i = 1;
            }
            else {
                i = 2;
