...
public final class auel extends ExperimentalUrlRequest$Builder
{
    private static final String a = "auel";
    ...
    public auel(final String c, final UrlRequest$Callback d, final Executor e, final aucy b) {
    ...
    public final auek a() {
        final auek b = this.b.b(this.c, this.d, this.e, this.j, this.k, this.h, this.i, this.n, this.o, this.p, this.q, this.r, this.s, this.u, this.t);
    ...
    public final void b(final String s, final String s2) {
        ...
        if ("Accept-Encoding".equalsIgnoreCase(s)) {
            Log.w(auel.a, "It's not necessary to set Accept-Encoding on requests - cronet will do this automatically for you, and setting it yourself has no effect. See https://crbug.com/581399 for details.", (Throwable)new Exception());
            return;
        }
