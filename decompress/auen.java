...
public final class auen extends UrlResponseInfo
{
    public final int a;
    ...
    public auen(final List list, final int a, final String e, final List list2, final boolean b, final String c, final String f, final long n) {
        this.d = Collections.unmodifiableList((List<?>)list);
        this.a = a;
        this.e = e;
        this.h = new auem(Collections.unmodifiableList((List<?>)list2));
        this.b = b;
        this.c = c;
        this.f = f;
