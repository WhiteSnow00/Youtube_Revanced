...
public final class aueo extends ThreadPoolExecutor
{
    ...
    static {
        ...
        c = n + n + 1;
        d = (ThreadFactory)new nej(3, (short[])null);
        e = new ArrayBlockingQueue(128);
    }
    
    public aueo() {
        super(aueo.b, aueo.c, 30L, TimeUnit.SECONDS, aueo.e, aueo.d);
