...
public final class augo extends aufu
{
    private static final String d = "augo";
    public final int b;
    public final augd c;
    private final String e;
    private final ExecutorService f;
    
    public augo(final aufy aufy) {
        final int hashCode = this.hashCode();
        this.b = hashCode;
        final int b = aufy.b(9);
        this.e = aufy.e;
        this.f = new ThreadPoolExecutor(10, 20, 50L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new augm(b));
        final augd a = auge.a(aufy.a);
        this.c = a;
        try {
            a.b(hashCode, new auga(aufy), new augc(this.getVersionString().split("/")[1].split("@")[0]), 4);
        }
        catch (final RuntimeException ex) {
            Log.e(augo.d, "Error while trying to log JavaCronetEngine creation: ", (Throwable)ex);
        }
    }
    ...
    public final String getVersionString() {
        return "CronetHttpURLConnection/".concat(atqv.d());
    }
    ...
    public final /* bridge */ UrlRequest$Builder newUrlRequestBuilder(final String s, final UrlRequest$Callback urlRequest$Callback, final Executor executor) {
        return (UrlRequest$Builder)super.newUrlRequestBuilder(s, urlRequest$Callback, executor);
    }
