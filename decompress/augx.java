...
public final class augx extends auhg
{
    public static final String a = "augx";
    public final augv b;
    ...
    public augx(final augo augo, final UrlRequest$Callback urlRequest$Callback, final Executor executor, final Executor executor2, final String m, final String d, final boolean h, final boolean b, int threadStatsTag, final boolean b2, final int n) {
        ...
        this.l = -1;
        this.h = h;
        this.b = new augv(this, urlRequest$Callback, executor2);
        if (!b) {
            threadStatsTag = TrafficStats.getThreadStatsTag();
        }
        this.c = new augw(new augt(executor, threadStatsTag, b2, n));
        this.r = augo.b;
        this.s = augo.c;
        this.m = m;
        this.d = d;
    ...
    public final void cancel() {
        ...
        final auhj o = this.o;
        b.d.f();
        b.b.execute((Runnable)new ashw(b, (UrlResponseInfo)o, 16));
    }
    
    public final Runnable d(final augy augy) {
        return (Runnable)new ashw(this, augy, 14);
    }
    
    public final Runnable e(final augy augy) {
        return (Runnable)new ashw(this, augy, 11);
    }
    
    public final void f() {
        this.c.execute(new augg(this, 7));
    }
    
    public final void followRedirect() {
        this.o(3, 1, new augg(this, 9));
    }
    ...
    public final void getStatus(final UrlRequest$StatusListener urlRequest$StatusListener) {
        ...
        while (true) {
            switch (value) {
                ...
                case 1: {
                    this.b.b.execute(new augh(new VersionSafeCallbacks$UrlRequestStatusListener(urlRequest$StatusListener), l, 2));
                    return;
                }
                case 5: {
                    l = 14;
    ...
    public final void h(final UploadDataProvider uploadDataProvider, final Executor k) {
        ...
        this.j = new auhq(uploadDataProvider);
        if (this.h) {
            this.k = k;
            return;
        }
        this.k = (Executor)new nrh(k, 3);
    }
    ...
    public final void i(CronetException ex) {
        ...
        final auhj o = this.o;
        b.d.f();
        ex = (CronetException)new asdo(b, (UrlResponseInfo)o, ex, 5);
        try {
    ...
    public final void j(final Throwable t) {
        this.i((CronetException)new aufr("Exception received from UploadDataProvider", t));
    }
    
    public final void k() {
        if (this.j != null && this.u.compareAndSet(false, true)) {
            try {
                this.k.execute(this.e(new augq(this, 5)));
            }
            catch (final RejectedExecutionException ex) {
                Log.e(augx.a, "Exception when closing uploadDataProvider", (Throwable)ex);
            }
        }
    }
    
    public final void l() {
        this.c.execute(new augg(this, 6));
    }
    
    public final void m() {
        this.l = 13;
        this.c.execute(this.d(new augq(this, 4)));
    }
    
    public final void n() {
        this.c.execute(this.d(new augq(this, 6)));
    }
    ...
    public final void read(final ByteBuffer byteBuffer) {
        atqv.b(byteBuffer);
        atqv.c(byteBuffer);
        this.o(4, 5, (Runnable)new ashw(this, byteBuffer, 12));
    }
    
    public final void start() {
        this.l = 10;
        this.o(0, 1, new augg(this, 8));
    }
}
