...
public final class auhz extends HttpURLConnection
{
    public final auie a;
    public UrlRequest b;
    public final auib c;
    ...
    public auhz(final URL url, final CronetEngine h) {
        super(url);
        this.h = h;
        this.a = new auie();
        this.c = new auib(this);
        this.i = new ArrayList();
    }
    
    static URL a(final auhz auhz) {
        return auhz.url;
    }
    
    static boolean c(final auhz auhz) {
        return auhz.instanceFollowRedirects;
    }
    
    static boolean d(final auhz auhz) {
        return auhz.instanceFollowRedirects;
    }
    
    static /* bridge */ void e(final auhz auhz) {
        auhz.n = true;
    }
    
    static void f(final auhz auhz, final URL url) {
        auhz.url = url;
    }
    ...
    private final void m() {
        ...
        final ExperimentalUrlRequest$Builder experimentalUrlRequest$Builder = (ExperimentalUrlRequest$Builder)this.h.newUrlRequestBuilder(this.getURL().toString(), (UrlRequest$Callback)new auhy(this), (Executor)this.a);
        if (this.doOutput) {
    ...
    public final OutputStream getOutputStream() {
        if (this.d == null && this.doOutput) {
            ...
            if (this.n()) {
                this.d = new auhv(this.chunkLength, this.a);
                this.m();
            }
            else {
                ...
                if (fixedContentLengthLong != -1L) {
                    this.d = new auhx(fixedContentLengthLong, this.a);
                    this.m();
                }
                else {
                    ...
                    if (requestProperty == null) {
                        ...
                        this.d = new auht(Long.parseLong(requestProperty));
                    }
                }
            }
        }
