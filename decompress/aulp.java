...
public final class aulp extends BroadcastReceiver implements auli
{
    public final aulh a;
    ...
    public aulp(aulh aulh, final Context b) {
        final HashSet g = new HashSet();
        this.g = g;
        this.a = aulh;
        this.b = b;
        final aull e = new aull(b, (Set)g, (String)aulh.a);
        this.e = e;
        aulh = null;
        this.l = new auch(b, (byte[])null);
        final aulm b2 = e.b();
        this.j = a(b2);
        this.k = this.d(b2);
        ...
        if (e.d()) {
            ...
            this.c = (ConnectivityManager$NetworkCallback)aulh;
            final auln d = new auln(this, this.g);
            this.d = (ConnectivityManager$NetworkCallback)d;
            final aull e2 = this.e;
    ...
    public static NetworkChangeDetector$ConnectionType a(final aulm aulm) {
        return b(aulm.a, aulm.b, aulm.c);
    }
    ...
    private final String d(final aulm aulm) {
        if (a(aulm) != NetworkChangeDetector$ConnectionType.c) {
            return "";
        }
