...
public final class bbc
{
    ...
    public bbc(final int n, byte[] ex, final long n2, final long n3) {
        try {
            ...
            final SecretKeySpec secretKeySpec = new SecretKeySpec((byte[])(Object)ex, baz.aq(instance.getAlgorithm(), "/")[0]);
    ...
    public bbc(final int n, final byte[] array, final String s, final long n2) {
        long n3 = 0L;
        long n4;
        if (s == null) {
            n4 = n3;
    ...
    public final void a(final byte[] array, int b, int i, final byte[] array2, int e) {
        do {
            ...
            if (e2 > 0) {
                ...
                e = this.b - n;
                this.e = e;
                bad.f(this.b(this.c, 0, e, this.d, 0) == this.b && b3);
                while (i < n) {
                    array2[b] = this.d[i];
                    ++i;
                    ++b;
