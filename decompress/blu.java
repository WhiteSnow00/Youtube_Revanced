...
public final class blu extends MediaCodec$Callback
{
    ...
    public blu(final HandlerThread b) {
        this.a = new Object();
        this.b = b;
        this.j = new ize((byte[])null, (byte[])null);
        this.k = new ize((byte[])null, (byte[])null);
