...
public final class bmn
{
    ...
    public static Pair a(ayh ayh) {
        final String k = ayh.k;
        if (k == null) {
            return null;
        }
        final String[] split = k.split("\\.");
        final boolean equals = "video/dolby-vision".equals(ayh.n);
        final int n = 2;
        if (equals) {
            final String i = ayh.k;
            if (split.length < 3) {
                baq.c("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: ".concat(String.valueOf(i)));
            }
            else {
                final Matcher matcher = bmn.b.matcher(split[1]);
                if (!matcher.matches()) {
                    baq.c("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: ".concat(String.valueOf(i)));
                }
                else {
                    ...
                    if (o == null) {
                        baq.c("MediaCodecUtil", "Unknown Dolby Vision profile string: ".concat(String.valueOf(group)));
                    }
                    else {
                        ...
                        baq.c("MediaCodecUtil", "Unknown Dolby Vision level string: ".concat(String.valueOf(s)));
                    }
                }
            }
            return null;
        ...
        switch (n3) {
            ...
            case 6: {
                final String j = ayh.k;
                if (split.length == 3) {
                    Pair pair2;
                    try {
                        if (!"audio/mp4a-latm".equals(aza.e(Integer.parseInt(split[1], 16)))) {
                            return null;
                        }
                        ...
                        baq.c("MediaCodecUtil", "Ignoring malformed MP4A codec string: ".concat(String.valueOf(j)));
                        return null;
                    }
                    return pair2;
                }
                ...
                if (split.length >= 4) {
                    ...
                    try {
                        ...
                        if (int2 != 0) {
                            ...
                            sb.append(int2);
                            baq.c("MediaCodecUtil", sb.toString());
                            return null;
                        }
                        int n5 = 0;
                        Label_1571: {
                            if (int4 != 8) {
                                if (int4 != 10) {
                                    ...
                                    sb2.append(int4);
                                    baq.c("MediaCodecUtil", sb2.toString());
                                    return null;
                                }
                                Label_1564: {
                                    if (z != null) {
                        ...
                        if (n6 == -1) {
                            ...
                            sb3.append(int3);
                            baq.c("MediaCodecUtil", sb3.toString());
                            return null;
                        }
                        pair3 = new Pair((Object)n5, (Object)n6);
                    }
                    catch (final NumberFormatException ex2) {
                        baq.c("MediaCodecUtil", "Ignoring malformed AV1 codec string: ".concat(String.valueOf(l)));
                        return null;
                    }
                    return pair3;
                }
            ...
            case 3:
            case 4: {
                final String m = ayh.k;
                if (split.length < 4) {
                    baq.c("MediaCodecUtil", "Ignoring malformed HEVC codec string: ".concat(String.valueOf(m)));
                }
                else {
                    final Matcher matcher2 = bmn.b.matcher(split[1]);
                    if (!matcher2.matches()) {
                        baq.c("MediaCodecUtil", "Ignoring malformed HEVC codec string: ".concat(String.valueOf(m)));
                    }
                    else {
                        ...
                        if ("1".equals(group2)) {
                            ...
                            if (!"2".equals(group2)) {
                                baq.c("MediaCodecUtil", "Unknown HEVC profile string: ".concat(String.valueOf(group2)));
                                return null;
                            }
                            n7 = 2;
                        }
                        ...
                        baq.c("MediaCodecUtil", "Unknown HEVC level string: ".concat(String.valueOf(s3)));
                    }
                }
                return null;
            }
            case 2: {
                ...
                if (split.length >= 3) {
                    try {
                        ...
                        if (n10 == -1) {
                            ayh = (ayh)new StringBuilder("Unknown VP9 profile: ");
                            ((StringBuilder)ayh).append(int5);
                            baq.c("MediaCodecUtil", ((StringBuilder)ayh).toString());
                            return null;
                        }
                        if (int6 != 10) {
                            if (int6 != 11) {
                        ...
                        if (n9 == -1) {
                            ayh = (ayh)new StringBuilder("Unknown VP9 level: ");
                            ((StringBuilder)ayh).append(int6);
                            baq.c("MediaCodecUtil", ((StringBuilder)ayh).toString());
                            return null;
                        }
                        ayh = (ayh)new Pair((Object)n10, (Object)n9);
                    }
                    catch (final NumberFormatException ex3) {
                        baq.c("MediaCodecUtil", "Ignoring malformed VP9 codec string: ".concat(String.valueOf(ayh)));
                        return null;
                    }
                    return (Pair)ayh;
                }
            ...
            case 1: {
                ...
                if (length < 2) {
                    baq.c("MediaCodecUtil", "Ignoring malformed AVC codec string: ".concat(String.valueOf(ayh)));
                }
                else {
                    try {
                        int n11;
                        ...
                        if (split[1].length() == 6) {
                            ...
                            if (length < 3) {
                                ...
                                sb4.append((String)ayh);
                                baq.c("MediaCodecUtil", sb4.toString());
                                return null;
                            }
                        ...
                        if (n13 == -1) {
                            ayh = (ayh)new StringBuilder("Unknown AVC profile: ");
                            ((StringBuilder)ayh).append(n11);
                            baq.c("MediaCodecUtil", ((StringBuilder)ayh).toString());
                        }
                        else {
                            int n14 = 0;
                            ...
                            if (n14 != -1) {
                                ayh = (ayh)new Pair((Object)n13, (Object)n14);
                                return (Pair)ayh;
                            }
                            ayh = (ayh)new StringBuilder("Unknown AVC level: ");
                            ((StringBuilder)ayh).append(n12);
                            baq.c("MediaCodecUtil", ((StringBuilder)ayh).toString());
                        }
                    }
    ...
    public static String c(final ayh ayh) {
        if ("audio/eac3-joc".equals(ayh.n)) {
            return "audio/eac3";
        }
    ...
    public static List d(final String ex, final boolean b, final boolean b2) {
        monitorenter(bmn.class);
        try {
            final bmk bmk = new bmk((String)ex, b, b2);
            final List list = bmn.c.get(bmk);
            if (list != null) {
                monitorexit(bmn.class);
                return list;
            }
            final int a = baz.a;
            final pnc pnc = new pnc(b, b2);
            try {
                final ArrayList<bmc> list2 = new ArrayList<bmc>();
                final String a2 = bmk.a;
                pnc.a();
            Label_0131:
                for (int length = ((MediaCodecInfo[])pnc.b).length, i = 0; i < length; ++i) {
                    pnc.a();
                    final MediaCodecInfo mediaCodecInfo = ((MediaCodecInfo[])pnc.b)[i];
                    if (baz.a < 29 || !mediaCodecInfo.isAlias()) {
                                    ...
                                    if (s.equalsIgnoreCase(a2)) {
                                        if (s != null) {
                                            try {
                                                ...
                                                try {
                                                    list2.add(new bmc(name, a2, s, capabilitiesForType, hardwareAccelerated, g, b4, b5));
                                                }
                                            ...
                                            sb.append(s);
                                            sb.append(")");
                                            baq.a("MediaCodecUtil", sb.toString());
                                            throw ex;
                                        }
                                        continue Label_0131;
                                    }
                ...
                if (baz.a < 32 && list2.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((bmc)list2.get(0)).a)) {
                    list2.add((bmc)list2.remove(0));
                }
                final afgh o = afgh.o(list2);
                bmn.c.put(bmk, o);
                monitorexit(bmn.class);
                return o;
            }
    ...
    public static List e(final List list, final ayh ayh) {
        final ArrayList list2 = new ArrayList(list);
        f(list2, new bmi(ayh));
        return list2;
    }
    
    private static void f(final List list, final bmm bmm) {
        Collections.sort((List<Object>)list, (Comparator<? super Object>)new lcs(bmm, 1));
    }
    ...
    private static boolean g(final MediaCodecInfo mediaCodecInfo, final String s) {
        ...
        final boolean i = aza.i(s);
        final boolean b = true;
        if (i) {
            return true;
        }
        final String b2 = aewr.b(mediaCodecInfo.getName());
