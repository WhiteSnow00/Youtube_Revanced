...
public final class btj implements btq
{
    ...
    private static final void b(final int n, final List list) {
        switch (n) {
            ...
            case 15: {
                final btm j = btj.c.J(new Object[0]);
                if (j != null) {
                    list.add(j);
                    return;
                }
            ...
            case 8: {
                ...
                list.add(new bws(null));
                return;
            }
            case 7: {
                list.add(new bvy(null));
                return;
            }
            case 6: {
                list.add(new bvu(0));
            ...
            case 4: {
                final btm i = btj.b.J(new Object[] { 0 });
                if (i != null) {
                    list.add(i);
                    return;
                }
            ...
            case 3: {
                list.add(new buj(null));
                return;
            }
            case 2: {
                list.add(new bzo(null));
                return;
            }
            case 1: {
                list.add(new bzm(0));
            ...
            case 0: {
                list.add(new bzm(1, null));
                break;
            }
        }
    }
    
    public final btm[] a(final Uri uri, final Map map) {
        monitorenter(this);
        try {
            ...
            final btm[] array = (btm[])list.toArray(new btm[list.size()]);
            monitorexit(this);
            return array;
        }
        finally {
