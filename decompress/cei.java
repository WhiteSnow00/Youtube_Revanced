...
final class cei extends Preference
{
    private long a;
    
    public cei(final Context context, final List list, final long n) {
        super(context);
        super.B = 2131624419;
        this.H(fc.b(super.j, 2131231422));
        super.r = 2131231422;
        this.M(2132018030);
        this.J(999);
        ...
        while (iterator.hasNext()) {
            ...
            if (list2.contains(preference.E)) {
                ...
                if (string == null) {
                    ...
                    string = super.j.getString(2132019919, new Object[] { string, q });
                }
            }
        }
        this.n(string);
