...
final class cfc
{
    ...
    public static final Preference a(final XmlPullParser xmlPullParser, final PreferenceGroup preferenceGroup, final Context context, final Object[] array, final cfg cfg, final String[] array2) {
        monitorenter(array);
        try {
                ...
                while (true) {
                    ...
                    if (next == 2) {
                        ...
                        if ((preferenceGroup3 = preferenceGroup) == null) {
                            ((Preference)preferenceGroup2).A(cfg);
                            preferenceGroup3 = preferenceGroup2;
                        }
                        b(xmlPullParser, (Preference)preferenceGroup3, attributeSet, context, array, cfg, array2);
                        monitorexit(array);
    ...
    private static final void b(final XmlPullParser xmlPullParser, final Preference preference, final AttributeSet set, final Context context, final Object[] array, final cfg cfg, final String[] array2) {
        ...
        while (true) {
            ...
            b(xmlPullParser, d, set, context, array, cfg, array2);
        }
    }
    ...
    private static final Preference c(final String s, final String[] array, final AttributeSet set, final Context context, final Object[] array2) {
        Label_0205: {
            ...
            if ((constructor = cfc.c.get(s)) != null) {
                break Label_0205;
            }
            Label_0223: {
                try {
                    ...
                    constructor = forName2.getConstructor((Class<?>[])cfc.b);
                    constructor.setAccessible(true);
                    cfc.c.put(s, constructor);
                    break Label_0205;
                }
