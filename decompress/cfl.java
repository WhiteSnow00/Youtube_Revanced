...
public final class cfl implements View$OnKeyListener
{
    final Object a;
    private final int b;
    
    public cfl(final SearchView a, final int b) {
        this.b = b;
        this.a = a;
    }
    
    public cfl(final SeekBarPreference a, final int b) {
        this.b = b;
        this.a = a;
    }
    
    public cfl(final npw a, final int b) {
        this.b = b;
        this.a = a;
    }
