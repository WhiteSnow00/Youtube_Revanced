...
public class ResponsiveShelfLinearLayout extends LinearLayout
{
    ...
    public ResponsiveShelfLinearLayout(final Context context, final AttributeSet set) {
        super(context, set);
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, fyo.b);
