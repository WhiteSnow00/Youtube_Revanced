...
public abstract class IApiPlayerService$Stub extends eod implements IApiPlayerService
{
    ...
    protected final boolean dispatchTransaction(int n, final Parcel parcel, final Parcel parcel2, int n2) {
        switch (n) {
            ...
            case 41: {
                final EmbedsPrewarmData embedsPrewarmData = (EmbedsPrewarmData)eoe.a(parcel, EmbedsPrewarmData.CREATOR);
            ...
            case 40: {
                final CommandWrapper commandWrapper = (CommandWrapper)eoe.a(parcel, CommandWrapper.CREATOR);
                this.enforceNoDataAvail(parcel);
            ...
            case 7: {
                ...
                n2 = parcel.readInt();
                this.enforceNoDataAvail(parcel);
                this.q(stringArrayList, n, int1, k2, n2);
                parcel2.writeNoException();
                break;
            }
            case 6: {
                ...
                n2 = parcel.readInt();
                this.enforceNoDataAvail(parcel);
                this.j(stringArrayList2, n, int2, n2);
                parcel2.writeNoException();
                break;
            }
            case 5: {
            ...
            case 1: {
                final VisibilityChangeEventData visibilityChangeEventData = (VisibilityChangeEventData)eoe.a(parcel, VisibilityChangeEventData.CREATOR);
                this.enforceNoDataAvail(parcel);
