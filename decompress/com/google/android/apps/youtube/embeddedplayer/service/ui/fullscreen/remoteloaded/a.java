...
public final class a extends Dialog
{
    ...
    public a(final Context context, final pvh d, final View b, final byte[] array, final byte[] array2, final byte[] array3) {
    ...
    public final void onBackPressed() {
        ((Activity)((l)((aehe)this.d.a).F).a).onBackPressed();
    }
    
    public final boolean onKeyDown(final int n, final KeyEvent keyEvent) {
        return ((aehe)this.d.a).ay(n, keyEvent) || super.onKeyDown(n, keyEvent);
    }
    
    public final boolean onKeyUp(final int n, final KeyEvent keyEvent) {
        return ((aehe)this.d.a).az(n, keyEvent) || super.onKeyUp(n, keyEvent);
    }
