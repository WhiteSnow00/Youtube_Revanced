...
final class a extends hy
{
    ...
    public final void b(final Rect rect, final View view, final RecyclerView recyclerView, final ok ok) {
        ...
        final int dimensionPixelSize = view.getResources().getDimensionPixelSize(2131169357);
        ...
        if (c <= 0) {
            rect.left = view.getResources().getDimensionPixelSize(2131169356);
        }
        final nq m = recyclerView.m;
        if (m != null && c >= m.a() - 1) {
            rect.right = view.getResources().getDimensionPixelSize(2131169356);
        }
    }
}
