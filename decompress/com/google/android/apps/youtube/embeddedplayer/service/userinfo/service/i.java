...
final class i implements SharedPreferences
{
    private final SharedPreferences a;
    private final String b;
    private final uyi c;
    
    public i(final SharedPreferences a, final String b, final uyi c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public final SharedPreferences$Editor edit() {
        return (SharedPreferences$Editor)new h(this.a.edit(), this.b, this.c);
    }
    ...
    public final String getString(final String s, final String s2) {
        if (this.c.K() && s.equals("visitor_id")) {
