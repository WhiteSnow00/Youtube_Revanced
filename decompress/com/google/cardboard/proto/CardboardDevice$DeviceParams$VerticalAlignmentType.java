...
public enum CardboardDevice$DeviceParams$VerticalAlignmentType implements agzm
{
    ...
    static {
        internalValueMap = (agzn)new CardboardDevice$DeviceParams$VerticalAlignmentType$1();
    }
    ...
    public static agzn internalGetValueMap() {
        return CardboardDevice$DeviceParams$VerticalAlignmentType.internalValueMap;
    }
