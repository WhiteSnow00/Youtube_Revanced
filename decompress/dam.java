...
public final class dam
{
    ...
    public static daf c(final Intent intent, final String s) {
        if (intent == null) {
            f("BillingHelper", "Got null intent!");
            return cjf.c(6, "An internal error occurred.");
        }
        return cjf.c(a(intent.getExtras(), s), d(intent.getExtras(), s));
    }
    ...
    public static Bundle h(final dae dae, final boolean b, final boolean b2, final String s) {
        final Bundle bundle = new Bundle();
        bundle.putString("playBillingLibraryVersion", s);
        ...
        if (!TextUtils.isEmpty((CharSequence)dae.b())) {
            bundle.putString("oldSkuPurchaseToken", dae.b());
        }
        if (!TextUtils.isEmpty((CharSequence)dae.a())) {
            bundle.putString("oldSkuPurchaseId", dae.a());
        }
        if (!TextUtils.isEmpty((CharSequence)null)) {
