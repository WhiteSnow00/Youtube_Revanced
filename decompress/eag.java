...
public final class eag extends dzt
{
    ...
    protected final void m(final dzu dzu, final dzo dzo, final dzt dzt, final dzt dzt2) {
        ...
        final dub dub = new dub(m, eag2.m);
        ...
        final Object b = new dub(n, eag2.n).b;
        if (b == null || !(boolean)b) {
            ...
            final eee eee = new eee(list, list2, cya, cya2, null, null);
            b5.a((hd)eee);
            final List c = eee.c;
            if (c != null && c.size() != eee.e.size()) {
                ...
                for (int k = 0; k < eee.a; ++k) {
                    list3.add(new dub(eee.b.get(k), null));
                }
                eee.f.addAll(list3);
