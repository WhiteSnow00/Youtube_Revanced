...
public final class eqd implements atke
{
    ...
    private final Object b() {
        ...
        switch (e) {
            ...
            case 90: {
                return new fzw(esn.aq(this.c), eqy.kK(this.a), null, (short[])null);
            }
            case 89: {
                return new ger();
            }
            ...
            case 79: {
                ...
                final eqy a9 = this.a;
                return new hmw(aq, ab, ac, ag, eqy.pn(a9), eqy.vx(a9), null);
            }
            case 78: {
            ...
            case 52: {
                ...
                final esr d7 = this.d;
                return new abrj(ft, eu, esr.an(d7), esr.ai(d7), esr.at(d7), esr.I(d7), esr.ah(d7), esn.ap(this.c), esr.Y(d7), (byte[])null, (byte[])null);
            }
            case 51: {
