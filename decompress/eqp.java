...
final class eqp implements atke
{
    ...
    public final Object a() {
        switch (this.c) {
            ...
            case 87: {
                final eqq b = this.b;
                return new abuj(eqq.at(b), eqq.ak(b), (trc)eqy.vM(this.a).a(), (abjj)eqq.af(this.b).a(), (aanx)eqq.am(this.b).a(), eqq.b(this.b), (aukf)eqy.vK(this.a).a(), (byte[])null, (byte[])null);
            }
            case 86: {
            ...
            case 47: {
                return new abqp((vjm)eqy.sS(this.a).a(), (abou)eqq.aK(this.b).a(), (abnl)eqq.bf(this.b).a(), (aglu)eqq.ac(this.b).a(), (Executor)eqy.oN(this.a).a(), (Executor)eqy.fT(this.a).a(), (arwh)eqy.qn(this.a).a(), eqq.bA(this.b), (ablh)eqq.aw(this.b).a(), (abrj)eqy.jt(this.a).a(), eqq.bz(this.b), null, null, null, null, null);
            }
            case 46: {
            ...
            case 22: {
                return new addo((aukf)eqq.aZ(this.b).a(), eqq.bA(this.b), (ablh)eqq.aw(this.b).a(), (aglu)eqq.ac(this.b).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 21: {
            ...
            case 18: {
                ...
                return new aakn(context13, ok, abjj3, eqq.aw(b11), eqq.as(b11), (aboe)eqq.aG(b11).a(), (aulc)eqy.mQ(this.a).a(), (aglu)eqq.ac(this.b).a(), (arwh)eqy.qn(this.a).a(), arlr.b(eqy.oL(this.a)), arlr.b(eqq.aF(this.b)), (abrj)eqy.jt(this.a).a(), null, null, null, null);
            }
            case 17: {
            ...
            case 0: {
                return new abof(eqq.bx(this.b), eqq.bC(this.b), 1, (byte[])null, (byte[])null, (byte[])null);
            }
        }
    }
}
