        ...
        switch (b) {
            ...
            case 18: {
                ...
                if (w.d) {
                    ...
                    w.c();
                    ((asht)((tok)((atke)adet.a).a()).m).Z((asjr)ablr.k).K((asjs)aada.r).Z((asjr)ablr.l).au(300L, TimeUnit.SECONDS, (ashw)asht.I(), atjj.a()).aC((Object)false).ab((asjm)new acpc(w, 5), (asjm)new acpc(w, 6));
                }
            ...
            case 5: {
                ...
                final lgj e2 = ifm.e;
                e2.e = ((vef)e2.g).b().g((Class)amac.class).af(atjj.b((Executor)e2.c)).K((asjs)hus.q).Z((asjr)hzh.u).l((Class)amac.class).aI((asjm)new igm(e2, (byte[])null), (asjm)new iad(e2, 18, (byte[])null));
                ifm.f.a();
                ((idm)ifm.c.a()).a();
                ifm.g.D().R().az().p().an((asjm)new iad(ifm, 17), (asjm)hot.j);
                ((zte)ifm).i = new pvh(ifm);
                ifm.a.g((Object)ifm);
                return;
            }
            case 4: {
