...
public final class esm
{
    ...
    public final void c() {
        ...
        this.h.registerActivityLifecycleCallbacks((Application$ActivityLifecycleCallbacks)new fgy(fzw, this.n, (byte[])null, (byte[])null));
    }
    ...
    public final void h(final boolean b) {
        ...
        if (watchVideoIndexer.d.aa()) {
            watchVideoIndexer.a.W(new MutateRequest(4, (Thing[])null, (String[])null, (String[])null, (ActionImpl)null, (String)null, (String)null));
        }
        if (((vai)this.bc.a()).bA()) {
