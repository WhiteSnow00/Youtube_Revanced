...
public final class ess implements aeqc, arko, arlh, arll
{
    ...
    static /* bridge */ hzn aC(final ess ess) {
        return new hzn(ess.b.iG, (char[])null, null);
    }
    
    static /* bridge */ fzw aG(final ess ess) {
        return new fzw((Context)ess.ak.d.a(), ess.aH(), null, null, null);
    }
    ...
    static /* bridge */ hmw ao(final ess ess) {
        return new hmw((Context)ess.ak.d.a(), (acpk)ess.b.jL.a(), (vcy)ess.ak.F.a(), (aeea)ess.b.a.ck.a(), (wyv)ess.ak.o.a(), null, null, null, null, null, null);
    }
