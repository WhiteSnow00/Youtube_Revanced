...
public final class fvh extends BaseAdapter implements SpinnerAdapter
{
    public final Set a;
    ...
    public fvh(final ViewGroup d, final Spinner e, final int f, final int g, final int i) {
        this.k = -1;
        this.d = d;
        this.e = e;
        this.f = f;
    ...
    private final View c(final ViewGroup viewGroup) {
        ...
        final ViewGroup viewGroup2 = (ViewGroup)inflate.findViewById(2131431636);
        viewGroup2.addView(from.inflate(this.g, viewGroup2, false));
        inflate.setTag(2131431633, (Object)true);
        return inflate;
    }
    ...
    private static final TextView g(final View view) {
        final ViewGroup viewGroup = (ViewGroup)view.findViewById(2131431636);
        final View viewById = viewGroup.findViewById(2131432095);
        TextView textView;
    ...
    public final View getDropDownView(int n, final View view, final ViewGroup viewGroup) {
        ...
        final boolean f = f(view, 2131431635, value);
        final int n2 = 0;
        View inflate;
        if (!f || (inflate = view) == null) {
            inflate = LayoutInflater.from(viewGroup.getContext()).inflate(this.h, viewGroup, false);
            inflate.setTag(2131431635, (Object)value);
        }
        final fvg fvg = this.j.get(n);
        final TextView textView = (TextView)inflate.findViewById(2131432095);
        if (fvg.d()) {
            textView.setBackground((Drawable)new ColorDrawable(tpe.cx(this.d.getContext(), 2130970822).orElse(0)));
        }
        else {
            textView.setBackground((Drawable)null);
        }
        textView.setText(fvg.a());
        ...
        while (iterator.hasNext()) {
            ike.b(((fve)((pvh)iterator.next()).a).e, (MessageLite)fvg.b());
        }
        return inflate;
    }
    ...
    public final View getView(int selectedItemPosition, final View view, final ViewGroup viewGroup) {
        ...
        View c;
        if (!f(view, 2131431633, true) || (c = view) == null) {
            c = this.c(viewGroup);
        }
        final TextView g = g(c);
