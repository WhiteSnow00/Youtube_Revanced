...
public final class fys extends oj
{
    final ScrollToTopLinearLayoutManager a;
    private final boolean n;
    private final int o;
    private float p;
    
    public fys(final ScrollToTopLinearLayoutManager a, final Context context, final boolean n, final int n2) {
        this.a = a;
        super(context);
        this.n = n;
