...
public final class fyv implements View$OnClickListener
{
    ...
    public fyv(final TextView b, final int c, final int f) {
        this.b = b;
        this.c = c;
        this.f = f;
        this.d = false;
        ...
        ofInt.addListener((Animator$AnimatorListener)new gtd(this, 1));
        b.addOnLayoutChangeListener((View$OnLayoutChangeListener)new fti(this, 3));
        this.c();
    }
