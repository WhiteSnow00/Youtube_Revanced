...
public final class gk extends ep implements jn
{
    ...
    public gk(final Activity activity, final boolean b) {
        ...
        this.k = true;
        this.z = true;
        this.p = (anl)new gh(this);
        this.q = (anl)new gi(this);
        this.r = new pvh(this);
    ...
    private final void G(final View view) {
        ...
        if (d != null && this.e != null && c != null) {
            ...
            if (dimensionPixelSize != 0) {
                anb.U((View)this.c, (float)dimensionPixelSize);
            }
        ...
        if (F(this.l, this.m, this.y)) {
                ...
                Label_0316: {
                    Label_0266: {
                        if (this.j == 0) {
                            ...
                            final hv n4 = new hv();
                            final bx ab = anb.aB((View)this.c);
                            ab.v(0.0f);
                            ab.aa(this.r);
                            n4.f(ab);
                            if (this.k) {
            ...
            Label_0563: {
                if (this.j == 0) {
                    ...
                    final bx ab3 = anb.aB((View)this.c);
                    ab3.v(n8);
                    ab3.aa(this.r);
                    n6.f(ab3);
                    if (this.k) {
    ...
    public final hm c(final hl hl) {
        ...
        this.b.k(false);
        this.e.i();
        final gj g2 = new gj(this, this.e.getContext(), hl);
        g2.a.s();
        try {
            final boolean c = g2.b.c((hm)g2, (Menu)g2.a);
            g2.a.r();
            if (c) {
                (this.g = g2).g();
                this.e.h((hm)g2);
