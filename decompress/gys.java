...
public final class gys implements ttg
{
    ...
    public final void a(Object o) {
        ...
        if (a.l != null && a.n) {
            adkp.I(a.m.h(), "Source video uri missing when loading media in MEAudioPlayer");
            try {
                a.o.clear();
                final rcp l = a.l;
                l.getClass();
                ...
                if (d2 != null && !d2.equals((Object)Uri.EMPTY)) {
                    ...
                    if (k.b) {
                        ...
                        final ahaz builder = aqsh.a.createBuilder();
                ...
                final rcp l4 = a.l;
                l4.getClass();
                l4.d((Callable)new pak(l4, Duration.ofMillis(c), 9));
                final rcp l5 = a.l;
                l5.getClass();
                l5.c(true);
                final rcp l6 = a.l;
                l6.getClass();
                l6.e = Optional.ofNullable((Object)new gyt(a));
                final rcp l7 = a.l;
                l7.getClass();
                l7.h(Duration.ZERO);
            }
