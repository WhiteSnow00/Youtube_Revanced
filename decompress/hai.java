            ...
            case 17: {
                ...
                if (!hjw.c.get()) {
                    if (akql != null && (akql.b & 0x2) != 0x0) {
                        ...
                        final ansc ansc = (ansc)((ahbc)anuv).rx((ahaq)ReelCameraRendererOuterClass.reelCameraRenderer);
                        ...
                        if ((ansc.b & 0x1) != 0x0) {
                            ...
                            if (((ahbc)anuv2).ry((ahaq)ConfirmDialogRendererOuterClass.confirmDialogRenderer)) {
                                anuv anuv3;
                                if ((anuv3 = ansc.f) == null) {
                                    anuv3 = anuv.a;
                                }
                                hjw.b.ba((aixf)((ahbc)anuv3).rx((ahaq)ConfirmDialogRendererOuterClass.confirmDialogRenderer));
                            }
                            final int c = ansc.c;
                            apmd apmd2;
                            aopz aopz;
                            ...
                            if ((((ansh)((ahbc)anuv4).rx((ahaq)ReelEditVideoRendererOuterClass.reelEditVideoRenderer)).b & 0x1) != 0x0) {
                                anuv anuv5;
                                ...
                                if ((apmd = ((ansh)((ahbc)anuv5).rx((ahaq)ReelEditVideoRendererOuterClass.reelEditVideoRenderer)).c) == null) {
                                    apmd = apmd.a;
                                }
                            }
