...
public final class hbr implements tcc
{
    ...
    public final void b(Object a, Object o) {
        final int b = this.b;
        ...
        switch (b) {
            ...
            case 19: {
                final xjr xjr = (xjr)a;
                ((xge)this.a).a.A((xjg)o, (tcc)new ugx(2));
                return;
            }
            case 18: {
                final Uri uri = (Uri)a;
                final Bitmap ap = (Bitmap)o;
                ((wqv)this.a).b.post((Runnable)new wmc(this, ap, 9, (byte[])null));
                ((wqv)this.a).ap = ap;
                return;
            }
            case 17: {
                ((ufh)this.a).u.c((Runnable)new rib(this, (Uri)a, (Drawable)o, 16, (byte[])null));
                return;
            }
            case 16: {
            ...
            case 15: {
                ...
                final aix a4 = zz.a(((koa)this.a).b.getResources(), (Bitmap)o);
                a4.c();
                ((koa)this.a).b.runOnUiThread((Runnable)new jlv(this, a4, 19, (byte[])null));
                return;
            }
            case 14: {
                final Uri uri4 = (Uri)a;
                final Bitmap d = (Bitmap)o;
                ...
                if (!((ios)this.a).o.isCancelled()) {
                    if (s.equals(((ios)this.a).m)) {
                        ...
                        if (n != 2147483647L && n != 0L) {
                            ...
                            o = new ikf(2130970922, new String[] { jgk.A((Context)ios.p.a, n, false) });
                            tpe.v((View)ios.h, false);
                            tpe.t(ios.g, (CharSequence)((String[])((ikf)o).c)[0]);
                            ios.g.setTextColor(tpe.cx(ios.a, ((ikf)o).a).orElse(0));
            ...
            case 7: {
                ...
                if (aaat2 != null && !((ijz)this.a).ai.isCancelled()) {
                    ...
                    final acko o2 = aj.o;
                    if (o2 != null) {
                        o2.mN(new ackm(), (Object)new fzw(ah));
                    }
                }
                return;
            }
            case 6: {
                ...
                if (fal.v((Context)((igf)this.a).a)) {
                    ...
                    if (p2 != null) {
                        p2.b(Boolean.valueOf(b7 != null && b7 && b2));
            ...
            case 5: {
                ...
                if (c != null && !c.isCancelled()) {
                    ...
                    ifx.a.execute((Runnable)new ifw(ifx, collection2));
                    return;
                }
                ((ifx)this.a).c = null;
                return;
