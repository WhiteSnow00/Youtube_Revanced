...
public final class aapv implements CardboardView$Renderer
{
    ...
    public final void onDrawEye(final CardboardView$Eye cardboardView$Eye) {
        if (this.b && this.a != null) {
            if (cardboardView$Eye.getEyeType() == 0) {
                this.a.onDrawEye((Eye)new aapu(cardboardView$Eye, 1, this.c.getHeadView()));
                return;
            }
            this.a.onDrawEye((Eye)new aapu(cardboardView$Eye, 2, this.c.getHeadView()));
        }
    }
