...
final class aapx implements GLSurfaceView$Renderer
{
    final GvrView$Renderer a;
    final aaqa b;
    
    public aapx(final aaqa b, final GvrView$Renderer a) {
        this.b = b;
        this.a = a;
    }
    ...
    public final void onDrawFrame(final GL10 gl10) {
        ...
        final Eye b2 = b.b;
        final aapy aapy = (aapy)a;
        aapy.a.onNewFrame(a2);
        aapy.a.onDrawEye(b2);
        ((aapy)this.a).a.onFinishFrame(this.b.c);
    }
