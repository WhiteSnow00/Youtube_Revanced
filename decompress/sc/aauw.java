...
public final class aauw implements aaut, abps, tgg
{
    ...
    public final asir[] lX(final abpu abpu) {
        final asir an = ((ashi)abpu.p().a).j(aale.s(abpu.bM(), 64L)).j(aale.q(1)).an(new aauu(this, 1), (asjm)aaof.h);
        asir asir;
        if (((vai)abpu.ci().g).bw()) {
            asir = ((ashi)abpu.cc().a).an(new aauu(this, 0), (asjm)aaof.h);
        }
        else {
            asir = abpu.cc().c().j(aale.s(abpu.bM(), 64L)).j(aale.q(0)).an(new aauu(this, 0), (asjm)aaof.h);
        }
