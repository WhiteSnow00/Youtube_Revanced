...
public final class aawr implements aarf, aatw, abps, tgg
{
    ...
    public aawr(final aaqz a, final aeea o, final atke k, final atke l, final aawv b, final abrj n, final byte[] array, final byte[] array2, final byte[] array3, final byte[] array4) {
        ...
        a.m = (Runnable)new aaog(new afhd(this), 8, (byte[])null, (byte[])null, (byte[])null);
        final aaqc f = a.f;
        if (f != null) {
            f.h(a.m);
        }
    ...
    public final asir[] lX(final abpu abpu) {
        asir asir;
        if (((vai)abpu.ci().g).bw()) {
            asir = ((ashi)abpu.cc().a).an(new aauu(this, 4), (asjm)aaof.k);
        }
        else {
            asir = abpu.cc().c().j(aale.s(abpu.bM(), 256L)).j(aale.q(0)).an(new aauu(this, 4), (asjm)aaof.k);
        }
