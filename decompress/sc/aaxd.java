...
final class aaxd implements aaxf
{
    ...
    public final aaxg a(final aawy aawy) {
        final int c = this.c;
        if (c == 0) {
            return new aaxe(this, aawy.d((xag)this.b, (WatchNextResponseModel)this.d, aawy.g), this.a, 0);
        }
        if (c != 1) {
            ...
            return new aaxi((xag)this.d, (aiqj)this.b, 1);
        }
        return new aaxe(this, aawy.c((xag)this.b, (PlayerResponseModel)this.d, aawy.g), this.a, 1, null);
    }
