...
public final class aazh implements abps, tgg
{
    ...
    public final asir[] lX(final abpu abpu) {
        final asir an = ((ashi)abpu.p().a).j(aale.s(abpu.bM(), 2048L)).j(aale.q(1)).an(new aauu(this, 13), (asjm)aaof.o);
        final asir an2 = ((ashi)abpu.p().e).j(aale.s(abpu.bM(), 2048L)).j(aale.q(1)).an(new aauu(this, 14), (asjm)aaof.o);
        asir asir;
        if (((vai)abpu.ci().g).bw()) {
            asir = ((ashi)abpu.cc().a).an(new aauu(this, 15), (asjm)aaof.o);
        }
        else {
            asir = abpu.cc().c().j(aale.s(abpu.bM(), 2048L)).j(aale.q(0)).an(new aauu(this, 15), (asjm)aaof.o);
        }
