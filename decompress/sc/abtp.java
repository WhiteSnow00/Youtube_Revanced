...
public final class abtp
{
    ...
    public abtp(final List list, final List list2, final List list3) {
        final int size = list.size();
        final int size2 = list2.size();
        final boolean b = true;
        adkp.R(size == size2, (Object)"startTimes and endTimes differ in size");
        adkp.R(list.size() == list3.size() && b, (Object)"startTimes and lines differ in size");
