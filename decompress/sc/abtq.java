...
public final class abtq extends View
{
    ...
    public abtq(final Context context) {
        super(context);
        this.setLayerType(1, (Paint)null);
        this.setId(2131431826);
                ...
                if (n != 3) {
                    if (n != 4) {
                        if (n != 5) {
                            ...
                            this.d.setShadowLayer((float)resources.getDimensionPixelSize(2131169863), 0.0f, (float)resources.getDimensionPixelSize(2131169864), this.e.getColor());
                            j = n;
                        }
                    }
                    else {
    ...
    protected final void onLayout(final boolean b, int i, int lineCount, int lineTop, int lineBottom) {
        super.onLayout(b, i, lineCount, lineTop, lineBottom);
        i = View$MeasureSpec.makeMeasureSpec(lineTop - i, 1073741824);
        this.a = this.l(i);
        this.b = this.k(i);
        final StaticLayout a = this.a;
        if (a != null) {
