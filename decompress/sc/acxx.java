...
public final class acxx implements acyk
{
    public xan a;
    private final Map b;
    private byte[] c;
    ...
    public acxx(final byte[] c, final String e) {
        this.c = c;
        this.b = new HashMap();
        this.e = e;
    }
    
    public acxx(final byte[] c, final Map b, final String e) {
        this.c = c;
        this.b = b;
        this.e = e;
    }
    
    public final void a(final adia f) {
        this.f = f;
    }
    ...
    public final acyh e() {
        if (this.d == null) {
            acvg.o(this.f, "SuggestResponseNull", "JSONResponse");
            final byte[] c = this.c;
            if (c == null || c.length == 0) {
                return null;
            }
            try {
                this.d = new String(c, cjj.d(this.b, "ISO-8859-1"));
            }
        ...
        if (this.d.isEmpty()) {
            acvg.o(this.f, "SuggestResponseEmpty", "JSONResponse");
            return null;
        }
        ...
        try {
            ...
            Label_0321: {
                if (jsonArray.length() > 2) {
                    ...
                    try {
                        ...
                        sparseArray.clear();
                        acvg.n("Invalid Group Id found in suggestions", (Throwable)ex2);
                        ttr.b("Invalid group ID found in suggestions");
                        b2 = b;
                        break Label_0321;
                    }
                }
            ...
            while (i < jsonArray2.length()) {
                ...
                list.add(new acyn(string, optInt, 2, array, string2, int1, s2, int2, string3, fromHtml));
                ++i;
            }
            if (b3) {
                Collections.sort((List<Comparable>)list);
            }
            return new acyh((List)list, b2, this.e);
        }
        catch (final IndexOutOfBoundsException ex3) {
            acvg.o(this.f, "IndexOutOfBoundsException", "JSONResponse");
            acvg.n("Could not find valid response data", (Throwable)ex3);
            ttr.d("Could not find valid response data, response was".concat(String.valueOf(this.d)), (Throwable)ex3);
        }
        catch (final JSONException ex4) {
            acvg.o(this.f, "JSONException", "JSONResponse");
            acvg.n("error processing suggestions", (Throwable)ex4);
            ttr.d("error processing suggestions, response was ".concat(String.valueOf(this.d)), (Throwable)ex4);
            goto Label_0759;
        }
    }
