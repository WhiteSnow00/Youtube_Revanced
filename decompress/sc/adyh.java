...
public class adyh extends Drawable implements adyx
{
    private static final String g = "adyh";
    ...
    private final adya s;
    private final adyo t;
    ...
    public adyh(final adyg a) {
        ...
        this.x = new afhd(this);
    }
    
    public adyh(final adym adym) {
        this(new adyg(adym));
    }
    
    public adyh(final Context context, final AttributeSet set, final int n, final int n2) {
        this(adym.c(context, set, n, n2).a());
    }
    ...
    private final void E(final Canvas canvas) {
        if (this.d.cardinality() > 0) {
            Log.w(adyh.g, "Compatibility shadow requested but can't be drawn for all operations in this shape.");
        }
        ...
        if (this.f) {
            ...
            canvas.drawPath(this.j, adyh.h);
            canvas.translate((float)f, (float)g);
        }
    }
    
    private final void F(final Canvas canvas, final Paint paint, final Path path, final adym adym, final RectF rectF) {
        if (adym.g(rectF)) {
            final float n = adym.c.a(rectF) * this.a.k;
    ...
    private final boolean J() {
        ...
        final adyg a2 = this.a;
        final ColorStateList f = a2.f;
        this.v = this.B(null, a2.h, this.r, false);
        final boolean u2 = this.a.u;
        return !akp.b((Object)u, (Object)this.u) || !akp.b((Object)v, (Object)this.v);
    }
    
    public static adyh j(final Context context, final float n) {
        final int y = adds.Y(context, "adyh");
        final adyh adyh = new adyh();
        adyh.m(context);
        adyh.o(ColorStateList.valueOf(y));
        adyh.n(n);
        return adyh;
    }
    ...
    public final void m(final Context context) {
        this.a.b = new adum(context);
        this.G();
    }
    
    public final Drawable mutate() {
        this.a = new adyg(this.a);
        return this;
    }
    ...
    public final void tn(final adym a) {
        this.a.a = a;
        this.invalidateSelf();
    }
