...
public class aelo extends Service
{
    ...
    protected final void dump(final FileDescriptor fileDescriptor, final PrintWriter printWriter, final String[] array) {
        final Iterator iterator = ((aeln)aqsy.k((Object)this.getApplicationContext(), (Class)aeln.class)).bz().e.entrySet().iterator();
    ...
    public final void onDestroy() {
        if (!this.a.isDone()) {
            final aelr bz = ((aeln)aqsy.k((Object)this.getApplicationContext(), (Class)aeln.class)).bz();
            final int b = this.b;
    ...
    public final int onStartCommand(final Intent intent, int intExtra, final int n) {
        if ((intExtra & 0x2) == 0x0 && intent != null) {
            final aelr bz = ((aeln)aqsy.k((Object)this.getApplicationContext(), (Class)aeln.class)).bz();
            adkp.M(intent.hasExtra("EXTRA_FUTURE_INDEX"), "Intent missing extra %s", (Object)intent);
            adkp.M(intent.hasExtra("EXTRA_PROCESS_UUID"), "Intent missing extra %s", (Object)intent);
            adkp.M(intent.hasExtra("EXTRA_PROCESS_UUID2"), "Intent missing extra %s", (Object)intent);
