...
public final class afqm extends ahbh implements ahcw
{
    ...
    public static final afqm DEFAULT_INSTANCE;
    ...
    static {
        ahbh.registerDefaultInstance((Class)afqm.class, (ahbh)(DEFAULT_INSTANCE = new afqm()));
    }
    ...
    protected final Object dynamicMethod(final ahbg ahbg, final Object o, final Object o2) {
        ...
        switch (ahbg.ordinal()) {
            ...
            case 6: {
                final ahdd parser;
                if ((parser = afqm.PARSER) == null) {
                    synchronized (afqm.class) {
                        if (afqm.PARSER == null) {
                            afqm.PARSER = (ahdd)new ahba((ahbh)afqm.DEFAULT_INSTANCE);
                        }
                    }
                }
                return parser;
