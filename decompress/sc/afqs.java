...
public final class afqs extends ahbh implements ahcw
{
    ...
    public static final afqs DEFAULT_INSTANCE;
    ...
    public afqm asyncReprojectionConfig_;
    ...
    private afqq performanceOverlayInfo_;
    public afqr screenCaptureConfig_;
    ...
    static {
        ahbh.registerDefaultInstance((Class)afqs.class, (ahbh)(DEFAULT_INSTANCE = new afqs()));
    }
    
    private afqs() {
    }
    
    public static void a(final afqs afqs) {
        afqs.bitField0_ |= 0x200000;
        afqs.allowHighPriorityAppRenderThread_ = true;
    }
    ...
    protected final Object dynamicMethod(final ahbg ahbg, final Object o, final Object o2) {
        ...
        switch (ahbg.ordinal()) {
            ...
            case 6: {
                final ahdd parser;
                if ((parser = afqs.PARSER) == null) {
                    synchronized (afqs.class) {
                        if (afqs.PARSER == null) {
                            afqs.PARSER = (ahdd)new ahba((ahbh)afqs.DEFAULT_INSTANCE);
                        }
                    }
                }
                return parser;
