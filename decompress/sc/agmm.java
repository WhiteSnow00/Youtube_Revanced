...
public final class agmm
{
    ...
    public agmm(final FirebaseMessaging a, final agkp b) {
        this.a = a;
        this.b = b;
    }
    ...
    final void a() {
        ...
        //     6: ifne            160
        //     9: aload_0        
        //    10: getfield        agmm.a:Lcom/google/firebase/messaging/FirebaseMessaging;
        //    13: getfield        com/google/firebase/messaging/FirebaseMessaging.c:Lagia;
        //    16: invokevirtual   agia.a:()Landroid/content/Context;
        //    19: astore_1       
        //    20: aload_1        
        ...
        //   117: aload_0        
        //   118: aload_1        
        //   119: putfield        agmm.e:Ljava/lang/Boolean;
        //   122: aload_1        
        //   123: ifnonnull       152
        //   126: new             Lagml;
        //   129: astore_1       
        //   130: aload_1        
        //   131: aload_0        
        //   132: invokespecial   agml.<init>:(Lagmm;)V
        //   135: aload_0        
        //   136: aload_1        
        //   137: putfield        agmm.d:Lagkn;
        //   140: aload_0        
        //   141: getfield        agmm.b:Lagkp;
        //   144: ldc             Laghv;.class
        //   146: aload_1        
        //   147: invokeinterface agkp.b:(Ljava/lang/Class;Lagkn;)V
        //   152: aload_0        
        //   153: iconst_1       
        //   154: putfield        agmm.c:Z
        //   157: aload_0        
        //   158: monitorexit    
        //   159: return         
        //   160: aload_0        
