...
public final class agmt
{
    ...
    private agmt(final String b, final String c, final long d) {
        this.b = b;
        this.c = c;
        this.d = d;
    }
    
    public static agmt a(final String s) {
        ...
        if (s.startsWith("{")) {
            try {
                ...
                return new agmt(jsonObject.getString("token"), jsonObject.getString("appVersion"), jsonObject.getLong("timestamp"));
            }
