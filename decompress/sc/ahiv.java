...
final class ahiv extends vfv
{
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final ahiy ahiy = (ahiy)ahbh.parseFrom((ahbh)ahiy.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((ahiy.b & 0x1) != 0x0) {
                return new ahiw(((ahbh)ahiy).toBuilder());
            }
