...
public final class aiej extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final aiel aiel = (aiel)ahbh.parseFrom((ahbh)aiel.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((aiel.b & 0x1) != 0x0) {
                return new aiei(aiel.toBuilder());
            }
