...
public final class amun extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final amup amup = (amup)ahbh.parseFrom((ahbh)amup.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((amup.b & 0x1) != 0x0) {
                return new amum(((ahbh)amup).toBuilder());
            }
