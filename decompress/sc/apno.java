...
public final class apno extends vfv
{
    public final int a() {
        return 1;
    }
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final apnq apnq = (apnq)ahbh.parseFrom((ahbh)apnq.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((apnq.c & 0x1) != 0x0) {
                return new apnn(apnq.toBuilder());
            }
