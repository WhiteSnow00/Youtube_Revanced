...
final class apph extends vfv
{
    ...
    public final /* bridge */ vfk b(final byte[] array) {
        try {
            final appj appj = (appj)ahbh.parseFrom((ahbh)appj.a, array, ExtensionRegistryLite.getGeneratedRegistry());
            if ((appj.b & 0x1) != 0x0) {
                return new appg(appj.toBuilder());
            }
