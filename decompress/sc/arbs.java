...
{
    public static final String a = "arbs";
    ...
    public static void a(final int n) {
        ...
        try {
            ...
            Log.e(arbs.a, "Failed to invoke setVrThread: ".concat(method.toString()));
            return;
        }
        catch (final RuntimeException method) {}
        catch (final NoSuchMethodException ex2) {}
        "NMR1".equals(Build$VERSION.CODENAME);
        Log.e(arbs.a, "Failed to acquire setVrThread method: ".concat(method.toString()));
    }
    ...
    public static void b(final Activity activity, final boolean sustainedPerformanceMode) {
        ...
        if (window == null) {
            Log.e(arbs.a, "Activity does not have a window");
            return;
        }
    ...
    public static boolean c(final Activity activity, final boolean b) {
        if (((Context)activity).getPackageManager().hasSystemFeature("android.software.vr.mode")) {
            ...
            try {
                ...
                Log.w(arbs.a, "Failed to set VR mode: ".concat(ex.toString()));
            }
            catch (final PackageManager$NameNotFoundException ex2) {
                Log.w(arbs.a, "No VR service component: ".concat(ex2.toString()));
                    ...
                    while (true) {
                        while (iterator.hasNext()) {
                            if (((ApplicationInfo)iterator.next()).packageName.equals("com.google.vr.vrcore")) {
                                ...
                                if (!arbu.m()) {
                                    if (n == -1) {
                                        d((Context)activity, 2132017885, 2132018129, (DialogInterface$OnClickListener)new wsm((Context)activity, 15));
                                        return false;
                                    }
                                    if (n == -2) {
                                        d((Context)activity, 2132017884, 2132018130, (DialogInterface$OnClickListener)new wsm((Context)activity, 16));
                                        return false;
                                    }
                                }
                                Log.w(arbs.a, "Failed to handle missing VrCore package.");
                            }
                        }
                        int n = -1;
                        continue;
    ...
    private static void d(final Context context, final int message, final int n, final DialogInterface$OnClickListener dialogInterface$OnClickListener) {
        ...
        alertDialog$Builder.setMessage(message).setTitle(2132017883).setPositiveButton(n, dialogInterface$OnClickListener).setNegativeButton(2132017612, (DialogInterface$OnClickListener)new gyl(18));
