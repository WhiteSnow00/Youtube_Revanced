...
public final class arcf
{
    ...
    public arcf(final int a, final int l, final int m, final arcg b, final boolean n) {
    ...
    public final void b(final int n) {
        ...
        if (this.g == null) {
            ...
            this.g.setOnFrameAvailableListener((SurfaceTexture$OnFrameAvailableListener)new arce(this, 0), handler);
    ...
    public final void c(final arcc arcc) {
        Object o = this.k;
        synchronized (o) {
            this.j = true;
            monitorexit(o);
