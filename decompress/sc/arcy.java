...
public final class arcy
{
    ...
    public static void a(final Context context) {
        ...
        final List q = aqsx.q(context);
        if (q == null || q.isEmpty()) {
            if (context.checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") != 0) {
                final Activity t = arbu.t(context);
                if (t == null) {
                    Log.w(arcp.a, "An Activity Context is required, aborting storage permission request.");
                }
                else {
                    t.requestPermissions(new String[] { "android.permission.READ_EXTERNAL_STORAGE" }, 239);
                }
            }
        }
        if (list.isEmpty()) {
            final wsm wsm = new wsm(context, 18);
            final AlertDialog$Builder c = c(context);
            c.setTitle(2132020172).setMessage(2132017879).setPositiveButton(2132018129, (DialogInterface$OnClickListener)wsm).setNegativeButton(2132017612, (DialogInterface$OnClickListener)null);
            d(context, c.create());
            return;
        }
    ...
    public static AlertDialog b(final Context context, final Runnable runnable) {
        final wsm wsm = new wsm(context, 17);
        final AlertDialog$Builder c = c(context);
        c.setTitle(2132017880).setMessage(2132017878).setCancelable(false).setPositiveButton(2132017877, (DialogInterface$OnClickListener)wsm).setNegativeButton(2132017876, (DialogInterface$OnClickListener)new gyl(19));
        if (runnable != null) {
            c.setOnCancelListener((DialogInterface$OnCancelListener)new fao(runnable, 16));
        }
    ...
    private static void d(final Context context, final AlertDialog alertDialog) {
        ...
        final Activity t = arbu.t(context);
        if (t != null) {
            alertDialog.getWindow().getDecorView().setSystemUiVisibility(t.getWindow().getDecorView().getSystemUiVisibility());
        }
