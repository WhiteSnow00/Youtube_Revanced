...
public final class arfy implements arfx
{
    final ByteBuffer a;
    
    public arfy(final byte[] array) {
    ...
    public final long d(final long n, final long n2, final WritableByteChannel writableByteChannel) {
        return writableByteChannel.write((ByteBuffer)((ByteBuffer)this.a.position(aqsy.q(n))).slice().limit(aqsy.q(n2)));
    }
    
    public final ByteBuffer e(final long n, final long n2) {
        final int position = this.a.position();
        this.a.position(aqsy.q(n));
        final ByteBuffer slice = this.a.slice();
        slice.limit(aqsy.q(n2));
