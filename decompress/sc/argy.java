...
@arhd(a = 64, b = { 5 })
public final class argy extends argz
{
    ...
    private static final int d(final arha arha) {
        final int b = arha.b(5);
        if (b == 31) {
            return arha.b(6) + 32;
        }
        return b;
    ...
    public final void a(final ByteBuffer byteBuffer) {
        ...
        slice.rewind();
        final arha arha = new arha(slice, (byte[])null);
        this.d = d(arha);
        ...
        switch (d2) {
            ...
            case 26:
            case 27: {
                final int b2 = arha.b(1);
                this.E = b2;
                if (b2 == 1) {
                    if ((this.F = arha.b(2)) != 1) {
                        this.H = arha.b(1);
                        this.I = arha.b(2);
                        if ((this.J = arha.b(1)) == 1) {
                            this.K = arha.b(1);
                        }
                    }
                    if (this.F != 0) {
        ...
        Label_1062: {
            ...
            final int b4 = arha.b(2);
            if ((this.p = b4) == 2 || b4 == 3) {
                throw new UnsupportedOperationException("can't parse ErrorProtectionSpecificConfig yet");
            }
            if (b4 == 3) {
                if ((this.q = arha.b(1)) == 0) {
                    throw new RuntimeException("not implemented");
                }
            }
        }
        if (this.h != 5 && arha.c() >= 16 && (this.r = arha.b(11)) == 695) {
            if ((this.h = d(arha)) == 5 && (this.i = arha.b(1)) == 1) {
                if ((this.k = arha.b(4)) == 15) {
                    this.l = arha.b(24);
                }
                if (arha.c() >= 12 && (this.r = arha.b(11)) == 1352) {
                    this.j = arha.b(1);
                }
            }
            if (this.h == 22) {
                if ((this.i = arha.b(1)) == 1 && (this.k = arha.b(4)) == 15) {
                    this.l = arha.b(24);
                }
                this.m = arha.b(4);
            }
    ...
    public final boolean equals(final Object o) {
        ...
        if (o != null && this.getClass() == o.getClass()) {
            final argy argy = (argy)o;
            return this.A == argy.A && this.z == argy.z && this.B == argy.B && this.d == argy.d && this.g == argy.g && this.u == argy.u && this.t == argy.t && this.q == argy.q && this.p == argy.p && this.J == argy.J && this.h == argy.h && this.m == argy.m && this.v == argy.v && this.C == argy.C && this.l == argy.l && this.k == argy.k && this.o == argy.o && this.s == argy.s && this.D == argy.D && this.P == argy.P && this.Q == argy.Q && this.R == argy.R && this.O == argy.O && this.M == argy.M && this.L == argy.L && this.N == argy.N && this.I == argy.I && this.H == argy.H && this.E == argy.E && this.w == argy.w && this.y == argy.y && this.x == argy.x && this.G == argy.G && this.F == argy.F && this.S == argy.S && this.j == argy.j && this.n == argy.n && this.f == argy.f && this.e == argy.e && this.i == argy.i && this.r == argy.r && this.K == argy.K && Arrays.equals(this.c, argy.c);
        }
        return false;
    }
