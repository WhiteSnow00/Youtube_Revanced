...
public final class arhm extends arhn
{
    private boolean a;
    private byte b;
    private UUID c;
    ...
    public final ByteBuffer b() {
        ...
        cln.l(allocate, (int)(this.a ? 1 : 0));
        if (this.a) {
            cln.n(allocate, (int)this.b);
            final UUID c = this.c;
    ...
    public final void c(ByteBuffer wrap) {
        final int u = cln.u(wrap);
        boolean a = true;
        if (u != 1) {
            a = false;
        }
        this.a = a;
        this.b = (byte)cln.v(wrap);
        final byte[] array = new byte[16];
        wrap.get(array);
