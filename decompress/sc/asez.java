...
final class asez
{
    ...
    public asez(final List b, final Collection c, final Collection d, final asfc f, final boolean g, final boolean a, final boolean h, final int e) {
        ...
        adkp.R(!a || b == null, (Object)"passThrough should imply buffer is null");
        adkp.R(!a || f != null, (Object)"passThrough should imply winningSubstream != null");
        adkp.R(!a || (c.size() == 1 && c.contains(f)) || (c.size() == 0 && f.b), (Object)"passThrough should imply winningSubstream is drained");
        boolean b3 = false;
        Label_0193: {
            if (g) {
                b3 = b2;
        ...
        adkp.R(b3, (Object)"cancelled should imply committed");
    }
    
    final asez a(final asfc asfc) {
        adkp.R(this.h ^ true, (Object)"hedging frozen");
        adkp.R(this.f == null, (Object)"already committed");
