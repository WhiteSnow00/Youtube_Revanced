...
public final class asfp
{
    ...
    final void e(final asfo asfo, Object o) {
        synchronized (this) {
            ...
            adkp.I(o == b, (Object)"Releasing the wrong instance");
            adkp.R(atib.a > 0, (Object)"Refcount has already reached zero");
            if (--atib.a == 0) {
                adkp.R(atib.c == null && b2, (Object)"Destroy task already scheduled");
                if (this.b == null) {
                    this.b = Executors.newSingleThreadScheduledExecutor(asby.k("grpc-shared-destroyer-%d"));
                }
                atib.c = this.b.schedule((Runnable)new ascn((Runnable)new aaxa(this, atib, asfo, o, 11, null)), 1L, TimeUnit.SECONDS);
            }
        }
    }
}
