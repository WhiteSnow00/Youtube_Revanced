...
final class aszz extends AtomicInteger implements ashy, asir
{
    ...
    public aszz(final ashy a, final asjr e) {
        this.a = a;
        this.e = e;
        this.b = new asiq();
        this.d = new atid();
    ...
    public final void tu(final Object o) {
        try {
            final ashq ashq = (ashq)this.e.a(o);
            askk.b((Object)ashq, "The mapper returned a null MaybeSource");
            this.c.getAndIncrement();
            final aszy aszy = new aszy(this);
            if (!this.h && this.b.c(aszy)) {
                ashq.ag(aszy);
            }
        }
        finally {
