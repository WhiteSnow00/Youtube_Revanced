...
public class atzn implements Serializable, Comparable
{
    ...
    static {
        a = new atzn(new byte[0]);
    }
    
    public atzn(final byte[] b) {
        b.getClass();
        this.b = b;
    }
    
    public static final atzn d(final String d) {
        final atzn atzn = new atzn(atzy.c(d));
        atzn.d = d;
        return atzn;
    }
    ...
    private final void readObject(final ObjectInputStream objectInputStream) {
        ...
        if (int1 >= 0) {
            ...
            final atzn atzn = new atzn(array);
            final Field declaredField = atzn.class.getDeclaredField("b");
            declaredField.setAccessible(true);
            declaredField.set(this, atzn.b);
            return;
        }
    ...
    public String c() {
        ...
        while (i < length) {
            final byte b2 = b[i];
            final int n2 = n + 1;
            array[n] = auaa.a[b2 >> 4 & 0xF];
            array[n2] = auaa.a[b2 & 0xF];
            n = n2 + 1;
            ++i;
        }
    ...
    public boolean e(final int n, final byte[] array, final int n2, final int n3) {
        ...
        if (n >= 0) {
            final byte[] b = this.b;
            if (n <= b.length - n3 && n2 >= 0 && n2 <= array.length - n3 && atzy.b(b, n, array, n2, n3)) {
                return true;
            }
        }
        return false;
    ...
    public boolean g(final atzn atzn, final int n) {
        return atzn.e(0, this.b, 0, n);
    }
        ...
        Label_0835:
            ...
            if (n4 == -1) {
                ...
                if (length2 <= 64) {
                    ...
                    final String c2 = new atzn(copyOfRange).c();
                ...
                if ((d = this.d) == null) {
                    final byte[] f = this.f();
                    f.getClass();
                    d = new String(f, atpi.a);
                    this.d = d;
                }
                final String substring = d.substring(0, n4);
                substring.getClass();
                final String p = asfn.p(asfn.p(asfn.p(substring, "\\", "\\\\"), "\n", "\\n"), "\r", "\\r");
                if (n4 < d.length()) {
