...
public final class auai extends InputStream implements InputStreamRetargetInterface
{
    private final byte[] a;
    private int b;
    private int c;
    private final auan d;
    
    public auai(final InputStream inputStream) {
        final auan d = new auan();
        this.d = d;
        this.a = new byte[256];
        this.b = 0;
        this.c = 0;
        try {
            aual.c(d, inputStream);
        }
        catch (final auaj auaj) {
            throw new IOException("Brotli decoder initialization failed", auaj);
        }
    }
        ...
        if (n >= 0) {
            ...
            if (n2 <= length) {
                ...
                try {
                    ...
                    throw new IOException("Brotli stream decoding failed", auaj);
                }
            }
