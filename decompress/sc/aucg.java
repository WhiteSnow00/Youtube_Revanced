...
public final class aucg extends ConnectivityManager$NetworkCallback
{
    LinkProperties a;
    NetworkCapabilities b;
    final NetworkChangeNotifierAutoDetect c;
    
    public aucg(final NetworkChangeNotifierAutoDetect c) {
        this.c = c;
    }
    ...
    private final NetworkChangeNotifierAutoDetect$NetworkState a(final Network network) {
        ...
        if (!hasTransport && !this.b.hasTransport(5)) {
            if (this.b.hasTransport(0)) {
                ...
                final int n = subtype;
                type = 0;
                return new NetworkChangeNotifierAutoDetect$NetworkState(true, type, n, this.b.hasCapability(11) ^ true, String.valueOf(NetworkChangeNotifierAutoDetect.networkToNetId(network)), this.a.isPrivateDnsActive(), this.a.getPrivateDnsServerName());
            }
