...
public final class auct extends ExperimentalBidirectionalStream$Builder
{
    ...
    public auct(final String b, final BidirectionalStream$Callback c, final Executor d, final aucy a) {
