...
public final class audr extends aucy
{
    private static final String d = "audr";
    public final int b;
    public final audh c;
    private final String e;
    private final ExecutorService f;
    
    public audr(final audc audc) {
        final int hashCode = this.hashCode();
        this.b = hashCode;
        final int b = audc.b(9);
        this.e = audc.e;
        this.f = new ThreadPoolExecutor(10, 20, 50L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new audp(b));
        final audh a = audi.a(audc.a);
        this.c = a;
        try {
            a.b(hashCode, new aude(audc), new audg(this.getVersionString().split("/")[1].split("@")[0]), 4);
        }
        catch (final RuntimeException ex) {
            Log.e(audr.d, "Error while trying to log JavaCronetEngine creation: ", (Throwable)ex);
        }
    }
    ...
    public final String getVersionString() {
        return "CronetHttpURLConnection/".concat(atny.d());
    }
