...
public final class auej extends RequestFinishedInfo
{
    ...
    public auej(final String a, final Collection b, final RequestFinishedInfo$Metrics c, final int d, final UrlResponseInfo e, final CronetException f) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
