...
public final class aufd extends HttpURLConnection
{
    public final aufi a;
    public UrlRequest b;
    public final auff c;
    ...
    public aufd(final URL url, final CronetEngine h) {
        super(url);
        this.h = h;
        this.a = new aufi();
        this.c = new auff(this);
        this.i = new ArrayList();
    }
    
    static URL a(final aufd aufd) {
        return aufd.url;
    }
    
    static boolean c(final aufd aufd) {
        return aufd.instanceFollowRedirects;
    }
    
    static boolean d(final aufd aufd) {
        return aufd.instanceFollowRedirects;
    }
    
    static /* bridge */ void e(final aufd aufd) {
        aufd.n = true;
    }
    
    static void f(final aufd aufd, final URL url) {
        aufd.url = url;
    }
    ...
    private final void m() {
        ...
        final ExperimentalUrlRequest$Builder experimentalUrlRequest$Builder = (ExperimentalUrlRequest$Builder)this.h.newUrlRequestBuilder(this.getURL().toString(), (UrlRequest$Callback)new aufc(this), (Executor)this.a);
        if (this.doOutput) {
    ...
    public final OutputStream getOutputStream() {
        if (this.d == null && this.doOutput) {
            ...
            if (this.n()) {
                this.d = new auez(this.chunkLength, this.a);
                this.m();
            }
            else {
                ...
                if (fixedContentLengthLong != -1L) {
                    this.d = new aufb(fixedContentLengthLong, this.a);
                    this.m();
                }
                else {
                    ...
                    if (requestProperty == null) {
                        ...
                        this.d = new auex(Long.parseLong(requestProperty));
                    }
                }
            }
        }
        return (OutputStream)this.d;
    }
