...
public final class bds extends azm
{
    public final int b;
    public final azm[] c;
    private final int d;
    ...
    public bds(final Collection collection, final eg j, final byte[] array, final byte[] array2) {
        this.j = j;
        this.d = j.v();
        ...
        while (iterator.hasNext()) {
            final bfh bfh = (bfh)iterator.next();
            this.c[n] = bfh.a();
            this.g[n] = b;
            this.f[n] = e;
            b += this.c[n].c();
    ...
    public final azk d(final int n, final azk azk, final boolean b) {
        ...
        this.y(u).d(n - this.w(u), azk, b);
        azk.c += x;
        if (b) {
            final Object z = this.z(u);
            final Object b2 = azk.b;
            dk.d(b2);
            azk.b = Pair.create(z, b2);
        }
        return azk;
    }
    ...
    public final azl e(final int n, final azl azl, final long n2) {
        ...
        this.y(v).e(n - x, azl, n2);
        Object b = this.z(v);
        if (!azl.a.equals(azl.b)) {
            b = Pair.create(b, azl.b);
        }
        azl.b = b;
        azl.o += w;
        azl.p += w;
    ...
    protected final int u(final int n) {
        return bax.b(this.f, n + 1, false, false);
    }
    
    protected final int v(final int n) {
        return bax.b(this.g, n + 1, false, false);
    }
    ...
    protected final azm y(final int n) {
        return this.c[n];
    }
