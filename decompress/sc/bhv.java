...
public final class bhv
{
    ...
    public bhv(final vai vai, final fjv fjv, final aun aun, final msr msr, final aanx aanx, final xnt xnt, final asid asid, final vai vai2, final byte[] array, final byte[] array2, final byte[] array3) {
        ...
        msr.Q((Callable)new foq(this, vai, asht.n(fjv.k(), vai2.cn(), (asji)new gcv(xnt, 1)), asid, 0, (byte[])null, (byte[])null, (byte[])null));
    }
    ...
    private static Map.Entry H(final String s, final int n, final int n2) {
        return Map$_CC.entry((Object)s, (Object)new giy(n, n2, (byte[])null));
    }
    ...
    public final void c(final Object o) {
        ...
        if (b) {
            ...
            ((MediaBrowserService$Result)a).sendResult(o3);
            return;
        }
        if (o instanceof Parcel) {
            final Parcel parcel2 = (Parcel)o;
            parcel2.setDataPosition(0);
            ((MediaBrowserService$Result)this.a).sendResult(MediaBrowser$MediaItem.CREATOR.createFromParcel(parcel2));
            parcel2.recycle();
            return;
        }
    ...
    public final frk v(final SwipeRefreshLayout swipeRefreshLayout) {
        ...
        return new frk(skt, swipeRefreshLayout, (byte[])null, (byte[])null, (byte[])null);
    }
