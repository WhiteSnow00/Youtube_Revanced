...
public final class bzr implements bzp
{
    ...
    public bzr(final eab q, final byte[] array, final byte[] array2, final byte[] array3) {
        this.q = q;
    ...
    public final void a(final bas bas) {
        ...
        this.c.c(bas, bas.a());
        while (true) {
            final int a2 = btx.a(a, b, c, this.f);
            if (a2 == c) {
                break;
            }
            final byte[] a3 = bas.a;
            ...
            if (n19 != 0 && n19 != 179) {
                ...
                if (this.p && this.j) {
                    ...
                    if (n22 != -9223372036854775807L) {
                        this.c.e(n22, (int)(this.o ? 1 : 0), (int)(this.h - this.m) - n21, n21, (buc)null);
                    }
                }
                if (!this.i || this.p) {
                    this.m = this.h - n21;
