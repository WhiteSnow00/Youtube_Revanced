...
public final class cae implements cap
{
    private final bzp a;
    private int b;
    private int c;
    ...
    private int i;
    private boolean j;
    private final atim k;
    
    public cae(final bzp a) {
        this.a = a;
        this.k = new atim(new byte[10], (byte[])null);
        this.b = 0;
    }
    ...
    private final boolean e(final bas bas, final byte[] array, final int n) {
        final int min = Math.min(bas.a(), n - this.c);
        if (min <= 0) {
            return true;
        }
        if (array == null) {
    ...
    public final void a(final bas bas, int g) {
        dk.e((Object)this.d);
        int n = -1;
        final int n2 = 1;
        if ((g & 0x1) != 0x0) {
            ...
            if (b != 0 && b != 1) {
                if (b != 2) {
                    ...
                    if (i != -1) {
                        ...
                        bap.c("PesReader", sb.toString());
                    }
                    this.a.c();
                }
                else {
                    bap.c("PesReader", "Unexpected start indicator reading extended header");
                }
            }
            this.d(1);
        }
            ...
            if (b2 != 0) {
                ...
                if (b2 != g) {
                    if (b2 != 2) {
                        ...
                        n6 = n;
                        n7 = g;
                        if (this.e(bas, (byte[])this.k.d, min)) {
                            n6 = n;
                            n7 = g;
                            if (this.e(bas, null, this.h)) {
                                this.k.m(0);
                                long b3;
                                if (this.e) {
                                    this.k.o(4);
    ...
    public final void b(final baw d, final btm btm, final cao cao) {
        this.d = d;
        this.a.b(btm, cao);
    }
