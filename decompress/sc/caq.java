...
final class caq implements car
{
    ...
    public caq(final btm c, final bud d, final cau e) {
        this.c = c;
        this.d = d;
        this.e = e;
        final int max = Math.max(1, e.c / 10);
        this.i = max;
        final bas bas = new bas(e.f);
        bas.g();
        final int g = bas.g();
        this.f = g;
        final int b = e.b;
        ...
        if (g == n) {
            final int c2 = bax.c(max, g);
            this.g = new byte[e.d * c2];
            this.h = new bas(c2 * ((g + g) * b));
            final int c3 = e.c;
    ...
    private final void f(final int n) {
        final long l = this.l;
        final long y = bax.y(this.n, 1000000L, (long)this.e.c);
        final int e = this.e(n);
        this.d.e(l + y, 1, e, this.m - e, (buc)null);
        this.n += n;
        this.m -= e;
    }
    
    public final void a(final int n, final long n2) {
        this.c.x((bua)new cav(this.e, this.f, n, n2));
        this.d.b(this.j);
    }
    ...
    public final boolean c(final btk btk, final long n) {
        final int n2 = bax.c(this.i - this.d(this.m), this.f) * this.e.d;
        while (true) {
            Label_0036: {
                if (n == 0L) {
                    break Label_0036;
                ...
                while (!b) {
                    ...
                    final int a = btk.a(this.g, this.k, (int)Math.min(n2 - k, n));
                    if (a == -1) {
                        break Label_0036;
                    }
                    this.k += a;
                    ...
                    for (int i = 0; i < n3; ++i) {
                        ...
                        while (true) {
                            ...
                            for (int j = 0; j < n5 + n5; ++j) {
                                ...
                                n10 += b2 + b2;
                                e2 = bax.e(e2 + n14, -32768, 32767);
                                a2[n10] = (byte)(e2 & 0xFF);
                                a2[n10 + 1] = (byte)(e2 >> 8);
                                n7 = bax.e(n7 + caq.a[n12], 0, 88);
                                n8 = caq.b[n7];
                            }
                            ++n4;
                        }
