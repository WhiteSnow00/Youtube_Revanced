...
public final class ceo implements View$OnCreateContextMenuListener, MenuItem$OnMenuItemClickListener
{
    private final Preference a;
    
    public ceo(final Preference a) {
        this.a = a;
    }
    ...
    public final boolean onMenuItemClick(final MenuItem menuItem) {
        ...
        if (Build$VERSION.SDK_INT <= 32) {
            ...
            Toast.makeText(j, (CharSequence)j.getString(2132019288, new Object[] { m }), 0).show();
        }
        return true;
    }
}
