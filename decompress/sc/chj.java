...
public final class chj extends ImageView
{
    public Animation$AnimationListener a;
    private int b;
    
    public chj(final Context context) {
        super(context);
        final float density = this.getContext().getResources().getDisplayMetrics().density;
        final TypedArray obtainStyledAttributes = this.getContext().obtainStyledAttributes(chi.a);
        ...
        anb.U((View)this, density * 4.0f);
        shapeDrawable.getPaint().setColor(this.b);
        anb.Q((View)this, (Drawable)shapeDrawable);
    }
