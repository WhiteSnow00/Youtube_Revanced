...
public final class chl extends Drawable implements Animatable
{
    ...
    static {
        ...
        f = (Interpolator)new ats();
        g = new int[] { -16777216 };
    }
    
    public chl(final Context context) {
        afg.k(context);
        ...
        ofFloat.addUpdateListener((ValueAnimator$AnimatorUpdateListener)new leq(this, a, 1));
        ofFloat.setRepeatCount(-1);
        ofFloat.setRepeatMode(1);
        ofFloat.setInterpolator((TimeInterpolator)chl.e);
        ofFloat.addListener((Animator$AnimatorListener)new gka(this, a, 1));
        this.i = (Animator)ofFloat;
    }
    
    public static final void e(float n, final chk chk) {
        if (n > 0.75f) {
            final int a = chk.a();
            final int[] i = chk.i;
            chk.g();
            ...
            chk.t = (n9 + (int)(n * ((n2 >> 24 & 0xFF) - n9)) << 24 | n7 + n8 << 16 | n5 + n6 << 8 | n3 + n4);
            return;
        }
        chk.t = chk.a();
    }
    
    public final void a(final float n, final chk chk, final boolean b) {
        if (this.d) {
            e(n, chk);
            final double floor = Math.floor(chk.l / 0.8f);
            final float j = chk.j;
            final float k = chk.k;
            chk.e = j + (-0.01f + k - j) * n;
            chk.f = k;
            final float l = chk.l;
            chk.g = l + ((float)(floor + 1.0) - l) * n;
            return;
        }
        if (n == 1.0f && !b) {
            return;
        ...
        if (n < 0.5f) {
            ...
            m = chk.j;
            f = chl.f.getInterpolation(n2) * 0.79f + 0.01f + m;
        }
        else {
            final float n3 = (-0.5f + n) / 0.5f;
            f = chk.j + 0.79f;
            m = f - ((1.0f - chl.f.getInterpolation(n3)) * 0.79f + 0.01f);
        }
        final float c = this.c;
        chk.e = m;
        chk.f = f;
        chk.g = i + 0.20999998f * n;
        this.h = (n + c) * 216.0f;
    }
