...
public final class csq extends csr
{
    ...
    public csq(final cof a, final String b) {
        this.a = a;
        this.b = b;
    }
    ...
    public final Object a() {
        ...
        final cfv a = cfv.a("SELECT id, state, output, run_attempt_count, generation FROM workspec WHERE id IN (SELECT work_spec_id FROM workname WHERE name=?)", 1);
        if (b == null) {
            a.f(1);
        }
        else {
