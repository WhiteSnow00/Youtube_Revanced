...
public final class dzo
{
    ...
    public static List o(final List list, final cya cya) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            list2.add(new efk((eei)list.get(i), cya, (byte[])null, (byte[])null, (byte[])null));
        }
        return list2;
    }
    ...
    public final void p(final int n, final eei eei, final cya cya, final Object o) {
        ...
        this.f(dzm.c(1, n, (eei)new efk(eei, cya, (byte[])null, (byte[])null, (byte[])null), null, o));
    }
    
    public final void q(final int n, final eei eei, final cya cya, final Object o, final Object o2) {
        this.f(dzm.c(2, n, (eei)new efk(eei, cya, (byte[])null, (byte[])null, (byte[])null), o, o2));
    }
}
