...
final class ept implements atke
{
    ...
    private final Object b() {
        ...
        switch (b) {
            ...
            case 79: {
                return new irh((Activity)esp.oz(this.c).a(), (kuf)esp.wn(this.c).a(), (vcy)esp.oW(this.c).a(), (wyv)esp.ow(this.c).a(), (aeea)esp.iE(this.c).a(), (aeea)eqy.mB(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 78: {
