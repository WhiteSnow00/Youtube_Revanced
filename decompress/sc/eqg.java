...
final class eqg implements atke
{
    ...
    public final Object a() {
        switch (this.c) {
            ...
            case 28: {
                return new hrk((Context)esp.oz(this.b).a(), (vcy)esp.oW(this.b).a(), (wyv)esp.ow(this.b).a(), (aujg)era.eU(eqy.r(this.a)).a(), (acpk)eqy.kK(this.a).a(), null, null, null, null);
            }
            case 27: {
            ...
            case 25: {
                final esp b9 = this.b;
                return new fzw(esp.kb(b9), epu.y(esp.cj(b9)), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 24: {
