...
final class eqh implements atke
{
    ...
    private final Object b() {
        ...
        switch (c) {
            ...
            case 98: {
                return new jeq((adgj)eqi.aB(this.b).a(), eqi.cn(this.b), (aadd)eqi.ay(this.b).a(), (aadj)eqi.a(this.b), (arwh)eqy.qn(this.a).a(), (afvt)eqy.oN(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 97: {
                return new abof(eqi.ce(this.b), eqi.cr(this.b), 1, null, null, null);
            }
            case 96: {
                final eqy a2 = this.a;
            ...
            case 48: {
                return new abqp((vjm)eqy.sS(this.a).a(), (abou)eqi.bf(this.b).a(), (abnl)eqi.aT(this.b).a(), (aglu)eqi.am(this.b).a(), (Executor)eqy.oN(this.a).a(), (Executor)eqy.fT(this.a).a(), (arwh)eqy.qn(this.a).a(), eqi.cl(this.b), (ablh)eqi.aM(this.b).a(), (abrj)eqy.jt(this.a).a(), eqi.ck(this.b), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 47: {
            ...
            case 38: {
                return new addo((aukf)eqi.bw(this.b).a(), eqi.cl(this.b), (ablh)eqi.aM(this.b).a(), (aglu)eqi.am(this.b).a(), null, null, null, null, null);
            }
            case 37: {
                return abaq.i();
            }
            ...
            case 23: {
                ...
                final eqi b7 = this.b;
                return new aakn(context12, ok, abjj2, eqi.aM(b7), eqi.aH(b7), (aboe)eqi.aU(b7).a(), (aulc)eqy.mQ(this.a).a(), (aglu)eqi.am(this.b).a(), (arwh)eqy.qn(this.a).a(), arlr.b(eqy.oL(this.a)), arlr.b(eqi.aZ(this.b)), (abrj)eqy.jt(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 22: {
                return abpb.j();
            }
            ...
            case 1: {
                return new jes((aboe)eqi.aU(this.b).a(), eqi.cr(this.b), (abfz)eqi.ba(this.b).a(), arlr.b(eqy.rd(this.a)), (vai)eqy.lu(this.a).a(), (asid)eqy.fU(this.a).a(), (elx)eqy.vz(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 0: {
        ...
        if (c / 100 != 0) {
            ...
            switch (c) {
                ...
                case 112: {
                    ...
                    o = new abuj(j, k, trc, abjj, aanx, d, (aukf)this.a.pq.a(), null, null);
                    break;
                }
                case 111: {
                ...
                case 110: {
                    ...
                    o = new jev(new hyx(a.pZ, a.pX, a.v, a.pW), 1, (byte[])null);
                    break;
                }
                case 109: {
