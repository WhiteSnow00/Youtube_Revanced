...
final class eqm implements atke
{
    ...
    public final Object a() {
        switch (this.c) {
            ...
            case 92: {
                final eqn b = this.b;
                return new abuj(eqn.aw(b), eqn.an(b), (trc)eqy.vM(this.a).a(), (abjj)eqn.ah(this.b).a(), (aanx)eqn.ap(this.b).a(), eqn.b(this.b), (aukf)eqy.vK(this.a).a(), null, null);
            }
            case 91: {
            ...
            case 54: {
                return new abqp((vjm)eqy.sS(this.a).a(), (abou)eqn.aM(this.b).a(), (abnl)eqn.bh(this.b).a(), (aglu)eqn.ae(this.b).a(), (Executor)eqy.oN(this.a).a(), (Executor)eqy.fT(this.a).a(), (arwh)eqy.qn(this.a).a(), eqn.bB(this.b), (ablh)eqn.az(this.b).a(), (abrj)eqy.jt(this.a).a(), eqn.bA(this.b), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 53: {
            ...
            case 46: {
                return new addo((aukf)eqn.bb(this.b).a(), eqn.bB(this.b), (ablh)eqn.az(this.b).a(), (aglu)eqn.ae(this.b).a(), null, null, null, null, null);
            }
            case 45: {
                return abaq.i();
            }
            ...
            case 22: {
                ...
                final eqn b7 = this.b;
                return new aakn(context11, ok, abjj2, eqn.az(b7), eqn.av(b7), (aboe)eqn.aJ(b7).a(), (aulc)eqy.mQ(this.a).a(), (aglu)eqn.ae(this.b).a(), (arwh)eqy.qn(this.a).a(), arlr.b(eqy.oL(this.a)), arlr.b(eqn.aI(this.b)), (abrj)eqy.jt(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 21: {
                return abpb.j();
            }
            ...
            case 0: {
                return new abof(eqn.by(this.b), eqn.bD(this.b), 0, null, null, null, null);
            }
        }
    }
}
