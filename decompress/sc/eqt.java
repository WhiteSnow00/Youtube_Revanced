...
final class eqt implements atke
{
    ...
    public final Object a() {
        switch (this.c) {
            ...
            case 92: {
                final equ b = this.b;
                return new abuj(equ.aw(b), equ.an(b), (trc)eqy.vM(this.a).a(), (abjj)equ.ah(this.b).a(), (aanx)equ.ap(this.b).a(), equ.b(this.b), (aukf)eqy.vK(this.a).a(), null, null);
            }
            case 91: {
            ...
            case 54: {
                return new abqp((vjm)eqy.sS(this.a).a(), (abou)equ.aM(this.b).a(), (abnl)equ.bh(this.b).a(), (aglu)equ.ae(this.b).a(), (Executor)eqy.oN(this.a).a(), (Executor)eqy.fT(this.a).a(), (arwh)eqy.qn(this.a).a(), equ.bB(this.b), (ablh)equ.az(this.b).a(), (abrj)eqy.jt(this.a).a(), equ.bA(this.b), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 53: {
            ...
            case 46: {
                return new addo((aukf)equ.bb(this.b).a(), equ.bB(this.b), (ablh)equ.az(this.b).a(), (aglu)equ.ae(this.b).a(), null, null, null, null, null);
            }
            case 45: {
                return abaq.i();
            }
            ...
            case 22: {
                ...
                final equ b7 = this.b;
                return new aakn(context11, ok, abjj2, equ.az(b7), equ.av(b7), (aboe)equ.aJ(b7).a(), (aulc)eqy.mQ(this.a).a(), (aglu)equ.ae(this.b).a(), (arwh)eqy.qn(this.a).a(), arlr.b(eqy.oL(this.a)), arlr.b(equ.aI(this.b)), (abrj)eqy.jt(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 21: {
                return abpb.j();
            }
            ...
            case 0: {
                return new abof(equ.by(this.b), equ.bD(this.b), 0, null, null, null, null);
            }
        }
    }
}
