...
final class erb implements atke
{
    ...
    private final Object b() {
        ...
        switch (c) {
            ...
            case 81: {
                return new kjo((Context)esp.oz(this.d).a(), (acgs)eqy.kr(this.a).a(), (vcy)esp.oW(this.d).a(), (acpn)esp.pj(this.d).a(), (rzy)eqy.eE(this.a).a(), (oyy)eqy.ev(this.a).a(), (vgy)eqy.eL(this.a).a(), (hyx)era.cA(eqy.r(this.a)).a(), 0, null, null, null, null, null);
            }
            case 80: {
                return new kjs((Context)esp.oz(this.d).a(), (afaq)erc.Y(this.b).a(), (acgs)eqy.kr(this.a).a(), (vcy)esp.oW(this.d).a(), (acpk)eqy.kK(this.a).a(), (acpn)esp.pj(this.d).a(), (rzy)eqy.eE(this.a).a(), (oyy)eqy.ev(this.a).a(), (vgy)eqy.eL(this.a).a(), (tgd)eqy.jn(this.a).a(), (InlinePlaybackLifecycleController)esp.kC(this.d).a(), (kaw)esp.gD(this.d).a(), (geu)esp.kB(this.d).a(), (kbw)esp.kK(this.d).a(), (hyx)era.cA(eqy.r(this.a)).a(), esp.zR(this.d), (aeea)esp.rT(this.d).a(), (hyx)esp.uM(this.d).a(), (vai)eqy.vx(this.a).a(), null, null, null, null, null, null, null);
            }
            case 79: {
            ...
            case 66: {
                return new fuf((Context)esp.oz(this.d).a(), (vcy)esp.oW(this.d).a(), (ziy)esp.uA(this.d).a(), 11, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 65: {
            ...
            case 39: {
                return new jbo((Context)esp.oz(this.d).a(), (gjh)esp.kX(this.d).a(), (acgs)eqy.kr(this.a).a(), (vcy)esp.oW(this.d).a(), (ziy)esp.uA(this.d).a(), 1, null, null, null, null);
            }
            case 38: {
            ...
            case 15: {
                return new fzw(esp.oW(this.d), eqy.kK(this.a), (byte[])null, (short[])null);
            }
            case 14: {
                return new fwc();
            }
            ...
            case 9: {
                ...
                return new jfx(activity, tgd2, b9, vcy3, lmo, gfq, fvf, hyx2, ziy, aujg, acpk2, eqy.lE(a19), era.cm(eqy.r(a19)), (aaih)esp.mf(this.d).a(), eqy.ig(this.a), (fzw)erc.U(this.b).a(), era.aC(eqy.r(this.a)), arlr.b(erc.T(this.b)), arlr.b(erc.S(this.b)), (cya)esp.mI(this.d).a(), (vai)eqy.vx(this.a).a(), (vai)eqy.uY(this.a).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 8: {
    ...
    private final Object c() {
        ...
        switch (c) {
            ...
            case 175: {
                return new fuw(erc.aD(this.b), 2, (byte[])null, (byte[])null, (byte[])null);
            }
            case 174: {
                return new fuw(erc.aD(this.b), 0, (byte[])null, (byte[])null);
            }
            case 173: {
            ...
            case 153: {
                ...
                final tgd tgd = (tgd)eqy.jn(this.a).a();
                final vcy vcy3 = (vcy)esp.oW(this.d).a();
                return new fxk(context4, gjh, hmw, tgd, (byte[])null, (byte[])null);
            }
            case 152: {
                return new fxi((Context)erc.ap(this.b).a(), (acgs)eqy.kr(this.a).a(), (aeea)erc.M(this.b).a(), (ziy)esp.uA(this.d).a(), (gjh)erc.W(this.b).a(), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 151: {
            ...
            case 132: {
                return new khk((Context)erc.ap(this.b).a(), (acps)erc.aa(this.b).a(), (asid)eqy.fU(this.a).a(), (aeea)esp.sZ(this.d).a(), (vaf)eqy.pn(this.a).a(), (vdr)eqy.kE(this.a).a(), (zmf)eqy.pK(this.a).a(), null, null, null, null);
            }
            case 131: {
            ...
            case 129: {
                return new fud((Context)erc.ap(this.b).a(), (vcy)esp.oW(this.d).a(), (acgs)eqy.kr(this.a).a(), (acpk)eqy.kK(this.a).a(), (acvw)esp.pR(this.d).a(), (jki)esp.rV(this.d).a(), arlr.b(esp.rS(this.d)), (byte[])null, (byte[])null, (byte[])null, (byte[])null, (byte[])null);
            }
            case 128: {
                return new jja((Context)esp.oz(this.d).a(), (acgs)eqy.kr(this.a).a(), (gjh)esp.kX(this.d).a(), (aeea)erc.M(this.b).a(), null, null, null, null, null);
            }
            case 127: {
            ...
            case 126: {
                return new ftx((Context)esp.oz(this.d).a(), (hmw)esp.uB(this.d).a(), (vai)eqy.vx(this.a).a(), (byte[])null, (byte[])null);
            }
            case 125: {
    ...
    private final Object d() {
        ...
        switch (c) {
            ...
            case 286: {
                return new kiv((Context)erc.ap(this.b).a(), (vcy)esp.oW(this.d).a(), (elx)esp.gi(this.d).a(), (vdr)eqy.kE(this.a).a(), erc.ax(this.b), erc.aI(this.b), (arwh)eqy.qn(this.a).a(), (vai)eqy.vx(this.a).a(), (aeea)eqy.mB(this.a).a(), null, null, null, null, null, null);
            }
            case 285: {
            ...
            case 274: {
                return new jli((Context)esp.oz(this.d).a(), (vcy)esp.oW(this.d).a(), (acgs)eqy.kr(this.a).a(), (acvi)erc.V(this.b).a(), (ziy)esp.uA(this.d).a(), (acpk)eqy.kK(this.a).a(), (hwn)esp.ui(this.d).a(), (hyx)esp.uk(this.d).a(), (aeea)esp.rT(this.d).a(), null, null, null, null, null, null, null);
            }
            case 273: {
            ...
            case 236: {
                return new kho((Context)esp.oz(this.d).a(), (acgs)eqy.kr(this.a).a(), (vcy)esp.oW(this.d).a(), (acpn)esp.pj(this.d).a(), (jki)erc.an(this.b).a(), null, null);
            }
            case 235: {
                return new khm((Context)erc.ap(this.b).a(), (gjh)erc.W(this.b).a(), (acgs)eqy.kr(this.a).a(), (vcy)esp.oW(this.d).a(), (acpn)erc.ac(this.b).a(), (isn)eqy.wi(this.a).a(), (arwh)eqy.qn(this.a).a(), (vai)eqy.vx(this.a).a(), null, null);
            }
            case 234: {
            ...
            case 209: {
                return new kgz((Activity)esp.oz(this.d).a(), (Context)erc.ap(this.b).a(), (mam)esp.wg(this.d).a(), (WatchOnTvMenuItem)esp.vN(this.d).a(), 0, null, null, null);
            }
            case 208: {
        ...
        if (n != 2) {
            ...
            switch (c) {
                ...
                case 310: {
                    ...
                    final atke b3 = b2.b;
                    final eqy a21 = b2.a;
                    o = new jhc(context2, vcy, gjh, acpn, qcy, an, new blu(b3, a21.jr, a21.en, a21.a.aV, a21.h, (char[])null, null, (byte[])null), null, null, null, null, null);
                    break;
                }
                case 309: {
                ...
                case 306: {
                    o = new jgo((Activity)this.d.d.a(), (Context)((arlt)this.b.b).a, (vcy)this.d.F.a(), (ktn)this.a.a.aR.a(), (tgd)this.a.h.a(), (fmr)this.a.jr.a(), (gjh)this.b.c.a(), this.b.aN(), (ajb)this.b.e.a(), (aln)this.b.f.a(), null, null, null, null);
                    break;
                }
                case 305: {
                ...
                case 301: {
                    o = new fae((Context)this.d.d.a(), (acgs)this.a.jl.a(), (gjh)this.d.eI.a(), (aeea)this.b.h.a(), (acpn)this.d.eB.a(), (cya)this.d.aX.a(), (ziy)this.d.U.a(), (hwn)this.d.bz.a(), (hyx)this.d.bR.a(), (aeea)this.d.fN.a(), null, null, null, null, null, null, null);
                    break;
                }
                case 300: {
