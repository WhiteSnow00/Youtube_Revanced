        ...
        switch (b) {
            default: {
                ...
                while (iterator.hasNext()) {
                    ((IntersectionEngine)esm.bJ.a()).setEnableProminenceForGroup((String)iterator.next(), false);
                }
                return;
            }
            case 19: {
            ...
            case 1: {
                ...
                if (v == 1) {
                    ...
                    adiq.i.schedule((Runnable)new adio(adiq), adiq.a + 50L, TimeUnit.MILLISECONDS);
                }
                else if (v == 3) {
                    ...
                    adiw.j.schedule((Runnable)new adiu(adiw), adiw.b + 50L, TimeUnit.MILLISECONDS);
                ...
                if (tos.y) {
                    Logger.getLogger("ErrorLoggingExecutor").addHandler(new adgi(adgj));
                }
