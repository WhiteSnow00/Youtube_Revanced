    ...
    public final void run() {
        ...
        switch (b) {
            ...
            case 18: {
                ...
                asht.p(msr.M(), dataReminderController.e.j().ai(), DataReminderController.j((fjv)dataReminderController.c.a()).ai(), (asjn)exk.a).af(dataReminderController.d).ay(((hze)g.a()).a(), (asji)exl.a).q(tpe.cl(msr.K())).af(h).aH(new erz(dataReminderController, 7));
                return;
            }
            case 17: {
