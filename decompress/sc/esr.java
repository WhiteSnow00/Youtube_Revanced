...
public final class esr implements aejs, aeph, aeqb, arll
{
    ...
    public final hnx aA() {
        ...
        final atke l = an.I;
        final eqy a = this.a;
        return new hnx(h, i, j, k, l, a.jl, this.aU, a.a.ar, an.M, an.k, (byte[])null);
    }
    ...
    public final bx aL() {
        return iyu.t(iyu.s((Context)this.a.c.a()));
    }
    ...
    public final Map i() {
        ...
        i.g("accessibility_player_setting_key", new tsk((qqr)this.a.a.bS.a(), (tci)fnh.q, (aezf)new igr(this.aL(), 15, null, null, null, null, null), 1));
        ...
        i.g("inline_global_play_pause", new tsk((tmx)this.a.fW.a(), (tci)fnh.o, (aezf)new igr((arwh)this.a.v.a(), 14, null, null), 0));
