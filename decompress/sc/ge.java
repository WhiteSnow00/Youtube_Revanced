...
public final class ge extends ep
{
    ...
    public ge(final Toolbar toolbar, final CharSequence charSequence, final Window$Callback window$Callback) {
        ...
        this.h = (Runnable)new be(this, 7);
        final qxr qxr = new qxr(this, 1);
        this.i = (pu)qxr;
        final px a = new px(toolbar, false);
        this.a = (lq)a;
        afg.k(window$Callback);
    ...
    public final void g() {
        ((ViewGroup)((px)this.a).a).removeCallbacks(this.h);
    }
