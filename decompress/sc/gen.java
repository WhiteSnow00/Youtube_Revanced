...
public class gen extends ViewGroup implements fju
{
    EdgeEffect a;
    EdgeEffect b;
    public trh c;
    ...
    public gen(final Context context) {
        super(context);
        this.e(context);
    }
    
    public gen(final Context context, final float g, final trh c) {
        super(context);
        this.g = g;
        this.c = c;
        this.d = new fkk();
    ...
    public gen(final Context context, final AttributeSet set) {
        super(context, set);
        this.e(context);
    }
    
    public gen(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        this.e(context);
    }
    ...
    public final void f(final arkg arkg) {
        ...
        final heo heo = (heo)arkg.a();
        final EdgeEffect a = this.a;
        a.getClass();
        heo.z(1, (View)this, a);
        final heo heo2 = (heo)arkg.a();
        final EdgeEffect b = this.b;
        b.getClass();
        heo2.z(3, (View)this, b);
    }
