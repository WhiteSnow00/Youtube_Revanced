...
public final class gkc
{
    ...
    public gkc(final Context context, final skt f, final wyv a, final gbc a2, final byte[] array, final byte[] array2, final byte[] array3) {
        this.F = f;
        this.A = a;
        this.a = a2;
        final Resources resources = context.getResources();
        this.b = resources.getColor(2131102114);
        this.c = resources.getColor(2131102115);
        this.d = resources.getColor(2131102116);
    ...
    private final void v(final boolean b, final boolean b2, final boolean b3) {
        ...
        d.a(2132018835);
        if (!b) {
            (this.D = fal.r((View)d, this.c, this.b, 250L)).addListener((Animator$AnimatorListener)new gka(this, d, 0));
            this.D.start();
        }
        else {
    ...
    public final LayoutTransition a(final boolean b) {
        ...
        if (b) {
            layoutTransition.addTransitionListener((LayoutTransition$TransitionListener)new jmi(1));
        }
        return layoutTransition;
    }
    
    public final View$OnLayoutChangeListener b() {
        return (View$OnLayoutChangeListener)new fti(this, 8);
    }
    ...
    public final Runnable e(final ViewGroup viewGroup, final SlimStatusBar slimStatusBar, final boolean b, final boolean b2, final boolean b3) {
        return new gjz(this, viewGroup, slimStatusBar, b, b2, b3);
    }
    
    public final Runnable f(final boolean b) {
        return (Runnable)new dmv(this, b, 4);
    }
    
    public final Runnable g(final boolean b) {
        return (Runnable)new dmv(this, b, 5);
    }
    ...
    public final void m(final int n) {
        ++this.C;
        final wyw pf = this.A.pF();
        pf.l(xmm.ac(pf.h((Object)this.C, xaa.c(n), this.C)));
    }
