...
public final class gyu implements txz, azf
{
        ...
        if (aujg.bC()) {
            ...
            try {
                ...
                try {
                    ...
                    final ahao a = ahao.a;
                    j.p();
                    final aqsk aqsk = (aqsk)((BaseClient)j).c(27285591, (MessageLite)a, ((ahbh)aqsk.a).getParserForType());
                    if ((aqsk.b & 0x1) != 0x0) {
                        aqrs aqrs;
                        if ((aqrs = aqsk.c) == null) {
                            aqrs = aqrs.c();
                        ...
                        throw new atzi(aqrs2.d(), null, a2.a());
                    }
                    ...
                    throw new atzi(ex.getMessage(), ex, h);
                }
            }
    ...
    public final void ak(final obq obq) {
        final rcp l = this.l;
        if (l != null && obq != null) {
            l.f = Optional.ofNullable((Object)new atzj(obq, null));
        }
    }
