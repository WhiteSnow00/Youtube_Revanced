...
public final class h extends Format
{
    ...
    private static final int c(String lowerCase, final String[] array) {
        ...
        Label_0122: {
            if (length != 0) {
                if (!d.a((int)lowerCase.charAt(0))) {
                    substring = lowerCase;
                    if (!d.a((int)lowerCase.charAt(lowerCase.length() - 1))) {
                        break Label_0122;
                    }
                }
                int length2;
                int n2;
                for (length2 = lowerCase.length(), n2 = 0; n2 < length2 && d.a((int)lowerCase.charAt(n2)); ++n2) {}
                int n3;
                if (n2 < (n3 = length2)) {
                    while (true) {
                        final int n4 = length2 - 1;
                        n3 = length2;
                        if (!d.a((int)lowerCase.charAt(n4))) {
                            break;
                        }
                        length2 = n4;
                    }
    ...
    Label_0726_Outer:
        while (true) {
            final int n2 = 1;
            final v d = this.b.d(n);
            final int e = d.e;
            final int n3 = d.a - a2;
            if (n3 != 0 && !a.regionMatches(a2, s, index, n3)) {
                parsePosition.setErrorIndex(index);
                return;
            }
            final int n4 = index + n3;
            if (e == 2) {
            ...
            if (e != 3 && e != 4) {
                ...
                Label_1082: {
                    if (c3 != null) {
                        final Format format = c3.get(n5 - 2);
                        if (format != null) {
                    ...
                    if (b2 != 1) {
                        final Map c4 = this.c;
                        if (c4 == null || !c4.containsKey(n5 - 2)) {
                            if (b2 == 3) {
                                parsePosition2.setIndex(n4);
                                final w b4 = this.b;
                                final int index2 = parsePosition2.getIndex();
                                double n8 = Double.NaN;
                                int index3 = index2;
                                int n9 = n5;
                                final String s4 = a;
                                while (true) {
                                    ...
                                    double n17;
                                    String s7;
                                    for (w w = b4; w.h(n9) != 7; n9 = c5 + 1, s7 = s6, w = w2, s2 = s7, index3 = n16, n8 = n17) {
                                        final double a3 = w.a(w.d(n9));
                                        int n10 = n9 + 2;
                                        c5 = w.c(n10);
                                        final String a4 = w.a;
                                        int a5 = w.d(n10).a();
                                    ...
                                    Label_0543_Outer:
                                        while (true) {
                                            ...
                                            while (true) {
                                                ...
                                                final int n14 = d3.a - a5;
                                                if (n14 != 0 && !s.regionMatches(index2, a4, a5, n14)) {
                                                    n15 = -1;
                                                    break;
                                                }
                                                final int n13 = n11 + n14;
                                                if (n12 == c5) {
                                                    n15 = n13;
                                                    break;
                                                }
                    ...
                    final StringBuilder sb = new StringBuilder();
                    final w b5 = this.b;
                    final String a7 = b5.a;
                    int n19 = b5.d(c).a();
                    int n20 = c + 1;
                    while (true) {
                        final v d4 = this.b.d(n20);
                        final int e2 = d4.e;
                        sb.append(a7, n19, d4.a);
                        if (e2 == 6 || e2 == 2) {
                            break;
                        }
                        n19 = d4.a();
                    ...
                    String substring = s.substring(n4, n6);
                                            ...
                                            if (b2 == 3) {
                                                ...
                                                if (c.b(b2)) {
                                                    if (value2 instanceof Number) {
                                                        ...
                                                        this.h(n, g2, array, map, array2, atib);
                                                        n = n10;
                                                        fieldPosition = fieldPosition2;
                                                        value = s3;
                                                        break Label_0449;
                                                    ...
                                                    if (b2 == 5) {
                                                        ...
                                                        this.h(n, null, array, map, array2, atib);
                                                        n = n10;
                                                        a4 = n33;
                                                        break Label_0449;
                                                    }
