...
public final class haj implements View$OnClickListener, tyy, uam, uai
{
    ...
    public final View a(final LayoutInflater layoutInflater, final ViewGroup viewGroup) {
        ...
        this.e.c(((ashi)this.f.a).ai().aI(new gyi(this, 14), (asjm)new gpg(16)));
        final asiq e = this.e;
        final VoiceoverSeekBar f = this.f;
        f.getClass();
        e.c(((ashi)f.b).ai().aH(new gyi(this, 12)));
    ...
    public final void f(long i) {
        ...
        if (j != null && n >= 300L) {
            final ahaz builder = j.toBuilder();
            arbj arbj5;
            if ((arbj5 = j.d) == null) {
                arbj5 = arbj.a;
            }
            final ahaz builder2 = arbj5.toBuilder();
            final int d = hcc.d(n);
