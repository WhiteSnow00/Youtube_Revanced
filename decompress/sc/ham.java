    ...
    public final void q(aezp aezp) {
        if (aezp.h()) {
            ...
            if (this.o.r(shortsCreationSelectedTrack)) {
                aezp = aezp.k((Object)shortsCreationSelectedTrack.n());
                if (!this.l.equals((Object)aezp)) {
                    this.l = aezp;
                }
                aezp = aezp.j((Object)shortsCreationSelectedTrack.m());
                if (!this.t.equals((Object)aezp)) {
                    this.t = aezp;
                    this.n();
                }
                this.v(apoy.c);
