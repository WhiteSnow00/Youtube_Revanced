...
public final class hrj extends FrameLayout
{
    public int a;
    public int b;
    private final int c;
    ...
    public hrj(final Context context) {
        super(context);
        this.setLayoutDirection(0);
        this.c = context.getResources().getDimensionPixelSize(2131170264);
        this.d = context.getResources().getDimensionPixelSize(2131170265);
    }
