...
abstract class jam implements jaf, ftq
{
    ...
    public jam(final Context b, final acgs a, final wyw z) {
        this.u = false;
        a.getClass();
        this.a = a;
        b.getClass();
    ...
    public final void b(final View view) {
        try {
            ...
            zlm.c(zll.a, zlk.a, "Error inflating YouTubeBaseCollapsibleAdCtaInnerOverlay:", (Throwable)ex);
        }
    }
    ...
    public void c() {
        ...
        if (c != null) {
            ...
            tpe.aF(c, tpe.aq(n), (Class)ViewGroup$MarginLayoutParams.class);
        }
    }
    ...
    public final void f(final rqm s) {
        this.s = s;
    }
        ...
        if (v2 != v || this.t != t) {
            ...
            if (n != 3) {
                if (n == 4) {
                    ...
                    final ahab j = this.j;
                    if (j != null) {
                        this.z.t((wzz)new wyt(j), (alhi)null);
                    }
                }
            }
            else {
                ...
                final ahab i = this.i;
                if (i != null) {
                    this.z.t((wzz)new wyt(i), (alhi)null);
                }
            }
        }
    }
