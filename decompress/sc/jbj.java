...
public final class jbj
{
    ...
    public jbj(final Context context, final jbh a, final jbb b, final int h) {
        this.a = a;
        this.b = b;
        this.h = h;
        this.c = context.getResources().getDimensionPixelSize(2131170243);
    }
    ...
    public final boolean c(final MotionEvent motionEvent) {
        ...
        if (this.a.a() == jbg.d && this.f() && this.a.m(n) && -n > this.c) {
            return true;
        }
        if (this.a.a() == jbg.f) {
