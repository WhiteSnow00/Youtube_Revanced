...
public final class aac extends aae implements Runnable
{
    ...
    public aac(final aab c, final ListenableFuture f) {
    ...
    public final void run() {
        ...
        try {
            try {
                try {
                    Object a = this.c.a(sg.h((Future)this.f));
                    ...
                    final Object d = new vs(this, (ListenableFuture)a, 7);
                    ((ListenableFuture)a).addListener((Runnable)d, zu.a());
                    this.c = null;
                    this.f = null;
                    a = this.e;
                }
