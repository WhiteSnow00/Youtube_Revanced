...
public final class aaka
{
    public final yob a;
    public abik[] b;
    public final /* synthetic */ aakb c;
    private long d;
    
    public aaka(final aakb c, final yob a) {
        this.c = c;
        this.a = a;
    }
    ...
    public final long a() {
        ...
        if (a != null && this.b == null) {
            this.b = this.b(a, aakb.a(this.c));
        }
        return aakb.a(this.c) + this.d;
    }
    
    public final abik[] b(yob f, long n) {
        final List f2 = aakb.f(f, "Stitched-Video-Id");
        final List f3 = aakb.f(f, "Stitched-Video-Duration-Us");
        final List f4 = aakb.f(f, "Stitched-Video-Cpn");
        f = (yob)aakb.f(f, "Stitched-Video-Start-Time-Within-Ad-Us");
        ...
        final abik[] array = new abik[linkedHashMap.size()];
        ...
        while (iterator.hasNext()) {
            ...
            array[n3] = new abik((String)entry.getKey(), (long)((Pair)entry.getValue()).first, (long)((Pair)entry.getValue()).second, n);
            ++n3;
        }
        return array;
    }
