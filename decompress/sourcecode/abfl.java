...
public final class abfl
{
    ...
    public abfl(final TapBloomView a, final int c, final int d) {
        this.a = a;
        this.c = c;
        this.d = d;
    }
    ...
    public final ValueAnimator a() {
        ...
        this.b.addUpdateListener((ValueAnimator$AnimatorUpdateListener)new usg(this, 15));
        this.b.addListener((Animator$AnimatorListener)new abfk(this));
        return this.b;
    }
