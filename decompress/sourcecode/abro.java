...
public final class abro
{
    ...
    public abro(final List list, final List list2, final List list3) {
        final int size = list.size();
        final int size2 = list2.size();
        final boolean b = true;
        agot.E(size == size2, (Object)"startTimes and endTimes differ in size");
        agot.E(list.size() == list3.size() && b, (Object)"startTimes and lines differ in size");
