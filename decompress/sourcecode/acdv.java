...
public final class acdv implements zhs
{
    private final int a;
    ...
    public acdv(final int a, final Bitmap$Config b) {
        agot.v(a > 0, (Object)"desiredWidth must be > 0");
        this.a = a;
        this.b = b;
    }
    ...
    public final Bitmap a(final byte[] array) {
        ...
        throw new tty("failed to decode bitmap");
    }
}
