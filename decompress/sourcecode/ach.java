...
public final class ach
{
    ...
    public float[] d;
    public int e;
    protected final cdn f;
    private final aci g;
    private int h;
    private int i;
    private boolean j;
    
    public ach(final aci g, final cdn f, final byte[] array, final byte[] array2) {
        this.a = 0;
        this.h = 8;
        this.b = new int[8];
        this.c = new int[8];
    ...
    public final float a(final acm acm) {
    ...
    public final float c(final acm acm, final boolean b) {
        int e = this.e;
        if (e != -1) {
            int n = 0;
            int n2 = -1;
    ...
    public final void e(final acm acm, float n, final boolean b) {
    ...
    public final void f() {
        for (int e = this.e, n = 0; e != -1 && n < this.a; e = this.c[e], ++n) {
            final acm acm = ((acm[])this.f.c)[this.b[e]];
            if (acm != null) {
                acm.b(this.g);
            }
        }
    ...
    public final void g(final acm acm, final float n) {
        if (n == 0.0f) {
            this.c(acm, true);
            return;
        }
    ...
    public final String toString() {
        ...
        for (int n = 0; e != -1 && n < this.a; e = this.c[e], ++n) {
            ...
            sb.append(n2);
            sb.append(" : ");
            concat = sb.toString().concat(String.valueOf(String.valueOf(((acm[])this.f.c)[this.b[e]])));
        }
        return concat;
    }
}
