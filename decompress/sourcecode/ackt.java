...
public final class ackt extends LinearLayout
{
    ...
    public ackt(final Context context) {
        super(context);
        this.setOrientation(1);
        final LayoutInflater from = LayoutInflater.from(context);
        from.inflate(2131625293, (ViewGroup)this);
        this.a = (TextView)this.findViewById(2131432092);
        final ListView b = (ListView)this.findViewById(2131428424);
        this.b = b;
        final View inflate = from.inflate(2131625295, (ViewGroup)b, false);
