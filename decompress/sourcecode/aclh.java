...
public final class aclh implements InputFilter
{
    private final TextView a;
    private final float b;
    private final int c;
    
    public aclh(final TextView a, final float b, final int c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
        ...
        if (charSequence != null && n != n2) {
            if ((n3 = n) == 0) {
                ...
                if (n2 == charSequence.length()) {
                    return acll.a(subSequence, 0, subSequence.length(), this.b, this.c);
                }
                n3 = 0;
            }
