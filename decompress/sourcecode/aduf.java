...
public final class aduf
{
    ...
    static {
        a = new int[] { 2130969086 };
        b = new int[] { 2130969101 };
    }
    ...
    public static void b(final Context context) {
        g(context, aduf.a, "Theme.AppCompat");
    }
    
    public static boolean c(final Context context) {
        return adwd.m(context, 2130969595, false);
    }
    
    public static cdn d(final Context context, final AttributeSet set, final int[] array, final int n, final int n2, final int... array2) {
        e(context, set, n, n2);
        f(context, set, array, n, n2, array2);
        return cdn.w(context, set, array, n, n2);
    }
    
    private static void e(final Context context, final AttributeSet set, final int n, final int n2) {
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, adtz.c, n, n2);
        final boolean boolean1 = obtainStyledAttributes.getBoolean(1, false);
        obtainStyledAttributes.recycle();
        if (boolean1) {
            final TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(2130969596, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                g(context, aduf.b, "Theme.MaterialComponents");
            }
        }
        b(context);
    }
    ...
    private static void f(final Context context, final AttributeSet set, final int[] array, int i, final int n, final int... array2) {
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, adtz.c, i, n);
        final int n2 = 0;
