...
public final class adza extends adzv
{
    public adza(final Context context) {
        new aeby("AppUpdateListenerRegistry", (byte[])null);
    ...
    protected final void a(final Context context, final Intent intent) {
        if (context.getPackageName().equals(intent.getStringExtra("package.name"))) {
            ...
            this.d((Object)new adzq(intent.getIntExtra("install.status", 0), intent.getLongExtra("bytes.downloaded", 0L), intent.getLongExtra("total.bytes.to.download", 0L), intent.getIntExtra("error.code", 0), intent.getStringExtra("package.name")));
            return;
        }
