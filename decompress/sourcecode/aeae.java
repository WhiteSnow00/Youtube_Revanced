...
public final class aeae
{
    ...
    public aeae(final IBinder a, final boolean b, final String c, final int d, final float e, final int f, final int g) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public final boolean equals(final Object o) {
        ...
        if (o instanceof aeae) {
            final aeae aeae = (aeae)o;
            if (this.a.equals(aeae.a) && this.b == aeae.b) {
                ...
                else if (!c.equals(aeae.c)) {
                    return false;
                }
                if (this.d == aeae.d && Float.floatToIntBits(this.e) == Float.floatToIntBits(aeae.e) && this.f == aeae.f && this.g == aeae.g) {
                    return true;
                }
            }
        }
