...
public final class aebn extends mpn
{
    public aebn(final int n) {
        final Map a = aeca.a;
        final Integer value = n;
        String string;
        if (a.containsKey(value) && aeca.b.containsKey(value)) {
            final String s = aeca.a.get(value);
            final String s2 = aeca.b.get(value);
