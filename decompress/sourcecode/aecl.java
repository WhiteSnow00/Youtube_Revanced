...
public final class aecl
{
    ...
    static {
        c = new aeby("LocalTestingConfigParser", (byte[])null);
    }
    
    public aecl(final XmlPullParser a) {
        this.a = a;
        this.b = aeci.a();
    }
    
    public static aeci a(final File p0) {
        // 
        ...
        //    49: aload_1        
        //    50: aload_2        
        //    51: invokespecial   aecl.<init>:(Lorg/xmlpull/v1/XmlPullParser;)V
        //    54: new             Laecj;
        //    57: astore_2       
        //    58: aload_2        
        //    59: aload_1        
        //    60: iconst_2       
        //    61: invokespecial   aecj.<init>:(Laecl;I)V
        //    64: aload_1        
        //    65: ldc             "local-testing-config"
        //    67: aload_2        
        //    68: invokevirtual   aecl.b:(Ljava/lang/String;Laeck;)V
        //    71: aload_1        
        //    72: getfield        aecl.b:Lagjc;
        //    75: invokevirtual   agjc.g:()Laeci;
        //    78: astore_1       
        //    79: aload_0        
        ...
        //   154: aastore        
        //   155: invokevirtual   aeby.m:(Ljava/lang/String;[Ljava/lang/Object;)V
        //   158: getstatic       aeci.a:Laeci;
        //   161: areturn        
        //   162: astore_0       
        //   163: goto            123
        //    Exceptions:
    ...
    public final void b(final String s, final aeck aeck) {
        while (true) {
