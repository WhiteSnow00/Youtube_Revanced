...
public final class aere implements Runnable, aers
{
    private aerr a;
    private aerr b;
    ...
    public final void a(final ListenableFuture listenableFuture) {
        ...
        if (!this.e) {
            this.e = true;
            this.a.j();
            listenableFuture.addListener((Runnable)this, (Executor)afsl.a);
            return;
        }
