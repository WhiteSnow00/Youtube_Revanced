...
public final class aeyn
{
    ...
    public aeyn(final aeyx b) {
        b.getClass();
        this.b = b;
    }
    
    public static aeyn b(final aeyx aeyx) {
        final aeyn aeyn = new aeyn(aeyx);
        aeyn.f();
        return aeyn;
    }
    
    public static aeyn c() {
        return new aeyn();
    }
    
    public static aeyn d(final aeyx aeyx) {
        return new aeyn(aeyx);
    }
    ...
    public final void f() {
        agot.E(this.a ^ true, (Object)"This stopwatch is already running.");
        this.a = true;
        this.d = this.b.a();
    }
    ...
    public final void g() {
        ...
        agot.E(this.a, (Object)"This stopwatch is already stopped.");
        this.a = false;
        this.c += a - this.d;
    }
    ...
    public final String toString() {
        ...
        final long convert = TimeUnit.NANOSECONDS.convert(1L, timeUnit);
        final StringBuilder sb = new StringBuilder();
        final double n = (double)h;
        final double n2 = (double)convert;
        Double.isNaN(n);
        Double.isNaN(n2);
        sb.append(aexs.d(n / n2));
        sb.append(" ");
        String s = null;
        switch (aeym.a[timeUnit.ordinal()]) {
            default: {
