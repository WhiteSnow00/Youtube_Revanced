...
public final class agdf implements aged
{
    ...
    static {
        a = (ThreadLocal)new agde();
    }
    
    public agdf(final byte[] array, final int c) {
        if (!aesy.ao(2)) {
            throw new GeneralSecurityException("Can not use AES-CTR in FIPS-mode, as BoringCrypto module is not available.");
        }
        agep.a(array.length);
        this.b = new SecretKeySpec(array, "AES");
        final int blockSize = agdf.a.get().getBlockSize();
        this.d = blockSize;
        if (c >= 12 && c <= blockSize) {
            this.c = c;
            return;
    ...
    public final byte[] a(final byte[] array) {
        ...
        final byte[] a = agej.a(c);
        System.arraycopy(a, 0, array2, 0, this.c);
        final int c3 = this.c;
        final Cipher cipher = agdf.a.get();
