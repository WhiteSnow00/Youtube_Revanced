...
public final class agdi implements afum
{
    ...
    static {
        a = (ThreadLocal)new agdg();
        b = (ThreadLocal)new agdh();
    }
    
    public agdi(byte[] b, final int f) {
        if (!aesy.ao(1)) {
        ...
        this.e = e;
        final Cipher cipher = agdi.a.get();
        cipher.init(1, e);
    ...
    public final byte[] a(byte[] c, byte[] c2) {
        ...
        if (length <= Integer.MAX_VALUE - f - 16) {
            ...
            final Cipher cipher2 = agdi.b.get();
