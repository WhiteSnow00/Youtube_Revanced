...
public abstract class agym extends agxu
{
    ...
    public static int I(final int n, final agyc agyc) {
        return ac(n) + J(agyc);
    }
    
    public static int J(final agyc agyc) {
        return S(agyc.d());
    }
    ...
    @Deprecated
    static int L(int ac, final MessageLite messageLite, final ahbp ahbp) {
        ac = ac(ac);
        return ac + ac + ((agxl)messageLite).getSerializedSize(ahbp);
    }
    ...
    public static int Q(final int n, final ahah ahah) {
        return ac(n) + R(ahah);
    }
    
    public static int R(final ahah ahah) {
        int n;
        if (ahah.b != null) {
            n = ahah.b.d();
        }
        else if (ahah.a != null) {
            n = ahah.a.getSerializedSize();
        }
        else {
            n = 0;
        }
    ...
    static int U(final MessageLite messageLite, final ahbp ahbp) {
        return S(((agxl)messageLite).getSerializedSize(ahbp));
    }
    ...
    public static int ab(final String s) {
        int n;
        try {
            n = ahcl.b((CharSequence)s);
        }
        catch (final ahck ahck) {
            n = s.getBytes(agzz.a).length;
        }
        return S(n);
    }
    
    public static int ac(final int n) {
        return ae(ahco.c(n, 0));
    }
    ...
    public static agym aj(final OutputStream outputStream) {
        return al(outputStream, 4096);
    }
    
    public static agym ak(final byte[] array) {
        return am(array, 0, array.length);
    }
    
    public static agym al(final OutputStream outputStream, final int n) {
        return (agym)new agyj(outputStream, n);
    }
    
    public static agym am(final byte[] array, final int n, final int n2) {
        return (agym)new agyk(array, n, n2);
    }
    ...
    final void ao(final String s, final ahck ahck) {
        agym.a.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable)ahck);
        final byte[] bytes = s.getBytes(agzz.a);
        try {
    ...
    public abstract void n(final int p0, final agyc p1);
    
    public abstract void o(final agyc p0);
    ...
    public abstract void v(final int p0, final MessageLite p1, final ahbp p2);
    
    public abstract void w(final MessageLite p0);
    
    public abstract void x(final int p0, final MessageLite p1);
    
    public abstract void y(final int p0, final agyc p1);
