...
final class ahcz extends ExtensionRegistryLite
{
    public ahcz() {
        super(null);
    }
    
    private static final agzg d(final MessageLite messageLite, final int n) {
    ...
    @Override
    public final agzg b(final MessageLite messageLite, final int n) {
        final String name = messageLite.getClass().getName();
        int n2 = 0;
        Label_0039: {
            if (name.hashCode() == 2999117) {
                if (name.equals("anss")) {
                    n2 = 0;
                    break Label_0039;
                }
