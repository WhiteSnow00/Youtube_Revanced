...
public final class ape implements View$OnTouchListener
{
    ...
    public ape(final ListView listView) {
        final apd a = new apd();
        this.a = a;
    ...
    private final void f() {
        ...
        final int n = (int)(currentAnimationTimeMillis - a.e);
        final int b = a.b;
        if (n > b) {
            i = b;
        }
    ...
    public final boolean onTouch(final View view, final MotionEvent motionEvent) {
        ...
        if (!this.e && this.b()) {
            if (this.i == null) {
                this.i = (Runnable)new uy(this, 12);
            }
            this.e = true;
            this.c = true;
            Label_0224: {
