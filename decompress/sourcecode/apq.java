...
public final class apq
{
    ...
    public static boolean e(final Editable editable, final KeyEvent keyEvent, final boolean b) {
        if (KeyEvent.metaStateHasNoModifiers(keyEvent.getMetaState())) {
            ...
            final asn[] array = (asn[])editable.getSpans(selectionStart, selectionEnd, (Class)asn.class);
            if (array != null) {
                final int length = array.length;
                if (length > 0) {
                    int i = 0;
                    while (i < length) {
                        final asn asn = array[i];
                        final int spanStart = editable.getSpanStart((Object)asn);
                        final int spanEnd = editable.getSpanEnd((Object)asn);
                        Label_0134: {
                            if (b) {
    ...
    public static boolean f(final InputConnection inputConnection, final Editable editable, int n, int n2, final boolean b) {
        if (editable != null && n >= 0) {
            if (n2 >= 0) {
                ...
                final asn[] array = (asn[])editable.getSpans(n, n2, (Class)asn.class);
                if (array != null) {
                    final int length2 = array.length;
                    if (length2 > 0) {
                        for (final asn asn : array) {
                            final int spanStart = editable.getSpanStart((Object)asn);
                            final int spanEnd = editable.getSpanEnd((Object)asn);
