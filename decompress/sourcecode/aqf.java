...
public abstract class aqf extends akv
{
    ...
    private final AccessibilityEvent w(final int n, final int n2) {
        ...
        final aol k = this.k(n);
        obtain2.getText().add(k.f());
        obtain2.setContentDescription(k.e());
        obtain2.setScrollable(k.L());
        obtain2.setPassword(k.K());
        obtain2.setEnabled(k.I());
        obtain2.setChecked(k.H());
        this.u(obtain2);
        if (obtain2.getText().isEmpty() && obtain2.getContentDescription() == null) {
            throw new RuntimeException("Callbacks must add text or a content description in populateEventForVirtualViewId()");
        }
        obtain2.setClassName(k.d());
        aor.a((AccessibilityRecord)obtain2, this.b, n);
    ...
    final aol k(int i) {
        final int n = 0;
        if (i == -1) {
            final aol c = aol.c(AccessibilityNodeInfo.obtain(this.b));
            ana.G(this.b, c);
            ...
            b.w(true);
            b.x(true);
            b.q((CharSequence)"android.view.View");
            final Rect f = aqf.f;
            b.m(f);
            b.n(f);
            b.C(this.b);
    ...
    protected abstract void p(final int p0, final aol p1);
