...
public final class aqh
{
    ...
    static {
        l = (Interpolator)new qe(3);
    }
    
    private aqh(final Context context, final ViewGroup w, final aqg u) {
        this.m = -1;
        this.x = (Runnable)new uy(this, 17);
        if (u != null) {
            this.w = w;
            this.u = u;
            ...
            this.t = new OverScroller(context, aqh.l);
            return;
        }
    ...
    public static aqh b(final ViewGroup viewGroup, final aqg aqg) {
        return new aqh(viewGroup.getContext(), viewGroup, aqg);
    }
    
    public static aqh c(final ViewGroup viewGroup, final float n, final aqg aqg) {
        final aqh b = b(viewGroup, aqg);
        b.b *= (int)(1.0f / n);
        return b;
    }
    ...
    private final boolean v(float abs, float n, final int n2, final int n3) {
        abs = Math.abs(abs);
        final float abs2 = Math.abs(n);
        if ((this.n[n2] & n3) == n3 && (this.j & n3) != 0x0 && (this.p[n2] & n3) != n3 && (this.o[n2] & n3) != n3) {
            n = (float)this.b;
            if (abs > n || abs2 > n) {
                if (abs < abs2 * 0.5f) {
                    this.u.j();
                }
                if ((this.o[n2] & n3) == 0x0 && abs > this.b) {
                    return true;
                }
            }
        }
    ...
    private final boolean x(int n, int n2, int n3, int n4) {
        ...
        final View k = this.k;
        n3 = A(n3, (int)this.g, (int)this.s);
        n4 = A(n4, (int)this.g, (int)this.s);
        final int abs = Math.abs(n);
        ...
        n3 = this.o(n, n3, this.u.a(k));
        n4 = this.o(n2, n4, this.u.b(k));
        this.t.startScroll(left, top, n, n2, (int)(n3 * n9 + n4 * n12));
        this.g(2);
        return true;
    }
        ...
        if (n3 != 0) {
            ...
            if (n3 == 2) {
                if (this.a == 1) {
                    ...
                    final int i = this.m;
                    final int n4 = (int)(x - e[i]);
                    final int n5 = (int)(y - this.f[i]);
                    final int n6 = this.k.getLeft() + n4;
                    final int n7 = this.k.getTop() + n5;
                    final int left = this.k.getLeft();
                    final int top = this.k.getTop();
                    int h = n6;
                    if (n4 != 0) {
                        h = this.u.h(this.k, n6);
                        ana.E(this.k, h - left);
                    }
                    int j = n7;
                    if (n5 != 0) {
                        j = this.u.i(this.k, n7);
                        ana.F(this.k, j - top);
                    }
                    if (n4 != 0 || n5 != 0) {
                        this.u.l(this.k, h, j, h - left);
                    }
                }
                else {
                    for (int pointerCount = motionEvent.getPointerCount(), k = n; k < pointerCount; ++k) {
                        ...
                        if (this.y(pointerId)) {
                            ...
                            final float n8 = x2 - this.c[pointerId];
                            final float n9 = y2 - this.d[pointerId];
                            this.s(n8, n9, pointerId);
                            if (this.a == 1) {
                                break;
                            }
                            final View a = this.a((int)x2, (int)y2);
                            if (this.w(a, n8, n9) && this.m(a, pointerId)) {
                                break;
                            }
                        }
                    }
