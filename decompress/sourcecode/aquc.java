...
public final class aquc implements aqum
{
    ...
    public aquc(final HttpURLConnection a, final String requestMethod, final aqub aqub, final aqty b) {
        this.e = -1;
        this.f = 0;
        this.a = a;
        try {
            ...
            for (final String s : aqub.c()) {
                final Iterator iterator2 = aqub.b(s).iterator();
    ...
    public final ListenableFuture a() {
        final aftp a = aftp.a((Callable)new adbx(this, 17));
        final arss arss = new arss((byte[])null);
        arss.k("Scotty-Uploader-HttpUrlConnectionHttpClient-%d");
    ...
    public final boolean g() {
        try {
            ...
            throw new aquo(aqun.c, (Throwable)ex);
        }
    }
        ...
        try {
            ...
            if (headerFields != null) {
                ...
                while (true) {
                    ...
                    while (iterator2.hasNext()) {
                        aqub.d(s, (String)iterator2.next());
                    }
                }
            }
            else {
            ...
            return new aeru(responseCode, aqub2, inputStream);
        }
        catch (final IOException ex2) {
            throw new aquo(aqun.d, "Error while reading response code.", (Throwable)ex2);
        }
    }
    
    public final void j(final aqqm g, final int e, final int f) {
        synchronized (this) {
            this.g = g;
            if (e > 0) {
                this.e = e;
