...
public class aque implements aqty
{
    ...
    public aque(final InputStream inputStream) {
        this(inputStream, -1L);
    }
    
    public aque(final InputStream a, final long e) {
        if (!a.markSupported()) {
    ...
    public final int b(final byte[] array, int read, final int n) {
        synchronized (this) {
            agot.v(array.length - read >= n, (Object)"Cannot read into a buffer smaller than given length");
            if (n == 0) {
                return 0;
            }
            if (this.d) {
            ...
            read = this.a.read(array, read, (int)Math.min(n, 1048576L - (this.c - this.b)));
            if (read == -1) {
                final long e = this.e;
                if (e == -1L) {
                    this.e = this.c;
