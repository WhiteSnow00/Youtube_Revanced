...
public final class aquf implements aqty
{
    ...
    public aquf(final String a, final String s, final aqub aqub, final aqty b, final MessageDigest i) {
        this.a = a;
        this.b = b;
        this.i = i;
        this.k = 1;
        ...
        sb.append(s);
        sb.append("\r\n");
        this.c = new aqul(sb.toString());
        final StringBuilder sb2 = new StringBuilder("--");
        sb2.append(a);
        sb2.append("\r\n");
        for (final String s2 : aqub.c()) {
            sb2.append(s2);
            sb2.append(": ");
            sb2.append(aqub.a(s2));
            sb2.append("\r\n");
        }
        if (this.b.a() >= 0L && aqub.b("content-length").isEmpty()) {
            sb2.append("Content-Length: ");
            sb2.append(this.b.a());
            sb2.append("\r\n");
        }
        sb2.append("\r\n");
        this.d = new aqul(sb2.toString());
        if (b.a() != -1L && i == null) {
            this.e = this.j();
    ...
    private final aqul j() {
        ...
        if (i != null && (i.getAlgorithm().equalsIgnoreCase("md5") || this.i.getAlgorithm().equalsIgnoreCase("sha-1"))) {
            ...
            sb.append(afmy.d.i(this.i.digest()));
            sb.append("\r\n--");
            sb.append(this.a);
            sb.append("--");
            return new aqul(sb.toString());
        }
        sb.append("--");
        return new aqul(sb.toString());
    }
    ...
    public final int b(final byte[] array, final int n, final int n2) {
        ...
        agot.v(array.length - n >= n2, (Object)"Buffer length must be greater than or equal to desired number of bytes.");
        if (n2 == 0) {
            return 0;
        }
        final long f = this.f;
        while (true) {
            ...
            this.f += ((aqty)o).b(array, n, n2);
            if (((aqty)o).d() < Long.MAX_VALUE) {
                ((aqty)o).g();
            }
            if (((aqty)o).i()) {
                continue;
