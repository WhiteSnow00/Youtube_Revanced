...
public abstract class arap extends enz implements araq
{
    public arap() {
    ...
    protected boolean dispatchTransaction(int n, final Parcel parcel, final Parcel parcel2, int int1) {
        switch (n) {
            ...
            case 6: {
                final HeadTrackingState headTrackingState = (HeadTrackingState)eoa.a(parcel, HeadTrackingState.CREATOR);
                this.enforceNoDataAvail(parcel);
            ...
            case 2: {
                ...
                eoa.i(parcel2, (Parcelable)requestStopTracking);
                break;
            }
            case 1: {
                parcel2.writeNoException();
