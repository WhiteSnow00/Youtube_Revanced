...
public final class arbz implements aulb
{
    ...
    public arbz(final String c, final arby i) {
        this.c = c;
        this.i = i;
    }
    
    private final void d(int a, final float[] array, final int n, final int n2) {
        aukm d;
        if (a == this.h) {
            d = this.d;
            d.getClass();
        ...
        GLES20.glVertexAttribPointer(this.e, 2, 5126, false, 0, (Buffer)arbz.a);
        GLES20.glEnableVertexAttribArray(this.f);
        GLES20.glVertexAttribPointer(this.f, 2, 5126, false, 0, (Buffer)arbz.b);
        GLES20.glUniformMatrix4fv(this.g, 1, false, array, 0);
        final arby j = this.i;
        a = j.a;
        final float n3 = 1.0f / (n * a);
        final float n4 = 1.0f / (a * n2);
        GLES20.glUniform2f(j.b, array[0] * n3, array[1] * n3);
        GLES20.glUniform2f(j.c, array[4] * n4, array[5] * n4);
