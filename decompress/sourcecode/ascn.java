...
final class ascn extends FilterInputStream implements InputStreamRetargetInterface
{
    private final int a;
    private final asfc b;
    private long c;
    private long d;
    private long e;
    
    public ascn(final InputStream inputStream, final int a, final asfc b) {
        super(inputStream);
        this.e = -1L;
        this.a = a;
        this.b = b;
