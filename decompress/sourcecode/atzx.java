...
final class atzx
{
    ...
    static {
        final auhr auhr = a = new auhr();
        final Object c = auhr.c;
        final Object d = auhr.d;
        final Object b = auhr.b;
        int n = 1;
        final int n2 = 0;
        int n3 = 0;
        int n4 = 0;
    ...
    static int a(final byte[] array, final int n, final ByteBuffer byteBuffer, int n2, int n3, final auhr auhr, int n4) {
        final Object b = auhr.b;
        final Object c = auhr.c;
        final Object d = auhr.d;
        final int n5 = n4 * 3;
