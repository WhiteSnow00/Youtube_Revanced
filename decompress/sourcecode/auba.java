...
public final class auba extends ThreadPoolExecutor
{
    ...
    static {
        ...
        c = n + n + 1;
        d = (ThreadFactory)new nco(3, (short[])null);
        e = new ArrayBlockingQueue(128);
    }
    
    public auba() {
        super(auba.b, auba.c, 30L, TimeUnit.SECONDS, auba.e, auba.d);
