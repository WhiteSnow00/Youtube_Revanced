...
public final class aubl implements AccountManagerCallback
{
    public final aubm a;
    final /* synthetic */ HttpNegotiateAuthenticator b;
    private final /* synthetic */ int c;
    
    public aubl(final HttpNegotiateAuthenticator b, final aubm a, final int c) {
        this.c = c;
        this.b = b;
        this.a = a;
    }
    ...
    public final void run(AccountManagerFuture ex) {
        if (this.c != 0) {
            try {
                ...
                if (length > 1) {
                    auak.f("net_auth", "ERR_MISSING_AUTH_CREDENTIALS: Found %d accounts eligible for the kerberos authentication. Please fix the configuration by providing a single account.", (Object)length);
                    N.M0s8NeYn(this.a.a, (Object)this.b, -341, (String)null);
                    return;
                }
                if (this.b.lacksPermission(auaf.a, "android.permission.USE_CREDENTIALS", true)) {
                ...
                a.e = ex[0];
                ex = (IOException)a.b;
                ((AccountManager)ex).getAuthToken((Account)a.e, (String)a.d, (Bundle)a.c, true, (AccountManagerCallback)new aubl(this.b, a, 0), new Handler(ThreadUtils.b()));
                return;
            }
        ...
        try {
            ...
            if (((Bundle)ex).containsKey("intent")) {
                ex = (IOException)auaf.a;
                ((Context)ex).registerReceiver((BroadcastReceiver)new aubk(this, (Context)ex), new IntentFilter("android.accounts.LOGIN_ACCOUNTS_CHANGED"));
                return;
            }
