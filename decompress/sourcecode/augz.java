...
public abstract class augz extends auew
{
    public final auey g;
    
    protected augz(final auey g) {
        if (g != null) {
            this.g = g;
            return;
        }
    ...
    public long i(final long n, final String s, final Locale locale) {
        return this.h(n, this.tQ(s, locale));
    }
    ...
    protected int tQ(final String s, final Locale locale) {
        try {
            return Integer.parseInt(s);
        }
        catch (final NumberFormatException ex) {
            throw new aufh(this.g, s);
        }
    }
