...
public final class auid implements auio, auim
{
    ...
    public auid(final String a, final String b, final boolean c, final int d) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public final int c(final auii auii, final CharSequence charSequence, int n) {
        ...
        final int b3 = auik.b(charSequence, n);
        if (b3 > 23) {
            return ~n;
        }
        ...
        Label_0698: {
            if (n5 <= 0) {
                ...
                final int b4 = auik.b(charSequence, n);
                if (b4 > 59) {
                    return ~n;
                }
                ...
                if (n12 > 0) {
                    ...
                    if (e2 == 0) {
                        ...
                        final int b5 = auik.b(charSequence, n);
                        if (b5 > 59) {
                            return ~n;
                        }
        ...
        auii.e(Integer.valueOf(n21));
        return n;
    }
    
    public final void d(final Appendable appendable, final long n, final aueu aueu, int n2, final aufc aufc, final Locale locale) {
        if (aufc == null) {
            return;
        }
        final int n3 = 0;
