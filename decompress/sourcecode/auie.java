...
final class auie implements auio, auim
{
    private final auey a;
    private final int b;
    private final boolean c;
    
    public auie(final auey a, final int b, final boolean c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public final int c(final auii auii, final CharSequence charSequence, int char1) {
        ...
        if (char4 >= '0' && char4 <= '9') {
            ...
            auii.d(this.a, n10 + (n11 + n13 - n12));
            return char1 + 2;
        }
        return ~char1;
    }
    
    public final void d(final Appendable appendable, final long n, final aueu aueu, int a, final aufc aufc, final Locale locale) {
        try {
            final int n2 = a = this.a.a(aueu).a(n);
            if (n2 < 0) {
                a = -n2;
            }
            a %= 100;
