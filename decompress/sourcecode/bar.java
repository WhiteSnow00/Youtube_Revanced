...
public final class bar
{
    ...
    public bar(final int c) {
        this.a = new byte[c];
        this.c = c;
    }
    
    public bar(final byte[] a) {
        this.a = a;
        this.c = a.length;
    }
    
    public bar(final byte[] a, final int c) {
        this.a = a;
        this.c = c;
    }
    ...
    public final void I(final athu athu, final int n) {
        this.B((byte[])athu.d, 0, n);
        athu.m(0);
    }
    ...
    public final long n() {
        ...
        final byte b8 = a[n6];
        this.b = n7 + 1;
        return ((long)b3 & 0xFFL) << 8 | ((long)b2 & 0xFFL) | ((long)b4 & 0xFFL) << 16 | ((long)b5 & 0xFFL) << 24 | ((long)b6 & 0xFFL) << 32 | ((long)b7 & 0xFFL) << 40 | ((long)b8 & 0xFFL) << 48 | ((long)a[n7] & 0xFFL) << 56;
    }
    ...
    public final long o() {
        ...
        final byte b4 = a[n2];
        this.b = n3 + 1;
        return ((long)b3 & 0xFFL) << 8 | ((long)b2 & 0xFFL) | ((long)b4 & 0xFFL) << 16 | ((long)a[n3] & 0xFFL) << 24;
    }
    ...
    public final long p() {
        ...
        final byte b8 = a[n6];
        this.b = n7 + 1;
        return ((long)b3 & 0xFFL) << 48 | ((long)b2 & 0xFFL) << 56 | ((long)b4 & 0xFFL) << 40 | ((long)b5 & 0xFFL) << 32 | ((long)b6 & 0xFFL) << 24 | ((long)b7 & 0xFFL) << 16 | ((long)b8 & 0xFFL) << 8 | ((long)a[n7] & 0xFFL);
    }
    ...
    public final long q() {
        ...
        final byte b4 = a[n2];
        this.b = n3 + 1;
        return ((long)b3 & 0xFFL) << 16 | ((long)b2 & 0xFFL) << 24 | ((long)b4 & 0xFFL) << 8 | ((long)a[n3] & 0xFFL);
    }
    ...
    public final String t() {
        ...
        int b;
        for (b = this.b; b < this.c && !baw.af(this.a[b]); ++b) {}
        int b2;
        ...
        final String o = baw.O(this.a, b2, b - b2);
        this.b = b;
        final int c = this.c;
        if (b == c) {
            return o;
    ...
    public final String v(final int n) {
        ...
        final String o = baw.O(this.a, b, n3);
        this.b += n;
        return o;
    }
    
    public final String w(final int n) {
        return this.x(n, aexb.c);
    }
