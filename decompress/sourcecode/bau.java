...
public final class bau
{
    ...
    public bau(final Context context, final XmlPullParser xmlPullParser) {
        this.d = new ArrayList();
        this.a = -1;
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), aed.h);
    ...
    public bau(final Object o, final int n, final int n2) {
        this.g((AttributedCharacterIterator.Attribute)f.a, o, n, n2);
    }
    
    public bau(final AttributedCharacterIterator.Attribute attribute, final Object o, final int n, final int n2) {
