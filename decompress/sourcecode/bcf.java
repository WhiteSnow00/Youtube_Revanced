...
public final class bcf
{
    ...
    public static long a(final String s, final String s2) {
        ...
        if (!empty) {
            try {
                ...
                sb.append(s);
                sb.append("]");
                bao.a("HttpUtil", sb.toString());
                long1 = n;
            }
        }
        long max = long1;
        if (!TextUtils.isEmpty((CharSequence)s2)) {
            final Matcher matcher = bcf.a.matcher(s2);
            max = long1;
            if (matcher.matches()) {
                try {
    ...
    public static long b(String group) {
        ...
        final Matcher matcher = bcf.b.matcher(group);
        if (matcher.matches()) {
