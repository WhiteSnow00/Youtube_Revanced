...
public class br implements ComponentCallbacks, View$OnCreateContextMenuListener, aum, avu, aud, cgj, re
{
    ...
    private final void nA() {
        this.X = new aun((aum)this);
        this.ab = cgi.a((cgj)this);
        this.aa = null;
    ...
    public final rf M(final rl rl, final sc sc, final rd rd) {
        if (this.g <= 1) {
            ...
            return (rf)new bj(atomicReference);
        }
        final StringBuilder sb = new StringBuilder("Fragment ");
        sb.append(this);
    ...
    public void R(final String s, final FileDescriptor fileDescriptor, final PrintWriter printWriter, final String[] array) {
        ...
        if (this.nT() != null) {
            awb.a((aum)this).c(s, printWriter);
        }
        printWriter.print(s);
    ...
    public final avx getDefaultViewModelCreationExtras() {
        while (true) {
            for (Context context = this.nY().getApplicationContext(); context instanceof ContextWrapper; context = ((ContextWrapper)context).getBaseContext()) {
                if (context instanceof Application) {
                    ...
                    final avz avz = new avz();
                    if (application != null) {
                        avz.b(avp.b, (Object)application);
                    }
                    avz.b(avj.a, (Object)this);
                    avz.b(avj.b, (Object)this);
                    final Bundle m = this.m;
                    if (m != null) {
                        avz.b(avj.c, (Object)m);
                    }
                    return (avx)avz;
                }
            }
    ...
    public avq getDefaultViewModelProviderFactory() {
        if (this.z != null) {
            if (this.aa == null) {
                while (true) {
                    for (Context context = this.nY().getApplicationContext(); context instanceof ContextWrapper; context = ((ContextWrapper)context).getBaseContext()) {
                        if (context instanceof Application) {
                            ...
                            this.aa = (avq)new avm(application, (cgj)this, this.m);
                            return this.aa;
                        }
                    }
                    final Application application = null;
    ...
    public final avt getViewModelStore() {
        ...
        if (this.lm() != aug.b.ordinal()) {
            final cm x = this.z.x;
            avt avt;
            if ((avt = x.d.get(this.l)) == null) {
                avt = new avt();
                x.d.put(this.l, avt);
            }
            return avt;
    ...
    public void nr(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        if (k != null) {
            this.Y.b();
            di.f(this.O, (aum)this.Y);
            di.e(this.O, (avu)this.Y);
            caw.c(this.O, (cgj)this.Y);
