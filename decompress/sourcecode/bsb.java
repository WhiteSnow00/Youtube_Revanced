...
public class bsb extends bmb
{
    ...
    public bsb(Context applicationContext, final blu blu, final bmd bmd, final long t, final Handler handler, final bsn bsn, final int u, final float n) {
        super(2, blu, bmd, false, n);
        this.t = t;
        this.u = u;
        applicationContext = applicationContext.getApplicationContext();
        this.r = applicationContext;
        this.s = new bsk(applicationContext);
        this.V = new dmk(handler, bsn);
    ...
    public bsb(final Context context, final bmd bmd, final long n, final Handler handler, final bsn bsn, final int n2) {
        this(context, blu.b, bmd, n, handler, bsn, n2, 30.0f);
    }
    ...
    private final void aL(final long n, final long n2, final ayf ayf) {
        final bse t = this.T;
        if (t != null) {
            t.sQ(n, n2, ayf, super.j);
        }
    }
    ...
    private final boolean aP(final bly bly) {
        final int a = baw.a;
        final boolean az = this.az(bly.a);
        boolean b = false;
        if (!az) {
            if (bly.f) {
    ...
    public static int au(final bly bly, final ayf ayf) {
        final int s = ayf.s;
        final int t = ayf.t;
        if (s == -1 || t == -1) {
            return -1;
        ...
        switch (n2) {
            ...
            case 5: {
                if (!"BRAVIA 4K 2015".equals(baw.d)) {
                    if ("Amazon".equals(baw.c)) {
                        if ("KFSOWI".equals(baw.d)) {
                            return -1;
                        }
                        if ("AFTS".equals(baw.d) && bly.f) {
                            return -1;
                        }
                    }
                    return b(baw.c(s, 16) * baw.c(t, 16) * 256, 2);
                }
                return -1;
            }
            case 4: {
    ...
    protected static int av(final bly bly, final ayf ayf) {
        if (ayf.o != -1) {
            final int size = ayf.p.size();
            int i = 0;
            int n = 0;
            while (i < size) {
                n += ((byte[])ayf.p.get(i)).length;
                ++i;
            }
            return ayf.o + n;
        }
    ...
    private static List c(final Context context, final bmd bmd, final ayf ayf, final boolean b, final boolean b2) {
        final String n = ayf.n;
        if (n == null) {
            return (List)afcr.q();
        }
        final List a = bmd.a(n, b, b2);
        final String c = bmj.c(ayf);
        if (c == null) {
            return (List)afcr.o((Collection)a);
        }
        final List a2 = bmd.a(c, b, b2);
        final int a3 = baw.a;
        if ("video/dolby-vision".equals(ayf.n) && !a2.isEmpty() && !bsa.a(context)) {
            return (List)afcr.o((Collection)a2);
        }
        final afcm d = afcr.d();
        d.j((Iterable)a);
        d.j((Iterable)a2);
    ...
    protected final void B() {
        ...
        if (n != 0) {
            ...
            final Object b = v.b;
            if (b != null) {
                ((Handler)b).post((Runnable)new bsl(v, m, n, 0, (byte[])null, (byte[])null, (byte[])null));
            }
            this.M = 0L;
            this.N = 0;
        }
    ...
    protected bdy U(final bly bly, final ayf ayf, final ayf ayf2) {
        ...
        return new bdy(a, ayf, ayf2, d, n3);
    }
    ...
    protected final blt V(final bly bly, final ayf ayf, final MediaCrypto mediaCrypto, final float n) {
        ...
        final aerl ag = this.aG(bly, ayf, ((bdw)this).N());
        this.U = ag;
        final boolean v = this.v;
        final MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString("mime", c);
        mediaFormat.setInteger("width", ayf.s);
        mediaFormat.setInteger("height", ayf.t);
        dl.r(mediaFormat, ayf.p);
        final float u = ayf.u;
        if (u != -1.0f) {
            mediaFormat.setFloat("frame-rate", u);
        }
        dl.q(mediaFormat, "rotation-degrees", ayf.v);
        final axz z = ayf.z;
        if (z != null) {
        ...
        if ("video/dolby-vision".equals(ayf.n)) {
            final Pair a = bmj.a(ayf);
            if (a != null) {
        ...
        if (this.d == null) {
            ...
            if (this.y == null) {
                this.y = PlaceholderSurface.b(bly.f);
            }
            this.d = (Surface)this.y;
        }
        return blt.a(bly, mediaFormat, ayf, this.d, mediaCrypto);
    }
    
    protected final List W(final bmd bmd, final ayf ayf, final boolean b) {
        return bmj.e(c(this.r, bmd, ayf, b, false), ayf);
    }
    
    protected final void X(final Exception ex) {
        bao.b("MediaCodecVideoRenderer", "Video codec error", (Throwable)ex);
        this.V.R(ex);
    }
    ...
    protected final void aE(final blv blv, final int n, final long n2) {
        Label_0107: {
            int o;
            if ((o = this.O) == -1) {
                if (this.P == -1) {
            ...
            if (r == null || r.a != o || r.b != this.P || r.d != this.Q) {
                final azr r2 = new azr(o, this.P, this.Q);
                this.R = r2;
                this.V.S(r2);
            }
        }
    ...
    protected final void aF(final blv blv, final int n) {
        final int a = baw.a;
        blv.p(n);
        final bdx o = this.o;
        ++o.f;
    ...
    protected aerl aG(final bly bly, final ayf ayf, final ayf[] array) {
        int s = ayf.s;
        final int t = ayf.t;
        int av = av(bly, ayf);
        ...
        if (length == 1) {
            int min;
            if ((min = av) != -1) {
                final int au = au(bly, ayf);
                min = av;
                if (au != -1) {
                    min = Math.min((int)(av * 1.5f), au);
                }
            }
            return new aerl(s, t, min, (byte[])null);
        }
        final int n = 0;
        int i = 0;
        int n2 = 0;
        ...
        if (n2 != 0) {
            ...
            sb.append("x");
            sb.append(n3);
            bao.c("MediaCodecVideoRenderer", sb.toString());
            int t2 = ayf.t;
            final int s3 = ayf.s;
            ...
            final float n6 = t2 / (float)n5;
            final int[] e = bsb.e;
            int j = n;
            while (true) {
                while (j < 9) {
                    int n7 = e[j];
                    final int n8 = (int)(n7 * n6);
                    if (n7 <= n5) {
                        break;
                    }
                    if (n8 <= t2) {
                    ...
                    final int a2 = baw.a;
                    final MediaCodecInfo$CodecCapabilities d = bly.d;
                    Point a3 = null;
                    Label_0533: {
                        if (d != null) {
                            final MediaCodecInfo$VideoCapabilities videoCapabilities = d.getVideoCapabilities();
                            if (videoCapabilities != null) {
                                a3 = bly.a(videoCapabilities, n9, n7);
                                break Label_0533;
                            }
                        }
                        a3 = null;
                    }
                    if (bly.e(a3.x, a3.y, (double)ayf.u)) {
                        max4 = s;
                        max5 = n3;
                        max6 = av;
                        if (a3 != null) {
                            ...
                            b3.p = max4;
                            b3.q = max5;
                            max6 = Math.max(av, au(bly, b3.a()));
                            final StringBuilder sb2 = new StringBuilder("Codec max resolution adjusted to: ");
                            sb2.append(max4);
                            sb2.append("x");
                            sb2.append(max5);
                            bao.c("MediaCodecVideoRenderer", sb2.toString());
                            return new aerl(max4, max5, max6, (byte[])null);
                        }
                        return new aerl(max4, max5, max6, (byte[])null);
                    }
                    else {
    ...
    protected boolean ae(long nanoTime, final long n, final blv blv, final ByteBuffer byteBuffer, final int n2, int e, int n3, long b, final boolean b2, final boolean b3, final ayf ayf) {
        dk.d((Object)blv);
            ...
            if (this.d != this.y) {
                ...
                Label_0601: {
                    if (this.F == -9223372036854775807L && nanoTime >= p11) {
                        ...
                        this.aL(n4, nanoTime, ayf);
                        e = baw.a;
                        this.aE(blv, n2, nanoTime);
                        this.ay(b);
                        return true;
                    }
                }
    ...
    protected final blw ai(final Throwable t, final bly bly) {
        return (blw)new brz(t, bly, this.d);
    }
    
    protected void aj(final bdb bdb) {
        if (!this.x) {
            return;
        }
        final ByteBuffer f = bdb.f;
        dk.d((Object)f);
        if (f.remaining() >= 7) {
    ...
    protected boolean aq(final bly bly) {
        return this.d != null || this.aP(bly);
    }
    
    protected void aw(final blv blv, final Surface surface) {
        blv.j(surface);
    }
        ...
        try {
            ...
            Label_4953:
                while (true) {
                    ...
                    if (baw.a <= 27 && "HWEML".equals(baw.b)) {
                        continue;
                    }
                    s = baw.d;
                    int n4 = 0;
    ...
    protected float e(final float n, final ayf ayf, final ayf[] array) {
        final int length = array.length;
        int i = 0;
        float n2 = -1.0f;
        while (i < length) {
    ...
    protected final int f(final bmd bmd, final ayf ayf) {
        final boolean m = ayy.m(ayf.n);
        final int n = 0;
        if (!m) {
            return beq.b(0);
        }
        final boolean b = ayf.q != null;
        List list2;
        final List list = list2 = c(this.r, bmd, ayf, b, (boolean)(0 != 0));
        if (b) {
            list2 = list;
            if (list.isEmpty()) {
                list2 = c(this.r, bmd, ayf, false, false);
            }
        }
        if (list2.isEmpty()) {
            return beq.b(1);
        ...
        int n7 = n;
        if (c) {
            final List c2 = c(this.r, bmd, ayf, b, true);
            n7 = n;
            if (!c2.isEmpty()) {
                final bly bly4 = bmj.e(c2, ayf).get(0);
                n7 = n;
                if (bly4.c(ayf)) {
                    n7 = n;
                    if (bly4.d(ayf)) {
