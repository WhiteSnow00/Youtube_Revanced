...
final class bsj implements Choreographer$FrameCallback, Handler$Callback
{
    ...
    private bsj() {
        ...
        (this.d = d).start();
        (this.c = baw.D(d.getLooper(), (Handler$Callback)this)).sendEmptyMessage(0);
    }
    ...
    public final boolean handleMessage(final Message message) {
        ...
        if (what == 0) {
            try {
                ...
                bao.d("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", (Throwable)ex);
            }
            return true;
        }
        if (what == 1) {
