...
public final class ca implements LayoutInflater$Factory2
{
    ...
    public final View onCreateView(View o, final String s, Context context, final AttributeSet set) {
        ...
        if (e3 == null) {
            ...
            final Bundle h2 = c.h;
            c.aD();
            final mqn mqn = mqn2 = this.a.aj(c);
            br = c;
            if (cl.W(2)) {
            ...
            context = a2.l.c;
            e3.aD();
            final mqn mqn3 = mqn2 = this.a.ak(e3);
            br = e3;
            if (cl.W(2)) {
        ...
        if (o != null) {
            ...
            br.O.addOnAttachStateChangeListener((View$OnAttachStateChangeListener)new ohv(this, mqn2, 1, (byte[])null, (byte[])null));
            return br.O;
        }
