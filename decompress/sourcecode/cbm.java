...
public final class cbm extends ArrayAdapter
{
    final float a;
    final /* synthetic */ cbn b;
    
    public cbm(final cbn b, final Context context, final List list) {
        this.b = b;
        super(context, 0, list);
        this.a = bid.d(context);
    }
    
    public final View getView(int n, View inflate, final ViewGroup viewGroup) {
        final int n2 = 0;
        if (inflate == null) {
            inflate = LayoutInflater.from(viewGroup.getContext()).inflate(2131624856, viewGroup, false);
        }
        else {
            final cbn b = this.b;
            cbn.oA(inflate.findViewById(2131432407), b.x);
        ...
        final ccs tag = (ccs)this.getItem(n);
        if (tag != null) {
            ...
            bid.k(viewGroup.getContext(), mediaRouteVolumeSlider, (View)this.b.n);
            ...
            final LinearLayout linearLayout = (LinearLayout)inflate.findViewById(2131432407);
