...
public final class cbu extends ccd
{
    final String a;
    ...
    public cbu(final MediaRouter2$RoutingController b, final String a) {
        this.e = new SparseArray();
        this.g = new AtomicInteger(1);
        this.o = (Runnable)new aur(this, 17);
        this.h = -1;
        this.b = b;
        this.a = a;
        ...
        if (c == null) {
            ...
            d = new Messenger((Handler)new cbt(this));
        }
        this.d = d;
