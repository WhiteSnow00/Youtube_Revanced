...
public final class cda implements IBinder$DeathRecipient
{
    ...
    final /* synthetic */ cdg h;
    private final Messenger i;
    
    public cda(final cdg h, final Messenger a) {
        this.h = h;
        this.c = 1;
        this.d = 1;
        this.g = new SparseArray();
        this.a = a;
        final cdc b = new cdc(this);
        this.b = b;
    ...
    public final void binderDied() {
        this.h.n.post((Runnable)new cdi(this, 1));
    }
    
    public final void c(final ccc ccc) {
        final int n = this.c++;
        Bundle a;
        if (ccc != null) {
            a = ccc.a;
