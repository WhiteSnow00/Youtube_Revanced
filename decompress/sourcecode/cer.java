...
public abstract class cer extends bi implements DialogInterface$OnClickListener
{
    ...
    public final DialogPreference aQ() {
        if (this.ae == null) {
            this.ae = (DialogPreference)((cec)((br)this).oc()).pF((CharSequence)((br)this).oa().getString("key"));
        }
        return this.ae;
    }
    ...
    public void oq(final Bundle bundle) {
        ...
        if (!(oc instanceof cec)) {
            throw new IllegalStateException("Target fragment must implement TargetFragment interface");
        }
        final cec cec = (cec)oc;
        ...
        final DialogPreference ae = (DialogPreference)cec.pF((CharSequence)string);
        this.ae = ae;
        this.af = ae.a;
        this.ag = ae.d;
        this.ah = ae.e;
