...
public final class da implements Runnable
{
    ...
    public da(final gka a, final gz b, final int c, final byte[] array) {
        this.c = c;
        this.a = a;
        this.b = b;
    }
        ...
        switch (c) {
            ...
            case 5: {
                ...
                for (int size3 = ((List)b8).size(), l = n3; l < size3; ++l) {
                    final ixy ixy = (ixy)((List)b8).get(l);
                    final Object a10 = this.a;
                    final Object e2 = ixy.e;
                    final int b9 = ixy.b;
                    final int a11 = ixy.a;
                    final int c2 = ixy.c;
                    final int d = ixy.d;
            ...
            case 4: {
                final gka gka = (gka)this.a;
                final gq gq = (gq)gka.d;
                if (gq.f == gka.a) {
                    final Object c3 = gka.c;
