...
public final class dfr implements dfx
{
    ...
    public dfr(final dfx b, final boolean a, final boolean c, final ddj d, final qbo g, final byte[] array, final byte[] array2, final byte[] array3, final byte[] array4, final byte[] array5) {
        cll.h((Object)b);
        this.b = b;
        this.a = a;
        this.c = c;
