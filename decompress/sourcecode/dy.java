...
final class dy extends MediaSession$Callback
{
    ...
    public final void onCommand(String a, final Bundle bundle, final ResultReceiver resultReceiver) {
        final eb a2 = this.a();
        if (a2 == null) {
            return;
        }
        ...
        Label_0248: {
            try {
                if (a.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                    final Bundle bundle2 = new Bundle();
                    final MediaSessionCompat$Token b = a2.b;
                    final dr a3 = b.a();
                    IBinder binder;
                    if (a3 == null) {
                        binder = null;
                    ...
                    afa.b(bundle2, "android.support.v4.media.session.EXTRA_BINDER", binder);
                    a = (String)b.a;
                    synchronized (a) {
                        final ckn d = b.d;
                        monitorexit(a);
                        if (d == null) {
                            ...
                            a = (String)new ParcelImpl(d);
                            bundle3.putParcelable("a", (Parcelable)a);
                ...
                if (a.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
                ...
                else if (a.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
                ...
                else if (a.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM")) {
                    ...
                    a.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT");
                }
            }
