...
public final class ebm extends Drawable
{
    public int a;
    public int b;
    public float c;
    ...
    public final void draw(final Canvas canvas) {
        ...
        final float n6 = (float)c2;
        final float n7 = (float)d2;
        canvas.drawRect(n5 + this.c, 0.0f, bounds.width() - this.c - n6, n7, this.h);
        canvas.restoreToCount(save5);
        final int save6 = canvas.save();
        canvas.translate((float)bounds.right, (float)bounds.bottom);
        canvas.rotate(180.0f);
        final float n8 = (float)a4;
        canvas.drawRect(n6 + this.c, 0.0f, bounds.width() - this.c - n5, n8, this.h);
        canvas.restoreToCount(save6);
        final int save7 = canvas.save();
        canvas.translate((float)bounds.left, (float)bounds.bottom);
        canvas.rotate(270.0f);
        canvas.drawRect(n8 + this.c, 0.0f, bounds.height() - (this.c + n7), n5, this.h);
        canvas.restoreToCount(save7);
        final int save8 = canvas.save();
        canvas.translate((float)bounds.right, (float)bounds.top);
        canvas.rotate(90.0f);
        canvas.drawRect(n7 + this.c, 0.0f, bounds.height() - (this.c + n8), n6, this.h);
