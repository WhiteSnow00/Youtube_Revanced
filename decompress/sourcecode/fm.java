...
{
    static ajo a(final Configuration configuration) {
        return ajo.c(configuration.getLocales().toLanguageTags());
    }
    ...
    public static void c(final ajo ajo) {
        LocaleList.setDefault(LocaleList.forLanguageTags(ajo.f()));
    }
    
    static void d(final Configuration configuration, final ajo ajo) {
        configuration.setLocales(LocaleList.forLanguageTags(ajo.f()));
    }
