...
public final class frv extends AppCompatImageView implements View$OnTouchListener
{
    public int a;
    public boolean b;
    public float c;
    ...
    public frv(final Context context) {
        super(context);
        this.n = true;
        this.o = false;
        this.a = 0;
        this.t = 1;
        this.b = false;
        this.getContext().registerReceiver((BroadcastReceiver)new fru(this, this), new IntentFilter("android.intent.action.SCREEN_OFF"));
        this.w = new ScaleGestureDetector(this.getContext(), (ScaleGestureDetector$OnScaleGestureListener)new frt(this));
    ...
    private final int[] e(final int[] array) {
        return new int[] { array[0] - tmy.m(this.getRootView()).b(), array[1] - tmy.m(this.getRootView()).d() };
    }
    ...
    public final void c(final View view) {
        if (this.i != null && view != null) {
            ...
            set.addListener((Animator$AnimatorListener)new frs(this));
            set.start();
        }
    ...
    public final void setImageDrawable(final Drawable imageDrawable) {
        ...
        this.setScaleType(aaja.y(this.t));
        aio.d(imageDrawable, this.b);
        if (this.a != 0) {
