...
public final class fxe extends aazp implements absb
{
    public boolean a;
    ...
    public fxe(final Context context) {
        super(context);
        this.c = new Rect();
    }
    ...
    public final View c(final Context context) {
        final View inflate = LayoutInflater.from(context).inflate(2131625647, (ViewGroup)null);
