...
public final class fxs implements View$OnLayoutChangeListener
{
    ...
    public fxs(final ProgressBar a, final pct b, final int c, final int d, final int e, final int f, final int g) {
