...
public final class fyl extends tnx
{
    public int a;
    ...
    public fyl(final int n, final int n2) {
        this(null, n, n2);
    }
    
    public fyl(final Drawable drawable, final int color, final int a) {
        Object o = drawable;
        if (drawable == null) {
