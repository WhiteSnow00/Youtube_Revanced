...
public final class ggx
{
    ...
    public ggx(final Activity c) {
        this.c = c;
    }
    
    public final void a(final TypedArray typedArray) {
        final boolean a = ggx.a;
        if (!a) {
            return;
        }
        if (typedArray == null) {
    ...
    public final void b(final Context context) {
        ...
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet)null, ggy.b, 2130969996, 2132083354);
