...
public final class glg
{
    ...
    public glg(final byte[] array) {
        this.a = -1;
    }
    
    public glg(final byte[] array, final byte[] array2) {
    }
            ...
            if (c != null) {
                ...
                if (d != null) {
                    ...
                    if (e != null) {
                        final int a = this.a;
                        if (a != 0) {
                            return new glh((akdd)b, (akec)c, (akdr)d, (akeb)e, a);
                        }
                    }
                }
            }
    ...
    public final void b(final akdd b) {
        if (b != null) {
            this.b = b;
            return;
        }
    ...
    public final void c(final akdr d) {
        if (d != null) {
            this.d = d;
            return;
        }
    ...
    public final void d(final akeb e) {
        if (e != null) {
            this.e = e;
            return;
        }
    ...
    public final void e(final akec c) {
        if (c != null) {
            this.c = c;
            return;
        }
