...
public final class gmj extends WebViewClient
{
    private final gml a;
    private final FrameLayout b;
    private final WebView c;
    
    public gmj(final gml a, final FrameLayout b, final WebView c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public final boolean shouldOverrideUrlLoading(final WebView webView, final WebResourceRequest webResourceRequest) {
        ...
        aesm.k(webView.getContext(), new Intent("android.intent.action.VIEW", webResourceRequest.getUrl()));
        return true;
    }
}
