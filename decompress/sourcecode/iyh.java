...
public final class iyh implements abfu
{
    final /* synthetic */ Object a;
    private final /* synthetic */ int b;
    
    public iyh(final YouTubeControlsOverlay a, final int b) {
        this.b = b;
        this.a = a;
    }
    
    public iyh(final ive a, final int b) {
        this.b = b;
        this.a = a;
    }
    
    public iyh(final jbo a, final int b) {
        this.b = b;
        this.a = a;
    }
            ...
            if (!youTubeControlsOverlay.aa(youTubeControlsOverlay.g.b.e() ^ true)) {
                        ...
                        if (((YouTubeControlsOverlay)this.a).g.b.f()) {
                            ...
                            if (n3 != 0) {
                                ...
                                if (((YouTubeControlsOverlay)this.a).Z()) {
                                    n5 = n4;
                                    if (((YouTubeControlsOverlay)this.a).N.a == abac.b) {
                                        n = 1;
                                        break Label_0169;
                                    }
                                }
                ...
                if (n4 != n2) {
                    if (!((YouTubeControlsOverlay)this.a).g.b.e() && ((YouTubeControlsOverlay)this.a).g.getParent() == null) {
                        final abfr h = ((YouTubeControlsOverlay)this.a).h;
                        final RecyclerView g = h.g;
                        if (g != null) {
                            if (h.h == null) {
                                h.h = (acon)((acrz)h.f).b(g, h.b);
                            }
                            final acon h2 = h.h;
                            if (h2 != null) {
                                h2.a(h.g);
                        ...
                        final abfr h3 = ((YouTubeControlsOverlay)this.a).h;
                    ...
                    ((tpt)youTubeControlsOverlay4.i).a(youTubeControlsOverlay4.g.b.e() ^ true);
                }
            }
    ...
    public final void d(final float n, final boolean b) {
        ...
        if (b2 != 0) {
            if (b2 != 1) {
                ...
                if (((abgj)a).i) {
                    ((jbo)a).b().c.setCurrentFraction(1.0f - aeh.u(n, 1.0f));
                }
            }
            return;
        }
