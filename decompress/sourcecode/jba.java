...
public final class jba extends aazp implements View$OnClickListener, abal
{
    private boolean A;
    private boolean B;
    ...
    public jba(final Context b, final abap q, final abam r, final Handler c) {
        super(b);
        this.q = q;
        this.r = r;
        this.b = b;
        this.c = c;
        this.a = (Runnable)new jcd(this, 1);
    }
    ...
    public final View c(final Context context) {
        final View inflate = LayoutInflater.from(context).inflate(2131624765, (ViewGroup)new FrameLayout(context), true);
        this.d = inflate;
        ...
        if (this.ab(1)) {
            ...
            if (b2) {
                ...
                if (TextUtils.isEmpty(this.D) && !TextUtils.isEmpty(this.C)) {
                    arrayDeque.add(tmy.az(2));
                    arrayDeque.add(tmy.ao(15));
                }
                else {
                    arrayDeque.add(tmy.ap(2, 2131429663));
                    arrayDeque.add(tmy.az(15));
                }
                tmy.aF((View)this.g, tmy.aK(arrayDeque), (Class)RelativeLayout$LayoutParams.class);
    ...
    public final void q(final abak p) {
        this.p = p;
    }
    ...
    public final void w(final boolean b) {
        ...
        final ArrayDeque arrayDeque = new ArrayDeque();
        if (b) {
            arrayDeque.add(tmy.aD(this.b.getResources().getDimensionPixelSize(2131167547)));
            arrayDeque.add(tmy.as(83));
        }
        else {
            arrayDeque.add(tmy.aD(-1));
            arrayDeque.add(tmy.as(81));
        }
        tmy.aF(this.e, tmy.aK(arrayDeque), (Class)FrameLayout$LayoutParams.class);
    }
