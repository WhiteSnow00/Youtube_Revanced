...
public class jc extends id implements Menu
{
    ...
    public jc(final Context context, final ajc d) {
        super(context);
        if (d != null) {
            this.d = d;
            return;
    ...
    public final int addIntentOptions(int i, int length, int addIntentOptions, final ComponentName componentName, final Intent[] array, final Intent intent, final int n, final MenuItem[] array2) {
        ...
        addIntentOptions = this.d.addIntentOptions(i, length, addIntentOptions, componentName, array, intent, n, array3);
        if (array3 != null) {
